//! This module contains 6843 tests, organized in functions.
...
pub fn option_map() {
    ...
    {
        assert!(
            Some(254u8).map((|x: u8| x.wrapping_add(1u8)))
        ...
        assert!(
            Some(254u8).map((|x: u8| x.wrapping_add(254u8)))
                == Some((|x: u8| x.wrapping_add(254u8))(254u8))
        );
        assert!(
            Some(0u8).map((|x: u8| x.wrapping_add(254u8)))
...
pub fn option_filter() {
    ...
    {
        assert!(
            Some(255u8).filter((|x: &u8| *x < 254u8)).is_some() == (|x: &u8| *x < 254u8)(&255u8)
        );
        assert!(
        ...
        assert!(
            Some(254u8).filter((|x: &u8| *x < 255u8)).is_some() == (|x: &u8| *x < 255u8)(&254u8)
        );
...
pub fn core_ops_rem_u8_rem() {
    eprintln!(r#"Testing "Properties for [`core::ops::Rem::<u8>::rem`]"... (2 contracts)"#);
    eprint!("  ");
    // ## Semantics of rem
...
pub fn core_ops_rem_u8_checked_rem() {
    eprintln!(r#"Testing "Properties for [`u8::checked_rem`]"... (2 contracts)"#);
    eprint!("  ");
...
pub fn t_u8_checked_neg() {
    eprintln!(r#"Testing "Properties for [`u8::checked_neg`]"... (2 contracts)"#);
    eprint!("  ");
...
pub fn core_ops_shl_u8_shl() {
    eprintln!(r#"Testing "Properties for [`core::ops::Shl::<u8>::shl`]"... (2 contracts)"#);
    eprint!("  ");
...
pub fn core_ops_shl_u8_checked_shl() {
    eprintln!(r#"Testing "Properties for [`core::ops::Shl::<u8>::checked_shl`]"... (2 contracts)"#);
    eprint!("  ");
    // ## Semantics of the left shift when the number of bits is right
    // __Inputs:__ `x : u8, y : u32`
    // __Precondition:__ `y < u8::BITS`
...
pub fn core_ops_shl_u8_overflowing_shl() {
    eprintln!(
        r#"Testing "Properties for [`core::ops::Shl::<u8>::overflowing_shl`]"... (2 contracts)"#
    );
    eprint!("  ");
    // ## Semantics of the left shift when the number of bits is right
    // __Inputs:__ `x : u8, y : u32`
...
pub fn core_ops_shr_u8_shr() {
    eprintln!(r#"Testing "Properties for [`core::ops::Shr::<u8>::shr`]"... (2 contracts)"#);
    eprint!("  ");
...
pub fn core_ops_shr_u8_checked_shr() {
    eprintln!(r#"Testing "Properties for [`core::ops::Shr::<u8>::checked_shr`]"... (2 contracts)"#);
    eprint!("  ");
    // ## Semantics of the right shift when the number of bits is right
    // __Inputs:__ `x : u8, y : u32`
    // __Precondition:__ `y < u8::BITS`
...
pub fn core_ops_shr_u8_overflowing_shr() {
    eprintln!(
        r#"Testing "Properties for [`core::ops::Shr::<u8>::overflowing_shr`]"... (2 contracts)"#
    );
    eprint!("  ");
    // ## Semantics of the right shift when the number of bits is right
    // __Inputs:__ `x : u8, y : u32`
...
pub fn core_ops_div_u8_div() {
    eprintln!(r#"Testing "Properties for [`core::ops::Div::<u8>::div`]"... (2 contracts)"#);
    eprint!("  ");
...
pub fn core_ops_div_u8_saturating_div() {
    eprintln!(r#"Testing "Properties for [`u8::saturating_div`]"... (2 contracts)"#);
    eprint!("  ");
    ...
    // __Postcondition:__ `{ #[allow(unconditional_panic)] { panics!(x.saturating_div(0)) } }`
    {
        assert!({
            #[allow(unconditional_panic)]
            {
                panics!(0u8.saturating_div(0))
            }
        });
        assert!({
            #[allow(unconditional_panic)]
            {
                panics!(254u8.saturating_div(0))
            }
        });
        assert!({
            #[allow(unconditional_panic)]
            {
                panics!(1u8.saturating_div(0))
            }
        });
        assert!({
            #[allow(unconditional_panic)]
            {
                panics!(255u8.saturating_div(0))
            }
        });
        assert!({
            #[allow(unconditional_panic)]
            {
                panics!(59u8.saturating_div(0))
            }
        });
        assert!({
            #[allow(unconditional_panic)]
            {
                panics!(119u8.saturating_div(0))
            }
        });
        assert!({
            #[allow(unconditional_panic)]
            {
                panics!(19u8.saturating_div(0))
            }
        });
        assert!({
            #[allow(unconditional_panic)]
            {
                panics!(134u8.saturating_div(0))
            }
        });
        assert!({
            #[allow(unconditional_panic)]
            {
                panics!(144u8.saturating_div(0))
            }
        });
        assert!({
            #[allow(unconditional_panic)]
            {
                panics!(115u8.saturating_div(0))
            }
        });
    }
    eprint!("... ");
...
pub fn core_ops_div_u8_checked_div() {
    eprintln!(r#"Testing "Properties for [`u8::checked_div`]"... (2 contracts)"#);
    eprint!("  ");
...
pub fn core_ops_mul_u8_mul() {
    eprintln!(r#"Testing "Properties for [`core::ops::Mul::<u8>::mul`]"... (8 contracts)"#);
    eprint!("  ");
...
pub fn core_ops_mul_u8_checked_mul() {
    eprintln!(r#"Testing "Properties for [`u8::checked_mul`]"... (2 contracts)"#);
    eprint!("  ");
...
pub fn core_ops_mul_u8_overflowing_mul() {
    eprintln!(r#"Testing "Properties for [`u8::overflowing_mul`]"... (2 contracts)"#);
    eprint!("  ");
...
pub fn core_ops_mul_u8_saturating_mul() {
    eprintln!(r#"Testing "Properties for [`u8::saturating_mul`]"... (3 contracts)"#);
    eprint!("  ");
...
pub fn core_ops_mul_u8_wrapped_mul() {
    eprintln!(r#"Testing "Properties for [`u8::wrapping_mul`]"... (8 contracts)"#);
    eprint!("  ");
...
pub fn core_ops_add_u8_sub() {
    eprintln!(r#"Testing "Properties for [`core::ops::Sub::<u8>::sub`]"... (4 contracts)"#);
    eprint!("  ");
...
pub fn core_ops_add_u8_wrapping_sub() {
    eprintln!(r#"Testing "Properties for [`u8::wrapping_sub`]"... (5 contracts)"#);
    eprint!("  ");
...
pub fn core_ops_add_u8_checked_sub() {
    eprintln!(r#"Testing "Properties for [`u8::checked_sub`]"... (4 contracts)"#);
    eprint!("  ");
...
pub fn core_ops_sub_u8_saturating_sub() {
    eprintln!(r#"Testing "Properties for [`u8::saturating_sub`]"... (3 contracts)"#);
    eprint!("  ");
...
pub fn core_ops_add_u8_wrapping_add() {
    eprintln!(r#"Testing "Properties for [`u8::wrapping_add`]"... (7 contracts)"#);
    eprint!("  ");
    ...
    {
        assert!(
            (0u8.wrapping_add(0u8)).wrapping_add(0u8) == 0u8.wrapping_add(0u8.wrapping_add(0u8))
        );
        assert!(
        ...
        assert!(
            (1u8.wrapping_add(0u8)).wrapping_add(0u8) == 1u8.wrapping_add(0u8.wrapping_add(0u8))
        );
        assert!(
...
pub fn core_ops_add_u8_checked_add() {
    ...
    {
        assert!(
            254u8.checked_add(0u8).and_then(|iv| iv.checked_add(255u8))
                == 0u8.checked_add(255u8).and_then(|iv| 254u8.checked_add(iv))
        );
        assert!(
            0u8.checked_add(0u8).and_then(|iv| iv.checked_add(254u8))
                == 0u8.checked_add(254u8).and_then(|iv| 0u8.checked_add(iv))
        );
        assert!(
            255u8
                .checked_add(254u8)
                .and_then(|iv| iv.checked_add(254u8))
                == 254u8
                    .checked_add(254u8)
                    .and_then(|iv| 255u8.checked_add(iv))
        );
        assert!(
            254u8
                .checked_add(255u8)
                ...
                == 255u8
                    .checked_add(254u8)
                    .and_then(|iv| 254u8.checked_add(iv))
        );
        assert!(
            1u8.checked_add(1u8).and_then(|iv| iv.checked_add(0u8))
        ...
        assert!(
            51u8.checked_add(245u8).and_then(|iv| iv.checked_add(213u8))
                == 245u8.checked_add(213u8).and_then(|iv| 51u8.checked_add(iv))
        );
        assert!(
            79u8.checked_add(56u8).and_then(|iv| iv.checked_add(66u8))
                == 56u8.checked_add(66u8).and_then(|iv| 79u8.checked_add(iv))
        );
        assert!(
            167u8.checked_add(72u8).and_then(|iv| iv.checked_add(149u8))
                == 72u8.checked_add(149u8).and_then(|iv| 167u8.checked_add(iv))
        );
        assert!(
            7u8.checked_add(124u8).and_then(|iv| iv.checked_add(197u8))
...
pub fn core_ops_add_u8_saturating_add() {
    eprintln!(r#"Testing "Properties for [`u8::saturating_add`]"... (3 contracts)"#);
    eprint!("  ");
...
pub fn core_ops_rem_u16_rem() {
    eprintln!(r#"Testing "Properties for [`core::ops::Rem::<u16>::rem`]"... (2 contracts)"#);
    eprint!("  ");
    // ## Semantics of rem
...
pub fn core_ops_rem_u16_checked_rem() {
    eprintln!(r#"Testing "Properties for [`u16::checked_rem`]"... (2 contracts)"#);
    eprint!("  ");
    // ## Semantics of checked_rem
    // __Inputs:__ `x : u16, y : u16`
    // __Precondition:__ `y != 0`
...
pub fn t_u16_checked_neg() {
    eprintln!(r#"Testing "Properties for [`u16::checked_neg`]"... (2 contracts)"#);
    eprint!("  ");
    // ## Semantics of checked neg when out of bounds
    // __Inputs:__ `x : u16`
...
pub fn core_ops_shl_u16_shl() {
    eprintln!(r#"Testing "Properties for [`core::ops::Shl::<u16>::shl`]"... (2 contracts)"#);
    eprint!("  ");
    // ## Semantics of the left shift when the number of bits is right
...
pub fn core_ops_shl_u16_checked_shl() {
    eprintln!(
        r#"Testing "Properties for [`core::ops::Shl::<u16>::checked_shl`]"... (2 contracts)"#
    );
    eprint!("  ");
    // ## Semantics of the left shift when the number of bits is right
    // __Inputs:__ `x : u16, y : u32`
...
pub fn core_ops_shl_u16_overflowing_shl() {
    eprintln!(
        r#"Testing "Properties for [`core::ops::Shl::<u16>::overflowing_shl`]"... (2 contracts)"#
    );
    eprint!("  ");
    // ## Semantics of the left shift when the number of bits is right
    // __Inputs:__ `x : u16, y : u32`
...
pub fn core_ops_shr_u16_shr() {
    eprintln!(r#"Testing "Properties for [`core::ops::Shr::<u16>::shr`]"... (2 contracts)"#);
    eprint!("  ");
    // ## Semantics of the right shift when the number of bits is right
    // __Inputs:__ `x : u16, y : u32`
    // __Precondition:__ `y < u16::BITS`
...
pub fn core_ops_shr_u16_checked_shr() {
    eprintln!(
        r#"Testing "Properties for [`core::ops::Shr::<u16>::checked_shr`]"... (2 contracts)"#
    );
    eprint!("  ");
    // ## Semantics of the right shift when the number of bits is right
    // __Inputs:__ `x : u16, y : u32`
...
pub fn core_ops_shr_u16_overflowing_shr() {
    eprintln!(
        r#"Testing "Properties for [`core::ops::Shr::<u16>::overflowing_shr`]"... (2 contracts)"#
    );
    eprint!("  ");
    // ## Semantics of the right shift when the number of bits is right
    // __Inputs:__ `x : u16, y : u32`
...
pub fn core_ops_div_u16_div() {
    eprintln!(r#"Testing "Properties for [`core::ops::Div::<u16>::div`]"... (2 contracts)"#);
    eprint!("  ");
    // ## Semantics of the division by non-zero
    // __Inputs:__ `x : u16, y : u16`
    // __Precondition:__ `y != 0`
...
pub fn core_ops_div_u16_saturating_div() {
    eprintln!(r#"Testing "Properties for [`u16::saturating_div`]"... (2 contracts)"#);
    eprint!("  ");
    // ## Semantics of the saturating division by non-zero
    // __Inputs:__ `x : u16, y : u16`
    // __Precondition:__ `y != 0`
    ...
    // __Postcondition:__ `{ #[allow(unconditional_panic)] { panics!(x.saturating_div(0)) } }`
    {
        assert!({
            #[allow(unconditional_panic)]
            {
                panics!(0u16.saturating_div(0))
            }
        });
        assert!({
            #[allow(unconditional_panic)]
            {
                panics!(65535u16.saturating_div(0))
            }
        });
        assert!({
            #[allow(unconditional_panic)]
            {
                panics!(1u16.saturating_div(0))
            }
        });
        assert!({
            #[allow(unconditional_panic)]
            {
                panics!(65534u16.saturating_div(0))
            }
        });
        assert!({
            #[allow(unconditional_panic)]
            {
                panics!(26678u16.saturating_div(0))
            }
        });
        assert!({
            #[allow(unconditional_panic)]
            {
                panics!(57542u16.saturating_div(0))
            }
        });
        assert!({
            #[allow(unconditional_panic)]
            {
                panics!(34219u16.saturating_div(0))
            }
        });
        assert!({
            #[allow(unconditional_panic)]
            {
                panics!(32349u16.saturating_div(0))
            }
        });
        assert!({
            #[allow(unconditional_panic)]
            {
                panics!(45301u16.saturating_div(0))
            }
        });
        assert!({
            #[allow(unconditional_panic)]
            {
                panics!(33050u16.saturating_div(0))
            }
        });
    }
    eprint!("... ");
...
pub fn core_ops_div_u16_checked_div() {
    eprintln!(r#"Testing "Properties for [`u16::checked_div`]"... (2 contracts)"#);
    eprint!("  ");
    // ## Semantics of the checked division by non-zero
    // __Inputs:__ `x : u16, y : u16`
    // __Precondition:__ `y != 0`
...
pub fn core_ops_mul_u16_mul() {
    eprintln!(r#"Testing "Properties for [`core::ops::Mul::<u16>::mul`]"... (8 contracts)"#);
    eprint!("  ");
    // ## Semantics of non-overflowing multiplication
    // __Inputs:__ `x : u16, y : u16`
...
pub fn core_ops_mul_u16_checked_mul() {
    eprintln!(r#"Testing "Properties for [`u16::checked_mul`]"... (2 contracts)"#);
    eprint!("  ");
    // ## Semantics of the non-overflowing checked multiplication
    // __Inputs:__ `x : u16, y : u16`
    // __Precondition:__ `x.up() * y.up() <= u16::MAX.up()`
...
pub fn core_ops_mul_u16_overflowing_mul() {
    eprintln!(r#"Testing "Properties for [`u16::overflowing_mul`]"... (2 contracts)"#);
    eprint!("  ");
    // ## Semantics of the overflowing multiplication when in bounds
    // __Inputs:__ `x : u16, y : u16`
    // __Precondition:__ `x.up() * y.up() <= u16::MAX.up()`
...
pub fn core_ops_mul_u16_saturating_mul() {
    eprintln!(r#"Testing "Properties for [`u16::saturating_mul`]"... (3 contracts)"#);
    eprint!("  ");
    // ## Semantics of the saturating multiplication
    // __Inputs:__ `x : u16, y : u16`
    // __Precondition:__ `true`
...
pub fn core_ops_mul_u16_wrapped_mul() {
    eprintln!(r#"Testing "Properties for [`u16::wrapping_mul`]"... (8 contracts)"#);
    eprint!("  ");
    // ## Semantics of the wrapping multiplication
    // __Inputs:__ `x : u16, y : u16`
    // __Precondition:__ `true`
...
pub fn core_ops_add_u16_sub() {
    eprintln!(r#"Testing "Properties for [`core::ops::Sub::<u16>::sub`]"... (4 contracts)"#);
    eprint!("  ");
    // ## Semantics of non-underflowing subtraction
    // __Inputs:__ `x : u16, y : u16`
    // __Precondition:__ `x.up() - y.up() >= 0u8.up()`
...
pub fn core_ops_add_u16_wrapping_sub() {
    eprintln!(r#"Testing "Properties for [`u16::wrapping_sub`]"... (5 contracts)"#);
    eprint!("  ");
    // ## Semantics of non-underflowing wrapping subtraction
    // __Inputs:__ `x : u16, y : u16`
    // __Precondition:__ `x.up() - y.up() >= 0u8.up()`
...
pub fn core_ops_add_u16_checked_sub() {
    eprintln!(r#"Testing "Properties for [`u16::checked_sub`]"... (4 contracts)"#);
    eprint!("  ");
    // ## Semantics of non-underflowing checked subtraction
    // __Inputs:__ `x : u16, y : u16`
    // __Precondition:__ `x.up() - y.up() >= 0u8.up()`
    ...
    {
        assert!(
            (65535u16.checked_sub(65534u16)).and_then(|r| r.checked_add(65534u16))
                == Some(65535u16)
        );
        ...
        assert!(
            (32173u16.checked_sub(19796u16)).and_then(|r| r.checked_add(19796u16))
                == Some(32173u16)
        );
        assert!(
            (56022u16.checked_sub(31100u16)).and_then(|r| r.checked_add(31100u16))
                == Some(56022u16)
        );
        assert!(
            (21592u16.checked_sub(4584u16)).and_then(|r| r.checked_add(4584u16)) == Some(21592u16)
        );
        assert!(
            (64473u16.checked_sub(14654u16)).and_then(|r| r.checked_add(14654u16))
                == Some(64473u16)
        );
        assert!(
            (5652u16.checked_sub(5469u16)).and_then(|r| r.checked_add(5469u16)) == Some(5652u16)
        );
        assert!(
            (53636u16.checked_sub(45156u16)).and_then(|r| r.checked_add(45156u16))
                == Some(53636u16)
        );
    }
    eprint!("... ");
...
pub fn core_ops_sub_u16_saturating_sub() {
    eprintln!(r#"Testing "Properties for [`u16::saturating_sub`]"... (3 contracts)"#);
    eprint!("  ");
    // ## Semantics of the saturating subtraction
    // __Inputs:__ `x : u16, y : u16`
    // __Precondition:__ `true`
...
pub fn core_ops_add_u16_wrapping_add() {
    eprintln!(r#"Testing "Properties for [`u16::wrapping_add`]"... (7 contracts)"#);
    eprint!("  ");
    // ## Semantics of the wrapping addition
    // __Inputs:__ `x : u16, y : u16`
    // __Precondition:__ `true`
...
pub fn core_ops_add_u16_checked_add() {
    ...
    {
        assert!(
            0u16.checked_add(1u16).and_then(|iv| iv.checked_add(0u16))
        ...
        assert!(
            65534u16
                ...
                == 1u16
                    .checked_add(0u16)
                    .and_then(|iv| 65534u16.checked_add(iv))
        );
        assert!(
            65534u16
        ...
        assert!(
            0u16.checked_add(0u16)
                .and_then(|iv| iv.checked_add(65534u16))
                == 0u16
                    .checked_add(65534u16)
        ...
        assert!(
            65535u16
                .checked_add(65535u16)
                .and_then(|iv| iv.checked_add(1u16))
                == 65535u16
                    .checked_add(1u16)
                    .and_then(|iv| 65535u16.checked_add(iv))
        );
        assert!(
            33745u16
                .checked_add(56583u16)
                .and_then(|iv| iv.checked_add(44218u16))
                == 56583u16
                    .checked_add(44218u16)
                    .and_then(|iv| 33745u16.checked_add(iv))
        );
        assert!(
            14612u16
                .checked_add(24141u16)
                .and_then(|iv| iv.checked_add(45395u16))
                == 24141u16
                    .checked_add(45395u16)
                    .and_then(|iv| 14612u16.checked_add(iv))
        );
        assert!(
            42017u16
                .checked_add(60260u16)
                .and_then(|iv| iv.checked_add(55964u16))
                == 60260u16
                    .checked_add(55964u16)
                    .and_then(|iv| 42017u16.checked_add(iv))
        );
        assert!(
            40217u16
                .checked_add(28973u16)
                .and_then(|iv| iv.checked_add(49003u16))
                == 28973u16
                    .checked_add(49003u16)
                    .and_then(|iv| 40217u16.checked_add(iv))
        );
    }
    eprint!("... ");
    eprintln!("✓\n");
...
pub fn core_ops_add_u16_saturating_add() {
    eprintln!(r#"Testing "Properties for [`u16::saturating_add`]"... (3 contracts)"#);
    eprint!("  ");
    // ## Semantics of the saturating addition
    // __Inputs:__ `x : u16, y : u16`
    // __Precondition:__ `true`
...
pub fn core_ops_rem_u32_rem() {
    eprintln!(r#"Testing "Properties for [`core::ops::Rem::<u32>::rem`]"... (2 contracts)"#);
    eprint!("  ");
    // ## Semantics of rem
...
pub fn core_ops_rem_u32_checked_rem() {
    eprintln!(r#"Testing "Properties for [`u32::checked_rem`]"... (2 contracts)"#);
    eprint!("  ");
    // ## Semantics of checked_rem
    // __Inputs:__ `x : u32, y : u32`
    // __Precondition:__ `y != 0`
...
pub fn t_u32_checked_neg() {
    eprintln!(r#"Testing "Properties for [`u32::checked_neg`]"... (2 contracts)"#);
    eprint!("  ");
    // ## Semantics of checked neg when out of bounds
    // __Inputs:__ `x : u32`
...
pub fn core_ops_shl_u32_shl() {
    eprintln!(r#"Testing "Properties for [`core::ops::Shl::<u32>::shl`]"... (2 contracts)"#);
    eprint!("  ");
    // ## Semantics of the left shift when the number of bits is right
    // __Inputs:__ `x : u32, y : u32`
...
pub fn core_ops_shl_u32_checked_shl() {
    eprintln!(
        r#"Testing "Properties for [`core::ops::Shl::<u32>::checked_shl`]"... (2 contracts)"#
    );
    eprint!("  ");
    // ## Semantics of the left shift when the number of bits is right
    // __Inputs:__ `x : u32, y : u32`
...
pub fn core_ops_shl_u32_overflowing_shl() {
    eprintln!(
        r#"Testing "Properties for [`core::ops::Shl::<u32>::overflowing_shl`]"... (2 contracts)"#
    );
    eprint!("  ");
    // ## Semantics of the left shift when the number of bits is right
    // __Inputs:__ `x : u32, y : u32`
...
pub fn core_ops_shr_u32_shr() {
    eprintln!(r#"Testing "Properties for [`core::ops::Shr::<u32>::shr`]"... (2 contracts)"#);
    eprint!("  ");
    // ## Semantics of the right shift when the number of bits is right
    // __Inputs:__ `x : u32, y : u32`
    // __Precondition:__ `y < u32::BITS`
...
pub fn core_ops_shr_u32_checked_shr() {
    eprintln!(
        r#"Testing "Properties for [`core::ops::Shr::<u32>::checked_shr`]"... (2 contracts)"#
    );
    eprint!("  ");
    // ## Semantics of the right shift when the number of bits is right
    // __Inputs:__ `x : u32, y : u32`
...
pub fn core_ops_shr_u32_overflowing_shr() {
    eprintln!(
        r#"Testing "Properties for [`core::ops::Shr::<u32>::overflowing_shr`]"... (2 contracts)"#
    );
    eprint!("  ");
    // ## Semantics of the right shift when the number of bits is right
    // __Inputs:__ `x : u32, y : u32`
...
pub fn core_ops_div_u32_div() {
    eprintln!(r#"Testing "Properties for [`core::ops::Div::<u32>::div`]"... (2 contracts)"#);
    eprint!("  ");
    // ## Semantics of the division by non-zero
    // __Inputs:__ `x : u32, y : u32`
    // __Precondition:__ `y != 0`
    ...
    // __Postcondition:__ `{ #[allow(unconditional_panic)] { panics!(x / 0) } }`
    {
        ...
        assert!({
            #[allow(unconditional_panic)]
            {
                panics!(4294967294u32 / 0)
            }
        });
        assert!({
            #[allow(unconditional_panic)]
            {
                panics!(4294967295u32 / 0)
            }
        });
        assert!({
            #[allow(unconditional_panic)]
            {
                panics!(1661446076u32 / 0)
            }
        });
        assert!({
            #[allow(unconditional_panic)]
            {
                panics!(1292851075u32 / 0)
            }
        });
        assert!({
            #[allow(unconditional_panic)]
            {
                panics!(2062014865u32 / 0)
            }
        });
        assert!({
            #[allow(unconditional_panic)]
            {
                panics!(721252113u32 / 0)
            }
        });
        assert!({
            #[allow(unconditional_panic)]
            {
                panics!(65492122u32 / 0)
            }
        });
        assert!({
            #[allow(unconditional_panic)]
            {
                panics!(3981364148u32 / 0)
            }
        });
    }
    eprint!("... ");
...
pub fn core_ops_div_u32_saturating_div() {
    eprintln!(r#"Testing "Properties for [`u32::saturating_div`]"... (2 contracts)"#);
    eprint!("  ");
    // ## Semantics of the saturating division by non-zero
    // __Inputs:__ `x : u32, y : u32`
    // __Precondition:__ `y != 0`
    ...
    // __Postcondition:__ `{ #[allow(unconditional_panic)] { panics!(x.saturating_div(0)) } }`
    {
        assert!({
            #[allow(unconditional_panic)]
            {
                panics!(4294967294u32.saturating_div(0))
            }
        });
        assert!({
            #[allow(unconditional_panic)]
            {
                panics!(0u32.saturating_div(0))
            }
        });
        assert!({
            #[allow(unconditional_panic)]
            {
                panics!(4294967295u32.saturating_div(0))
            }
        });
        assert!({
            #[allow(unconditional_panic)]
            {
                panics!(1u32.saturating_div(0))
            }
        });
        assert!({
            #[allow(unconditional_panic)]
            {
                panics!(4117435034u32.saturating_div(0))
            }
        });
        assert!({
            #[allow(unconditional_panic)]
            {
                panics!(2424381597u32.saturating_div(0))
            }
        });
        assert!({
            #[allow(unconditional_panic)]
            {
                panics!(3952739913u32.saturating_div(0))
            }
        });
        assert!({
            #[allow(unconditional_panic)]
            {
                panics!(76031108u32.saturating_div(0))
            }
        });
        assert!({
            #[allow(unconditional_panic)]
            {
                panics!(3623311327u32.saturating_div(0))
            }
        });
        assert!({
            #[allow(unconditional_panic)]
            {
                panics!(2313520947u32.saturating_div(0))
            }
        });
    }
    eprint!("... ");
...
pub fn core_ops_div_u32_checked_div() {
    eprintln!(r#"Testing "Properties for [`u32::checked_div`]"... (2 contracts)"#);
    eprint!("  ");
    // ## Semantics of the checked division by non-zero
    // __Inputs:__ `x : u32, y : u32`
    // __Precondition:__ `y != 0`
...
pub fn core_ops_mul_u32_mul() {
    eprintln!(r#"Testing "Properties for [`core::ops::Mul::<u32>::mul`]"... (8 contracts)"#);
    eprint!("  ");
    // ## Semantics of non-overflowing multiplication
    // __Inputs:__ `x : u32, y : u32`
...
pub fn core_ops_mul_u32_checked_mul() {
    eprintln!(r#"Testing "Properties for [`u32::checked_mul`]"... (2 contracts)"#);
    eprint!("  ");
    // ## Semantics of the non-overflowing checked multiplication
    // __Inputs:__ `x : u32, y : u32`
    // __Precondition:__ `x.up() * y.up() <= u32::MAX.up()`
...
pub fn core_ops_mul_u32_overflowing_mul() {
    eprintln!(r#"Testing "Properties for [`u32::overflowing_mul`]"... (2 contracts)"#);
    eprint!("  ");
    // ## Semantics of the overflowing multiplication when in bounds
    // __Inputs:__ `x : u32, y : u32`
    // __Precondition:__ `x.up() * y.up() <= u32::MAX.up()`
...
pub fn core_ops_mul_u32_saturating_mul() {
    eprintln!(r#"Testing "Properties for [`u32::saturating_mul`]"... (3 contracts)"#);
    eprint!("  ");
    // ## Semantics of the saturating multiplication
    // __Inputs:__ `x : u32, y : u32`
    // __Precondition:__ `true`
...
pub fn core_ops_mul_u32_wrapped_mul() {
    eprintln!(r#"Testing "Properties for [`u32::wrapping_mul`]"... (8 contracts)"#);
    eprint!("  ");
    // ## Semantics of the wrapping multiplication
    // __Inputs:__ `x : u32, y : u32`
    // __Precondition:__ `true`
...
pub fn core_ops_add_u32_sub() {
    eprintln!(r#"Testing "Properties for [`core::ops::Sub::<u32>::sub`]"... (4 contracts)"#);
    eprint!("  ");
    // ## Semantics of non-underflowing subtraction
    // __Inputs:__ `x : u32, y : u32`
    // __Precondition:__ `x.up() - y.up() >= 0u8.up()`
...
pub fn core_ops_add_u32_wrapping_sub() {
    eprintln!(r#"Testing "Properties for [`u32::wrapping_sub`]"... (5 contracts)"#);
    eprint!("  ");
    // ## Semantics of non-underflowing wrapping subtraction
    // __Inputs:__ `x : u32, y : u32`
    // __Precondition:__ `x.up() - y.up() >= 0u8.up()`
    ...
    // __Postcondition:__ `(x.wrapping_sub(y)).wrapping_add(y) == x`
    {
        ...
        assert!(
            (3076129507u32.wrapping_sub(2809785564u32)).wrapping_add(2809785564u32)
                == 3076129507u32
        );
        assert!(
            (2062194708u32.wrapping_sub(2953437153u32)).wrapping_add(2953437153u32)
                == 2062194708u32
        );
        assert!(
            (653721344u32.wrapping_sub(1839067770u32)).wrapping_add(1839067770u32) == 653721344u32
        );
        assert!(
            (3530026658u32.wrapping_sub(1773066552u32)).wrapping_add(1773066552u32)
                == 3530026658u32
        );
        assert!(
            (255804295u32.wrapping_sub(3218584940u32)).wrapping_add(3218584940u32) == 255804295u32
        );
    }
    eprint!("... ");
    // ## Left identity
...
pub fn core_ops_add_u32_checked_sub() {
    eprintln!(r#"Testing "Properties for [`u32::checked_sub`]"... (4 contracts)"#);
    eprint!("  ");
    // ## Semantics of non-underflowing checked subtraction
    // __Inputs:__ `x : u32, y : u32`
    // __Precondition:__ `x.up() - y.up() >= 0u8.up()`
    ...
    {
        assert!(
            (4294967294u32.checked_sub(0u32)).and_then(|r| r.checked_add(0u32))
                == Some(4294967294u32)
        );
        assert!(
            (4294967295u32.checked_sub(1u32)).and_then(|r| r.checked_add(1u32))
                == Some(4294967295u32)
        );
        assert!((0u32.checked_sub(0u32)).and_then(|r| r.checked_add(0u32)) == Some(0u32));
        assert!(
            (4294967295u32.checked_sub(0u32)).and_then(|r| r.checked_add(0u32))
                == Some(4294967295u32)
        );
        assert!(
            (3321772758u32.checked_sub(2666334970u32)).and_then(|r| r.checked_add(2666334970u32))
                == Some(3321772758u32)
        );
        assert!(
            (4289707070u32.checked_sub(2035481719u32)).and_then(|r| r.checked_add(2035481719u32))
                == Some(4289707070u32)
        );
        assert!(
            (3954304948u32.checked_sub(1135233182u32)).and_then(|r| r.checked_add(1135233182u32))
                == Some(3954304948u32)
        );
        assert!(
            (3502068592u32.checked_sub(2911981990u32)).and_then(|r| r.checked_add(2911981990u32))
                == Some(3502068592u32)
        );
        assert!(
            (2041834116u32.checked_sub(1343177476u32)).and_then(|r| r.checked_add(1343177476u32))
                == Some(2041834116u32)
        );
        assert!(
            (834027195u32.checked_sub(496540351u32)).and_then(|r| r.checked_add(496540351u32))
                == Some(834027195u32)
        );
    }
    eprint!("... ");
...
pub fn core_ops_sub_u32_saturating_sub() {
    eprintln!(r#"Testing "Properties for [`u32::saturating_sub`]"... (3 contracts)"#);
    eprint!("  ");
    // ## Semantics of the saturating subtraction
    // __Inputs:__ `x : u32, y : u32`
    // __Precondition:__ `true`
...
pub fn core_ops_add_u32_wrapping_add() {
    eprintln!(r#"Testing "Properties for [`u32::wrapping_add`]"... (7 contracts)"#);
    eprint!("  ");
    // ## Semantics of the wrapping addition
    // __Inputs:__ `x : u32, y : u32`
    // __Precondition:__ `true`
    ...
    // __Postcondition:__ `x.wrapping_add(y) == y.wrapping_add(x)`
    {
        ...
        assert!(
            3230403307u32.wrapping_add(3513354023u32) == 3513354023u32.wrapping_add(3230403307u32)
        );
        assert!(
            374844381u32.wrapping_add(2820812497u32) == 2820812497u32.wrapping_add(374844381u32)
        );
        assert!(4149312623u32.wrapping_add(94561244u32) == 94561244u32.wrapping_add(4149312623u32));
        assert!(
            365125764u32.wrapping_add(2007144080u32) == 2007144080u32.wrapping_add(365125764u32)
        );
        assert!(
            1693978471u32.wrapping_add(432925522u32) == 432925522u32.wrapping_add(1693978471u32)
        );
    }
    eprint!("... ");
    // ## Left identity
...
pub fn core_ops_add_u32_checked_add() {
    ...
    {
        assert!(
            4294967294u32.checked_add(4294967294u32) == 4294967294u32.checked_add(4294967294u32)
        );
        ...
        assert!(
            3411158154u32.checked_add(4009517711u32) == 4009517711u32.checked_add(3411158154u32)
        );
        assert!(1569064231u32.checked_add(924925773u32) == 924925773u32.checked_add(1569064231u32));
        assert!(
            3301161257u32.checked_add(1973255712u32) == 1973255712u32.checked_add(3301161257u32)
        );
    }
    eprint!("... ");
    // ## Left identity
    ...
    //         == y.checked_add(z).and_then(|iv| x.checked_add(iv))`
    {
        ...
        assert!(
            0u32.checked_add(4294967294u32)
                .and_then(|iv| iv.checked_add(4294967294u32))
                == 4294967294u32
                    .checked_add(4294967294u32)
                    .and_then(|iv| 0u32.checked_add(iv))
        );
        assert!(
            1u32.checked_add(4294967295u32)
                .and_then(|iv| iv.checked_add(0u32))
                == 4294967295u32
                    .checked_add(0u32)
                    .and_then(|iv| 1u32.checked_add(iv))
        );
        assert!(
            4294967294u32
                .checked_add(0u32)
                ...
                == 0u32
                    .checked_add(0u32)
                    .and_then(|iv| 4294967294u32.checked_add(iv))
        );
        assert!(
        ...
        assert!(
            3732905487u32
                .checked_add(2755779625u32)
                .and_then(|iv| iv.checked_add(3358094072u32))
                == 2755779625u32
        ...
        assert!(
            3391689185u32
                .checked_add(2556167309u32)
                .and_then(|iv| iv.checked_add(141157205u32))
                == 2556167309u32
        ...
        assert!(
            694700122u32
                .checked_add(2916154247u32)
                .and_then(|iv| iv.checked_add(1439383947u32))
                == 2916154247u32
        ...
        assert!(
            1366529711u32
                .checked_add(639090145u32)
                .and_then(|iv| iv.checked_add(3201752294u32))
                == 639090145u32
...
pub fn core_ops_add_u32_saturating_add() {
    eprintln!(r#"Testing "Properties for [`u32::saturating_add`]"... (3 contracts)"#);
    eprint!("  ");
    // ## Semantics of the saturating addition
    // __Inputs:__ `x : u32, y : u32`
    // __Precondition:__ `true`
...
pub fn core_ops_rem_u64_rem() {
    eprintln!(r#"Testing "Properties for [`core::ops::Rem::<u64>::rem`]"... (2 contracts)"#);
    eprint!("  ");
    // ## Semantics of rem
...
pub fn core_ops_rem_u64_checked_rem() {
    eprintln!(r#"Testing "Properties for [`u64::checked_rem`]"... (2 contracts)"#);
    eprint!("  ");
    // ## Semantics of checked_rem
    // __Inputs:__ `x : u64, y : u64`
    // __Precondition:__ `y != 0`
    // __Postcondition:__ `x.checked_rem(y) == Some(u64::down(x.up() % y.up()))`
    {
        ...
        assert!(
            15190343420006766453u64.checked_rem(3463313369277229636u64)
                == Some(1337089942897847909u64)
        );
        assert!(
            1951620070264938349u64.checked_rem(15077326295837186647u64)
                == Some(1951620070264938349u64)
        );
        assert!(
            36461994823924471u64.checked_rem(11870157710381094389u64) == Some(36461994823924471u64)
        );
        assert!(
            12505486218545677295u64.checked_rem(16769084475771579103u64)
...
pub fn t_u64_checked_neg() {
    eprintln!(r#"Testing "Properties for [`u64::checked_neg`]"... (2 contracts)"#);
    eprint!("  ");
    // ## Semantics of checked neg when out of bounds
    // __Inputs:__ `x : u64`
...
pub fn core_ops_shl_u64_shl() {
    eprintln!(r#"Testing "Properties for [`core::ops::Shl::<u64>::shl`]"... (2 contracts)"#);
    eprint!("  ");
    // ## Semantics of the left shift when the number of bits is right
...
pub fn core_ops_shl_u64_checked_shl() {
    eprintln!(
        r#"Testing "Properties for [`core::ops::Shl::<u64>::checked_shl`]"... (2 contracts)"#
    );
    eprint!("  ");
    // ## Semantics of the left shift when the number of bits is right
    // __Inputs:__ `x : u64, y : u32`
...
pub fn core_ops_shl_u64_overflowing_shl() {
    eprintln!(
        r#"Testing "Properties for [`core::ops::Shl::<u64>::overflowing_shl`]"... (2 contracts)"#
    );
    eprint!("  ");
    // ## Semantics of the left shift when the number of bits is right
    // __Inputs:__ `x : u64, y : u32`
    ...
    //         == (u64::down((x.up() << (y & (u64::BITS - 1)) & u64::MAX.up())), true)`
    {
        ...
        assert!(
            18446744073709551614u64.overflowing_shl(4294967294u32)
                == (9223372036854775808u64, true)
        );
        assert!(0u64.overflowing_shl(4294967294u32) == (0u64, true));
        assert!(
            18446744073709551615u64.overflowing_shl(4294967295u32)
                == (9223372036854775808u64, true)
        );
        assert!(
            18446744073709551615u64.overflowing_shl(4294967294u32)
...
pub fn core_ops_shr_u64_shr() {
    eprintln!(r#"Testing "Properties for [`core::ops::Shr::<u64>::shr`]"... (2 contracts)"#);
    eprint!("  ");
    // ## Semantics of the right shift when the number of bits is right
    // __Inputs:__ `x : u64, y : u32`
    // __Precondition:__ `y < u64::BITS`
...
pub fn core_ops_shr_u64_checked_shr() {
    eprintln!(
        r#"Testing "Properties for [`core::ops::Shr::<u64>::checked_shr`]"... (2 contracts)"#
    );
    eprint!("  ");
    // ## Semantics of the right shift when the number of bits is right
    // __Inputs:__ `x : u64, y : u32`
...
pub fn core_ops_shr_u64_overflowing_shr() {
    eprintln!(
        r#"Testing "Properties for [`core::ops::Shr::<u64>::overflowing_shr`]"... (2 contracts)"#
    );
    eprint!("  ");
    // ## Semantics of the right shift when the number of bits is right
    // __Inputs:__ `x : u64, y : u32`
...
pub fn core_ops_div_u64_div() {
    eprintln!(r#"Testing "Properties for [`core::ops::Div::<u64>::div`]"... (2 contracts)"#);
    eprint!("  ");
    // ## Semantics of the division by non-zero
    // __Inputs:__ `x : u64, y : u64`
    // __Precondition:__ `y != 0`
    ...
    // __Postcondition:__ `{ #[allow(unconditional_panic)] { panics!(x / 0) } }`
    {
        ...
        assert!({
            #[allow(unconditional_panic)]
            {
                panics!(18446744073709551614u64 / 0)
            }
        });
        assert!({
            #[allow(unconditional_panic)]
            {
                panics!(18446744073709551615u64 / 0)
            }
        });
        assert!({
            #[allow(unconditional_panic)]
            {
                panics!(4134595096586999757u64 / 0)
            }
        });
        assert!({
            #[allow(unconditional_panic)]
            {
                panics!(11601631929676441577u64 / 0)
            }
        });
        assert!({
            #[allow(unconditional_panic)]
            {
                panics!(18292638891768135550u64 / 0)
            }
        });
        assert!({
            #[allow(unconditional_panic)]
            {
                panics!(11224464402441731037u64 / 0)
            }
        });
        assert!({
            #[allow(unconditional_panic)]
            {
                panics!(9318127153531994564u64 / 0)
            }
        });
        assert!({
            #[allow(unconditional_panic)]
            {
                panics!(1293189655105820760u64 / 0)
            }
        });
    }
    eprint!("... ");
...
pub fn core_ops_div_u64_saturating_div() {
    eprintln!(r#"Testing "Properties for [`u64::saturating_div`]"... (2 contracts)"#);
    eprint!("  ");
    // ## Semantics of the saturating division by non-zero
    // __Inputs:__ `x : u64, y : u64`
    // __Precondition:__ `y != 0`
...
pub fn core_ops_div_u64_checked_div() {
    eprintln!(r#"Testing "Properties for [`u64::checked_div`]"... (2 contracts)"#);
    eprint!("  ");
    // ## Semantics of the checked division by non-zero
    // __Inputs:__ `x : u64, y : u64`
    // __Precondition:__ `y != 0`
...
pub fn core_ops_mul_u64_mul() {
    eprintln!(r#"Testing "Properties for [`core::ops::Mul::<u64>::mul`]"... (8 contracts)"#);
    eprint!("  ");
    // ## Semantics of non-overflowing multiplication
    // __Inputs:__ `x : u64, y : u64`
    ...
    {
        assert!(
            18446744073709551614u64 * (0u64 + 1u64)
                == 18446744073709551614u64 * 0u64 + 18446744073709551614u64 * 1u64
        );
        assert!(
            1u64 * (18446744073709551614u64 + 0u64) == 1u64 * 18446744073709551614u64 + 1u64 * 0u64
        );
        assert!(1u64 * (0u64 + 1u64) == 1u64 * 0u64 + 1u64 * 1u64);
        assert!(
            18446744073709551615u64 * (0u64 + 0u64)
...
pub fn core_ops_mul_u64_checked_mul() {
    eprintln!(r#"Testing "Properties for [`u64::checked_mul`]"... (2 contracts)"#);
    eprint!("  ");
    // ## Semantics of the non-overflowing checked multiplication
    // __Inputs:__ `x : u64, y : u64`
    // __Precondition:__ `x.up() * y.up() <= u64::MAX.up()`
...
pub fn core_ops_mul_u64_overflowing_mul() {
    eprintln!(r#"Testing "Properties for [`u64::overflowing_mul`]"... (2 contracts)"#);
    eprint!("  ");
    // ## Semantics of the overflowing multiplication when in bounds
    // __Inputs:__ `x : u64, y : u64`
    // __Precondition:__ `x.up() * y.up() <= u64::MAX.up()`
    ...
    // __Postcondition:__ `x.overflowing_mul(y) == (x.wrapping_mul(y), true)`
    {
        ...
        assert!(
            1303655627196217444u64.overflowing_mul(13549311689848883103u64)
                == (17609718009402475036u64, true)
        );
        assert!(
            6725832618175000799u64.overflowing_mul(16741300694647574752u64)
                == (10950610652606542624u64, true)
        );
        assert!(
            1395182454678035481u64.overflowing_mul(12203968943236976897u64)
                == (1694468870133826841u64, true)
        );
        assert!(
            7697399895972380707u64.overflowing_mul(8919293145244213227u64)
                == (506198501910568225u64, true)
        );
        assert!(
            15323309810660617105u64.overflowing_mul(14323623050897051334u64)
                == (1422420803753500710u64, true)
        );
        assert!(
            2744253587011671760u64.overflowing_mul(6626066546375654547u64)
...
pub fn core_ops_mul_u64_saturating_mul() {
    eprintln!(r#"Testing "Properties for [`u64::saturating_mul`]"... (3 contracts)"#);
    eprint!("  ");
    // ## Semantics of the saturating multiplication
    // __Inputs:__ `x : u64, y : u64`
    // __Precondition:__ `true`
    // __Postcondition:__ `x.saturating_mul(y) == u64::down((x.up() * y.up()).min(u64::MAX.up()))`
    {
        ...
        assert!(
            9881313458577801838u64.saturating_mul(14838910037206159185u64)
                == 18446744073709551615u64
        );
        assert!(
            10059282949459022608u64.saturating_mul(8891251196185004628u64)
                == 18446744073709551615u64
        );
        assert!(
            4702321361377098870u64.saturating_mul(14985769649829701040u64)
                == 18446744073709551615u64
        );
        assert!(
            14747864928272885034u64.saturating_mul(6328669897182828278u64)
                == 18446744073709551615u64
        );
        assert!(
            16818969505459717763u64.saturating_mul(9980144830089487543u64)
                == 18446744073709551615u64
        );
    }
    eprint!("... ");
...
pub fn core_ops_mul_u64_wrapped_mul() {
    eprintln!(r#"Testing "Properties for [`u64::wrapping_mul`]"... (8 contracts)"#);
    eprint!("  ");
    // ## Semantics of the wrapping multiplication
    // __Inputs:__ `x : u64, y : u64`
    // __Precondition:__ `true`
    // __Postcondition:__ `x.wrapping_mul(y) == u64::down((x.up() * y.up()) % (u64::MAX.up() + 1))`
    {
        ...
        assert!(
            5432415670996629373u64.wrapping_mul(16592920368332096913u64) == 6225195289057156813u64
        );
        assert!(
            2518857302628044116u64.wrapping_mul(10025297938972593643u64) == 17338698809363496988u64
        );
        assert!(
            4280720747492907308u64.wrapping_mul(4224406619351706851u64) == 14332598317284155908u64
        );
        assert!(
            11721522810526901407u64.wrapping_mul(16358703112234022177u64)
                == 18338709598632452991u64
        );
        assert!(
            2875970237586455994u64.wrapping_mul(7979239098626718637u64) == 17984300689677620402u64
        );
    }
    eprint!("... ");
    // ## Semantics of the non-overflowing wrapping multiplication
    ...
    {
        assert!(
            1u64 * (0u64 + 18446744073709551614u64) == 1u64 * 0u64 + 1u64 * 18446744073709551614u64
        );
        ...
        assert!(
            1u64 * (18446744073709551615u64 + 0u64) == 1u64 * 18446744073709551615u64 + 1u64 * 0u64
        );
        assert!(
            1u64 * (0u64 + 18446744073709551615u64) == 1u64 * 0u64 + 1u64 * 18446744073709551615u64
        );
        assert!(
            18446744073709551615u64 * (0u64 + 0u64)
                == 18446744073709551615u64 * 0u64 + 18446744073709551615u64 * 0u64
...
pub fn core_ops_add_u64_sub() {
    eprintln!(r#"Testing "Properties for [`core::ops::Sub::<u64>::sub`]"... (4 contracts)"#);
    eprint!("  ");
    // ## Semantics of non-underflowing subtraction
    // __Inputs:__ `x : u64, y : u64`
    // __Precondition:__ `x.up() - y.up() >= 0u8.up()`
    ...
    // __Postcondition:__ `(x - y) + y == x`
    {
        ...
        assert!((18446744073709551614u64 - 1u64) + 1u64 == 18446744073709551614u64);
        assert!(
            (1982518616540436121u64 - 105772265504642273u64) + 105772265504642273u64
                == 1982518616540436121u64
        );
        assert!(
            (9402821684265331485u64 - 8186099806271199278u64) + 8186099806271199278u64
                == 9402821684265331485u64
        );
        assert!(
            (17863537011890604140u64 - 1742308977411726754u64) + 1742308977411726754u64
                == 17863537011890604140u64
        );
        assert!(
            (17623714523438472493u64 - 4061459252554808638u64) + 4061459252554808638u64
                == 17623714523438472493u64
        );
        assert!(
            (5537948368172586122u64 - 1349377895950166936u64) + 1349377895950166936u64
                == 5537948368172586122u64
        );
        assert!(
            (11885240300150246849u64 - 8847082319360437869u64) + 8847082319360437869u64
...
pub fn core_ops_add_u64_wrapping_sub() {
    eprintln!(r#"Testing "Properties for [`u64::wrapping_sub`]"... (5 contracts)"#);
    eprint!("  ");
    // ## Semantics of non-underflowing wrapping subtraction
    // __Inputs:__ `x : u64, y : u64`
    // __Precondition:__ `x.up() - y.up() >= 0u8.up()`
    // __Postcondition:__ `x.wrapping_sub(y) == u64::down(x.up() - y.up())`
    {
        ...
        assert!(
            4295550399245113325u64.wrapping_sub(3147990774445253290u64) == 1147559624799860035u64
        );
        assert!(
            18265225007942576899u64.wrapping_sub(4793280566019501597u64) == 13471944441923075302u64
        );
        assert!(
            5193605276663690913u64.wrapping_sub(5073508740881909483u64) == 120096535781781430u64
        );
        assert!(
            14894656982776678141u64.wrapping_sub(8781773428527472416u64) == 6112883554249205725u64
        );
        assert!(
            17274840230231201528u64.wrapping_sub(6487398083804802028u64) == 10787442146426399500u64
        );
        assert!(
            15144640083175735678u64.wrapping_sub(1995539115987487138u64) == 13149100967188248540u64
        );
    }
    eprint!("... ");
    // ## Semantics of underflowing wrapping subtraction
    ...
    // __Postcondition:__ `x.wrapping_sub(y) == u64::down(x.up() - y.up() + u64::MAX + 1)`
    {
        ...
        assert!(
            7659176418402310679u64.wrapping_sub(11197173811801213850u64) == 14908746680310648445u64
        );
        assert!(
            5828290851460186584u64.wrapping_sub(8567057937518386626u64) == 15707976987651351574u64
        );
        assert!(
            13903035624928381945u64.wrapping_sub(14322821320173388365u64)
                == 18026958378464545196u64
        );
        assert!(
            12596077344238981323u64.wrapping_sub(16589997695581851160u64)
                == 14452823722366681779u64
        );
        assert!(
            13785663631092317216u64.wrapping_sub(17778433844810101484u64)
    ...
    // __Postcondition:__ `x.wrapping_sub(y) == u64::down((x.up() - y.up()).rem_euclid(&(u64::MAX.up() + 1)))`
    {
        ...
        assert!(0u64.wrapping_sub(18446744073709551615u64) == 1u64);
        assert!(
            18446744073709551614u64.wrapping_sub(18446744073709551615u64)
                == 18446744073709551615u64
        );
        assert!(0u64.wrapping_sub(18446744073709551614u64) == 2u64);
        assert!(1u64.wrapping_sub(1u64) == 0u64);
        assert!(
            18053880868088225997u64.wrapping_sub(7947735979830574634u64) == 10106144888257651363u64
        );
        assert!(
            8904942849206518349u64.wrapping_sub(8640816945855508782u64) == 264125903351009567u64
        );
        assert!(
            7007524204023294449u64.wrapping_sub(6968744497169713346u64) == 38779706853581103u64
        );
        assert!(
            3391067057377774432u64.wrapping_sub(14002964176719122596u64) == 7834846954368203452u64
        );
        assert!(
            13037521112532359648u64.wrapping_sub(12686920894512140250u64) == 350600218020219398u64
        );
    }
    eprint!("... ");
    // ## Wrapping subtraction is the reverse of wrapping subtraction
    ...
    // __Postcondition:__ `(x.wrapping_sub(y)).wrapping_add(y) == x`
    {
        ...
        assert!(
            (18446744073709551615u64.wrapping_sub(18446744073709551615u64))
                .wrapping_add(18446744073709551615u64)
                == 18446744073709551615u64
        );
        assert!(
            (18446744073709551615u64.wrapping_sub(1u64)).wrapping_add(1u64)
                == 18446744073709551615u64
        );
        assert!(
            (0u64.wrapping_sub(18446744073709551614u64)).wrapping_add(18446744073709551614u64)
                == 0u64
        );
        assert!(
            (9586776892199351783u64.wrapping_sub(14804343499298723784u64))
                .wrapping_add(14804343499298723784u64)
                == 9586776892199351783u64
        );
        assert!(
            (5461347418438641227u64.wrapping_sub(7244397506374584039u64))
                .wrapping_add(7244397506374584039u64)
                == 5461347418438641227u64
        );
        assert!(
            (15233655541217232357u64.wrapping_sub(14283253323550432907u64))
                .wrapping_add(14283253323550432907u64)
                == 15233655541217232357u64
        );
        assert!(
            (7138101779155896809u64.wrapping_sub(12244600732773038107u64))
                .wrapping_add(12244600732773038107u64)
                == 7138101779155896809u64
        );
        assert!(
            (12239864750045454708u64.wrapping_sub(15482655176856963924u64))
                .wrapping_add(15482655176856963924u64)
                == 12239864750045454708u64
        );
    }
    eprint!("... ");
    // ## Left identity
...
pub fn core_ops_add_u64_checked_sub() {
    eprintln!(r#"Testing "Properties for [`u64::checked_sub`]"... (4 contracts)"#);
    eprint!("  ");
    // ## Semantics of non-underflowing checked subtraction
    // __Inputs:__ `x : u64, y : u64`
    // __Precondition:__ `x.up() - y.up() >= 0u8.up()`
    // __Postcondition:__ `x.checked_sub(y) == Some(u64::down(x.up() - y.up()))`
    {
        ...
        assert!(
            2886275021644884670u64.checked_sub(1581189677190709656u64)
                == Some(1305085344454175014u64)
        );
        assert!(
            12271864926647756730u64.checked_sub(10388910563731901193u64)
                == Some(1882954362915855537u64)
        );
        assert!(
            5432036582764001613u64.checked_sub(3229984707734507197u64)
                == Some(2202051875029494416u64)
        );
        assert!(
            4268359746359127824u64.checked_sub(545900495087335535u64)
                == Some(3722459251271792289u64)
        );
        assert!(
            15979193445098486764u64.checked_sub(7524437615397424091u64)
                == Some(8454755829701062673u64)
        );
        assert!(
            12346791969837155010u64.checked_sub(7570312225275793264u64)
                == Some(4776479744561361746u64)
        );
        assert!(
            5905321547289298441u64.checked_sub(1804922977740839927u64)
...
pub fn core_ops_sub_u64_saturating_sub() {
    eprintln!(r#"Testing "Properties for [`u64::saturating_sub`]"... (3 contracts)"#);
    eprint!("  ");
    // ## Semantics of the saturating subtraction
    // __Inputs:__ `x : u64, y : u64`
    // __Precondition:__ `true`
    // __Postcondition:__ `x.saturating_sub(y) == u64::down((x.up() - y.up()).max(0u8.up()))`
    {
        ...
        assert!(
            17811903049872051074u64.saturating_sub(5248577990810077986u64)
                == 12563325059061973088u64
        );
        assert!(
            16090473597048357249u64.saturating_sub(15634927699458788116u64)
                == 455545897589569133u64
        );
        assert!(
            15714514304358922607u64.saturating_sub(132002802910082977u64)
    ...
    // __Postcondition:__ `x.saturating_sub(y) == u64::down(x.up() - y.up())`
    {
        ...
        assert!(
            6970554964460043766u64.saturating_sub(649278899521555957u64) == 6321276064938487809u64
        );
        assert!(
            16708850109370470318u64.saturating_sub(5581528993991986871u64)
                == 11127321115378483447u64
        );
        assert!(
            17256974872256090380u64.saturating_sub(2098396596098643408u64)
                == 15158578276157446972u64
        );
        assert!(
            16465277308234684917u64.saturating_sub(8724892251868553553u64)
                == 7740385056366131364u64
        );
        assert!(
            14182904310960017581u64.saturating_sub(13745592713603204808u64)
...
pub fn core_ops_add_u64_add() {
    ...
    // __Postcondition:__ `x + y == y + x`
    {
        ...
        assert!(0u64 + 18446744073709551614u64 == 18446744073709551614u64 + 0u64);
        assert!(
            1440915559954330757u64 + 9779481805413251048u64
                == 9779481805413251048u64 + 1440915559954330757u64
        );
        assert!(
            8623412268454678230u64 + 7953187344132322397u64
                == 7953187344132322397u64 + 8623412268454678230u64
        );
        assert!(
            16893466379395401071u64 + 1119554388119524567u64
                == 1119554388119524567u64 + 16893466379395401071u64
        );
        assert!(
            13064162570492401382u64 + 4559277057822536287u64
                == 4559277057822536287u64 + 13064162570492401382u64
        );
        assert!(
            2420322760408236841u64 + 3134979596377233738u64
                == 3134979596377233738u64 + 2420322760408236841u64
        );
        assert!(
            12142414795174052203u64 + 510087825373511993u64
...
pub fn core_ops_add_u64_wrapping_add() {
    eprintln!(r#"Testing "Properties for [`u64::wrapping_add`]"... (7 contracts)"#);
    eprint!("  ");
    // ## Semantics of the wrapping addition
    // __Inputs:__ `x : u64, y : u64`
    // __Precondition:__ `true`
    // __Postcondition:__ `x.wrapping_add(y) == u64::down((x.up() + y.up()) % (u64::MAX.up() + 1))`
    {
        ...
        assert!(
            11497329531226800046u64.wrapping_add(17645961346674826711u64)
                == 10696546804192075141u64
        );
        assert!(
            2523504136897224141u64.wrapping_add(9228819589347923377u64) == 11752323726245147518u64
        );
        assert!(
            5752567711560929977u64.wrapping_add(10165562949348682446u64) == 15918130660909612423u64
        );
        assert!(
            14074322408488401055u64.wrapping_add(11571250499169383567u64) == 7198828833948233006u64
        );
        assert!(
            9517898234019986828u64.wrapping_add(15099555483445413901u64) == 6170709643755849113u64
        );
    }
    eprint!("... ");
    // ## Semantics of non-overflowing wrapping addition
    ...
    // __Postcondition:__ `x.wrapping_add(y) == u64::down(x.up() + y.up())`
    {
        ...
        assert!(18446744073709551614u64.wrapping_add(1u64) == 18446744073709551615u64);
        assert!(
            11282832288790894640u64.wrapping_add(3810074944710141816u64) == 15092907233501036456u64
        );
        assert!(
            1021382167855581400u64.wrapping_add(6225662797027278438u64) == 7247044964882859838u64
        );
        assert!(
            323516598024964659u64.wrapping_add(13035419856752040698u64) == 13358936454777005357u64
        );
        assert!(
            12289997749622152191u64.wrapping_add(3491378156440941595u64) == 15781375906063093786u64
        );
        assert!(
            8668033732465009278u64.wrapping_add(5962115806564720216u64) == 14630149539029729494u64
        );
        assert!(
            4772276148552105127u64.wrapping_add(12882300185907866151u64) == 17654576334459971278u64
        );
    }
    eprint!("... ");
    // ## Semantics of the overflowing wrapping addition
    ...
    {
        assert!(
            18446744073709551614u64.wrapping_add(18446744073709551614u64)
        ...
        assert!(
            18446744073709551615u64.wrapping_add(18446744073709551615u64)
        ...
        assert!(
            8395306402826299605u64.wrapping_add(18268856737362686463u64) == 8217419066479434452u64
        );
        assert!(
            10855466145140215156u64.wrapping_add(11174015099546791945u64) == 3582737170977455485u64
        );
        assert!(
            5261055245441060330u64.wrapping_add(16946809371679253683u64) == 3761120543410762397u64
        );
        assert!(
            11784821798150687613u64.wrapping_add(13658261105965021065u64) == 6996338830406157062u64
        );
    }
    eprint!("... ");
    // ## Commutativity
    ...
    // __Postcondition:__ `x.wrapping_add(y) == y.wrapping_add(x)`
    {
        ...
        assert!(
            18446744073709551614u64.wrapping_add(0u64)
        ...
        assert!(
            17629253343937043598u64.wrapping_add(4760858582179607883u64)
                == 4760858582179607883u64.wrapping_add(17629253343937043598u64)
        );
        assert!(
            9381576514058642618u64.wrapping_add(10827321634667638631u64)
                == 10827321634667638631u64.wrapping_add(9381576514058642618u64)
        );
        assert!(
            16190602992964236701u64.wrapping_add(2142813998948933493u64)
                == 2142813998948933493u64.wrapping_add(16190602992964236701u64)
        );
        assert!(
            9760671215100479997u64.wrapping_add(13115199433494600937u64)
                == 13115199433494600937u64.wrapping_add(9760671215100479997u64)
        );
        assert!(
            10642062179775747426u64.wrapping_add(16078920244474320563u64)
    ...
    // __Postcondition:__ `(x.wrapping_add(y)).wrapping_add(z) == x.wrapping_add(y.wrapping_add(z))`
    {
        ...
        assert!(
            (7992379714619961784u64.wrapping_add(5395939545173631554u64))
        ...
        assert!(
            (2839265273189607235u64.wrapping_add(4064859409454933605u64))
        ...
        assert!(
            (9318122716365391050u64.wrapping_add(361746444172479746u64))
        ...
        assert!(
            (303657065953992066u64.wrapping_add(2954525626561174298u64))
...
pub fn core_ops_add_u64_checked_add() {
    ...
    // __Postcondition:__ `x.checked_add(y) == Some(u64::down(x.up() + y.up()))`
    {
        ...
        assert!(
            4067254209563317489u64.checked_add(7306047880005491721u64)
                == Some(11373302089568809210u64)
        );
        assert!(
            3476509367821100462u64.checked_add(10261534538333706118u64)
                == Some(13738043906154806580u64)
        );
        assert!(
            9516601890714965454u64.checked_add(389146804558578938u64)
                == Some(9905748695273544392u64)
        );
        assert!(
            5569709721449974863u64.checked_add(5404991929729897711u64)
                == Some(10974701651179872574u64)
        );
        assert!(
            4327954126007052286u64.checked_add(5035172111931420468u64)
    ...
    // __Postcondition:__ `x.checked_add(y) == y.checked_add(x)`
    {
        ...
        assert!(
            18446744073709551615u64.checked_add(1u64) == 1u64.checked_add(18446744073709551615u64)
        );
        assert!(
            0u64.checked_add(18446744073709551615u64) == 18446744073709551615u64.checked_add(0u64)
        );
        assert!(
            18446744073709551614u64.checked_add(18446744073709551615u64)
                == 18446744073709551615u64.checked_add(18446744073709551614u64)
        );
        assert!(
            1072994177747969064u64.checked_add(6945007417353748628u64)
                == 6945007417353748628u64.checked_add(1072994177747969064u64)
        );
        assert!(
            8525389765938437305u64.checked_add(4777747194165159641u64)
                == 4777747194165159641u64.checked_add(8525389765938437305u64)
        );
        assert!(
            3307483026636985139u64.checked_add(9362931579535312760u64)
                == 9362931579535312760u64.checked_add(3307483026636985139u64)
        );
        assert!(
            9162319209807707428u64.checked_add(13086863034179529216u64)
                == 13086863034179529216u64.checked_add(9162319209807707428u64)
        );
        assert!(
            5260534946306240568u64.checked_add(14622473656912468386u64)
    ...
    //         == y.checked_add(z).and_then(|iv| x.checked_add(iv))`
    {
        ...
        assert!(
            18446744073709551614u64
                ...
                == 1u64
                    .checked_add(0u64)
                    .and_then(|iv| 18446744073709551614u64.checked_add(iv))
        );
        assert!(
            18446744073709551615u64
                .checked_add(1u64)
...
pub fn core_ops_add_u64_saturating_add() {
    eprintln!(r#"Testing "Properties for [`u64::saturating_add`]"... (3 contracts)"#);
    eprint!("  ");
    // ## Semantics of the saturating addition
    // __Inputs:__ `x : u64, y : u64`
    // __Precondition:__ `true`
    // __Postcondition:__ `x.saturating_add(y) == u64::down((x.up() + y.up()).min(u64::MAX.up()))`
    {
        ...
        assert!(
            18446744073709551615u64.saturating_add(18446744073709551614u64)
                == 18446744073709551615u64
        );
        ...
        assert!(
            18446744073709551614u64.saturating_add(18446744073709551615u64)
                == 18446744073709551615u64
        );
        assert!(
            541387966228545948u64.saturating_add(63915623614872842u64) == 605303589843418790u64
        );
        assert!(
            15239498299998639604u64.saturating_add(16105248499582893708u64)
                == 18446744073709551615u64
        );
        assert!(
            2291202630201986527u64.saturating_add(16950175483481505316u64)
                == 18446744073709551615u64
        );
        assert!(
            13339534060194688678u64.saturating_add(16744578176459419040u64)
                == 18446744073709551615u64
        );
    }
    eprint!("... ");
    ...
    // __Postcondition:__ `x.saturating_add(y) == u64::down(x.up() + y.up())`
    {
        ...
        assert!(
            702133583256102253u64.saturating_add(8002151453192877111u64) == 8704285036448979364u64
        );
        assert!(
            422236904932363843u64.saturating_add(17016393797660234318u64)
                == 17438630702592598161u64
        );
        assert!(
            2225441287772132075u64.saturating_add(517188340883590026u64) == 2742629628655722101u64
        );
        assert!(
            9662402388100658631u64.saturating_add(872315084759208151u64) == 10534717472859866782u64
        );
        assert!(
            5162698224122104094u64.saturating_add(11408621137122469995u64)
...
pub fn core_ops_rem_u128_rem() {
    eprintln!(r#"Testing "Properties for [`core::ops::Rem::<u128>::rem`]"... (2 contracts)"#);
    eprint!("  ");
    // ## Semantics of rem
    ...
    // __Postcondition:__ `x % y == u128::down(x.up() % y.up())`
    {
        ...
        assert!(
            165279567009091147950063193432337719155u128
                % 155749280621017155545022556905659026770u128
                == 9530286388073992405040636526678692385u128
        );
        assert!(
            118592575597622308504946721463665697917u128
        ...
        assert!(
            329139448216202008444380637023426590410u128
                % 13926876413228973622391292715593217868u128
                == 8821290711935615129380904564782579446u128
        );
        assert!(
            239014478764977911136584437733855150507u128
...
pub fn core_ops_rem_u128_checked_rem() {
    eprintln!(r#"Testing "Properties for [`u128::checked_rem`]"... (2 contracts)"#);
    eprint!("  ");
    // ## Semantics of checked_rem
    // __Inputs:__ `x : u128, y : u128`
    // __Precondition:__ `y != 0`
...
pub fn t_u128_checked_neg() {
    eprintln!(r#"Testing "Properties for [`u128::checked_neg`]"... (2 contracts)"#);
    eprint!("  ");
    // ## Semantics of checked neg when out of bounds
    // __Inputs:__ `x : u128`
...
pub fn core_ops_shl_u128_shl() {
    eprintln!(r#"Testing "Properties for [`core::ops::Shl::<u128>::shl`]"... (2 contracts)"#);
    eprint!("  ");
    // ## Semantics of the left shift when the number of bits is right
    ...
    {
        assert!(
            340282366920938463463374607431768211454u128 << 0u32
                == 340282366920938463463374607431768211454u128
        );
        ...
        assert!(
            113699248844852967389607659790730454124u128 << 40u32
                == 799980777798157323152109115403141120u128
        );
        assert!(
            90613784064571567748980140286851503002u128 << 16u32
                == 197367318465138097812199547313042620416u128
        );
        assert!(
            157815862717777113875853390533849819491u128 << 44u32
                == 72223912803883472540372308726386786304u128
        );
        assert!(
            213072217016016640595196483961503348645u128 << 119u32
                == 279802493112724791246251386189012533248u128
        );
        assert!(
            327476622907742198811587862309285562577u128 << 115u32
    ...
    {
        assert!(panics!(
            340282366920938463463374607431768211454u128 << 4294967295u32
        ));
        assert!(panics!(0u128 << 4294967295u32));
        assert!(panics!(
            340282366920938463463374607431768211455u128 << 4294967294u32
        ));
        assert!(panics!(1u128 << 4294967295u32));
        assert!(panics!(0u128 << 4294967294u32));
        assert!(panics!(1u128 << 4294967294u32));
        assert!(panics!(
            298345759450429921398906082834388091650u128 << 133u32
        ));
        assert!(panics!(
            218370933246023631170111892818660806576u128 << 135u32
        ));
        assert!(panics!(
            163203166328356871898192568439542855733u128 << 130u32
        ));
        assert!(panics!(
            248200426393977888511028413289271196069u128 << 134u32
        ));
    }
    eprint!("... ");
    eprintln!("✓\n");
...
pub fn core_ops_shl_u128_checked_shl() {
    eprintln!(
        r#"Testing "Properties for [`core::ops::Shl::<u128>::checked_shl`]"... (2 contracts)"#
    );
    eprint!("  ");
    // ## Semantics of the left shift when the number of bits is right
    // __Inputs:__ `x : u128, y : u32`
    ...
    {
        assert!(
            340282366920938463463374607431768211454u128.checked_shl(1u32)
                == Some(340282366920938463463374607431768211452u128)
        );
        assert!(
            340282366920938463463374607431768211455u128.checked_shl(0u32)
        ...
        assert!(
            290378029557449922155347396468709090772u128.checked_shl(35u32)
                == Some(129957054640666072357467003393098645504u128)
        );
        assert!(
            160915236427804063474725500722692375970u128.checked_shl(93u32)
                == Some(151681446594316408214864499455731695616u128)
        );
        assert!(
            330830281648505852581083907648998636656u128.checked_shl(85u32)
                == Some(167124429794415400510601513089808465920u128)
        );
        assert!(
            240262733941476922113253463484465635792u128.checked_shl(2u32)
                == Some(280486201924030761526264639074326120256u128)
        );
        assert!(
            146734302021290512383664444249087110056u128.checked_shl(3u32)
                == Some(153027315407508708679191731697392246080u128)
        );
        assert!(
            300910112010925888762557769234171023349u128.checked_shl(29u32)
...
pub fn core_ops_shl_u128_overflowing_shl() {
    eprintln!(
        r#"Testing "Properties for [`core::ops::Shl::<u128>::overflowing_shl`]"... (2 contracts)"#
    );
    eprint!("  ");
    // ## Semantics of the left shift when the number of bits is right
    // __Inputs:__ `x : u128, y : u32`
    ...
    {
        assert!(
            340282366920938463463374607431768211454u128.overflowing_shl(0u32)
        ...
        assert!(
            340282366920938463463374607431768211455u128.overflowing_shl(0u32)
                == (340282366920938463463374607431768211455u128, false)
        );
        assert!(
            273062793211525393081434930449763094349u128.overflowing_shl(42u32)
                == (203646907561105097508361117802061365248u128, false)
        );
        assert!(
            222687750525370170390805015705304183567u128.overflowing_shl(67u32)
                == (127072533518383489178496267763515916288u128, false)
        );
        assert!(
            23262435629076802430100176875137600124u128.overflowing_shl(117u32)
                == (105673625664900811895852661292287393792u128, false)
        );
        assert!(
            215721255784434349554365950908791109239u128.overflowing_shl(43u32)
                == (305933467357588934554990651985602019328u128, false)
        );
        assert!(
            256613329837541252657572489782251104195u128.overflowing_shl(92u32)
                == (47749061352160231268963283348291059712u128, false)
        );
        assert!(
            190753225078727606021418083476136186571u128.overflowing_shl(67u32)
    ...
    {
        assert!(
            340282366920938463463374607431768211454u128.overflowing_shl(4294967294u32)
                == (170141183460469231731687303715884105728u128, true)
        );
        assert!(0u128.overflowing_shl(4294967294u32) == (0u128, true));
        assert!(
            340282366920938463463374607431768211455u128.overflowing_shl(4294967294u32)
                == (255211775190703847597530955573826158592u128, true)
        );
        assert!(
            340282366920938463463374607431768211454u128.overflowing_shl(4294967295u32)
                == (0u128, true)
        );
        assert!(0u128.overflowing_shl(4294967295u32) == (0u128, true));
        assert!(
            1u128.overflowing_shl(4294967295u32)
                == (170141183460469231731687303715884105728u128, true)
        );
        assert!(
            4117347195829555112140947184055320116u128.overflowing_shl(132u32)
                == (65877555133272881794255154944885121856u128, true)
        );
        assert!(
            150132961496137677501697823274894503378u128.overflowing_shl(131u32)
                == (180216591206286029623458763903851392656u128, true)
        );
        assert!(
            127753090255186701627295598903286917366u128.overflowing_shl(128u32)
                == (127753090255186701627295598903286917366u128, true)
        );
        assert!(
            205846817790232398794448435929604951720u128.overflowing_shl(135u32)
...
pub fn core_ops_shr_u128_shr() {
    eprintln!(r#"Testing "Properties for [`core::ops::Shr::<u128>::shr`]"... (2 contracts)"#);
    eprint!("  ");
    // ## Semantics of the right shift when the number of bits is right
    // __Inputs:__ `x : u128, y : u32`
    // __Precondition:__ `y < u128::BITS`
    // __Postcondition:__ `x >> y == u128::down((x.up() >> y) & u128::MAX.up())`
    {
        assert!(0u128 >> 1u32 == 0u128);
        assert!(
            340282366920938463463374607431768211455u128 >> 0u32
                == 340282366920938463463374607431768211455u128
        );
        assert!(0u128 >> 0u32 == 0u128);
        assert!(
            340282366920938463463374607431768211455u128 >> 1u32
                == 170141183460469231731687303715884105727u128
        );
        assert!(1u128 >> 1u32 == 0u128);
        assert!(
            340282366920938463463374607431768211454u128 >> 1u32
                == 170141183460469231731687303715884105727u128
        );
        assert!(
            227089335066104853425697743040453938492u128 >> 46u32 == 3227133547996243882859314u128
        );
    ...
    // __Postcondition:__ `panics!(x >> y)`
    {
        assert!(panics!(1u128 >> 4294967295u32));
        assert!(panics!(
            340282366920938463463374607431768211454u128 >> 4294967294u32
        ));
        assert!(panics!(0u128 >> 4294967294u32));
        assert!(panics!(
            340282366920938463463374607431768211454u128 >> 4294967295u32
        ...
        assert!(panics!(1u128 >> 4294967294u32));
        assert!(panics!(
            340282366920938463463374607431768211455u128 >> 4294967295u32
        ));
        assert!(panics!(
            25897848721839680065148633815835921403u128 >> 135u32
        ));
        assert!(panics!(
            286374049010926090547132480538131864086u128 >> 130u32
        ));
        assert!(panics!(
            304252035078002645993141153496263197842u128 >> 137u32
        ));
        assert!(panics!(
            260508253520686154068986738155264691776u128 >> 135u32
        ));
    }
    eprint!("... ");
    eprintln!("✓\n");
...
pub fn core_ops_shr_u128_checked_shr() {
    eprintln!(
        r#"Testing "Properties for [`core::ops::Shr::<u128>::checked_shr`]"... (2 contracts)"#
    );
    eprint!("  ");
    // ## Semantics of the right shift when the number of bits is right
    // __Inputs:__ `x : u128, y : u32`
    ...
    // __Postcondition:__ `x.checked_shr(y) == Some(u128::down((x.up() >> y) & u128::MAX.up()))`
    {
        ...
        assert!(
            340282366920938463463374607431768211454u128.checked_shr(1u32)
                == Some(170141183460469231731687303715884105727u128)
        );
        assert!(0u128.checked_shr(1u32) == Some(0u128));
        assert!(
            340282366920938463463374607431768211455u128.checked_shr(0u32)
                == Some(340282366920938463463374607431768211455u128)
        );
        assert!(
            252316218034588459971116333202084596065u128.checked_shr(66u32)
                == Some(3419522396830337775u128)
        );
        assert!(
            334190594110102711535156507242418690490u128.checked_shr(83u32)
                == Some(34554497543181u128)
        );
        assert!(
            66145232996116336173724471662930760468u128.checked_shr(28u32)
        ...
        assert!(
            76905542726712586382966936419089068481u128.checked_shr(98u32) == Some(242671104u128)
        );
        assert!(
            278076771542737860680363066365121079009u128.checked_shr(27u32)
...
pub fn core_ops_shr_u128_overflowing_shr() {
    eprintln!(
        r#"Testing "Properties for [`core::ops::Shr::<u128>::overflowing_shr`]"... (2 contracts)"#
    );
    eprint!("  ");
    // ## Semantics of the right shift when the number of bits is right
    // __Inputs:__ `x : u128, y : u32`
    ...
    // __Postcondition:__ `x.overflowing_shr(y) == (u128::down((x.up() >> y) & u128::MAX.up()), false)`
    {
        ...
        assert!(
            340282366920938463463374607431768211454u128.overflowing_shr(0u32)
                == (340282366920938463463374607431768211454u128, false)
        );
        assert!(
            145147086045401703383115577531452243504u128.overflowing_shr(2u32)
                == (36286771511350425845778894382863060876u128, false)
        );
        assert!(
            7380747509478876327918292409468917876u128.overflowing_shr(64u32)
                == (400111124217198697u128, false)
        );
        assert!(
            986798216271145287180268589045388798u128.overflowing_shr(21u32)
                == (470542057166645663824209494135u128, false)
        );
        assert!(
            117546134513307262468459419464613233595u128.overflowing_shr(57u32)
                == (815640156202246824821u128, false)
        );
        assert!(
            91801043877071481930841570278220029760u128.overflowing_shr(52u32)
    ...
    //         == (u128::down((x.up() >> (y & (u128::BITS - 1)) & u128::MAX.up())), true)`
    {
        ...
        assert!(
            340282366920938463463374607431768211454u128.overflowing_shr(4294967294u32)
                == (3u128, true)
        );
        assert!(0u128.overflowing_shr(4294967295u32) == (0u128, true));
        assert!(1u128.overflowing_shr(4294967294u32) == (0u128, true));
        assert!(
            340282366920938463463374607431768211455u128.overflowing_shr(4294967294u32)
                == (3u128, true)
        );
        assert!(
            340282366920938463463374607431768211454u128.overflowing_shr(4294967295u32)
                == (1u128, true)
        );
        assert!(
            205157128168528260251075194667511472862u128.overflowing_shr(132u32)
                == (12822320510533016265692199666719467053u128, true)
        );
        assert!(
            330820758495165359424854114445849632634u128.overflowing_shr(132u32)
                == (20676297405947834964053382152865602039u128, true)
        );
        assert!(
            332873604912822982328031719059567428156u128.overflowing_shr(132u32)
                == (20804600307051436395501982441222964259u128, true)
        );
        assert!(
            311981185646969099307405436089504526249u128.overflowing_shr(133u32)
...
pub fn core_ops_div_u128_div() {
    eprintln!(r#"Testing "Properties for [`core::ops::Div::<u128>::div`]"... (2 contracts)"#);
    eprint!("  ");
    // ## Semantics of the division by non-zero
    // __Inputs:__ `x : u128, y : u128`
    // __Precondition:__ `y != 0`
...
pub fn core_ops_div_u128_saturating_div() {
    eprintln!(r#"Testing "Properties for [`u128::saturating_div`]"... (2 contracts)"#);
    eprint!("  ");
    // ## Semantics of the saturating division by non-zero
    // __Inputs:__ `x : u128, y : u128`
    // __Precondition:__ `y != 0`
    // __Postcondition:__ `x.saturating_div(y) == u128::down(x.up() / y.up())`
    {
        ...
        assert!(
            340282366920938463463374607431768211455u128
                .saturating_div(340282366920938463463374607431768211455u128)
                == 1u128
        );
    ...
    // __Postcondition:__ `{ #[allow(unconditional_panic)] { panics!(x.saturating_div(0)) } }`
    {
        ...
        assert!({
            #[allow(unconditional_panic)]
            {
                panics!(1u128.saturating_div(0))
            }
        });
        assert!({
            #[allow(unconditional_panic)]
            {
                panics!(0u128.saturating_div(0))
            }
        });
        assert!({
            #[allow(unconditional_panic)]
...
pub fn core_ops_div_u128_checked_div() {
    eprintln!(r#"Testing "Properties for [`u128::checked_div`]"... (2 contracts)"#);
    eprint!("  ");
    // ## Semantics of the checked division by non-zero
    // __Inputs:__ `x : u128, y : u128`
    // __Precondition:__ `y != 0`
    ...
    {
        assert!(
            340282366920938463463374607431768211455u128.checked_div(1u128)
                == Some(340282366920938463463374607431768211455u128)
        );
        ...
        assert!(
            340282366920938463463374607431768211454u128
                .checked_div(340282366920938463463374607431768211455u128)
                == Some(0u128)
        );
...
pub fn core_ops_mul_u128_mul() {
    eprintln!(r#"Testing "Properties for [`core::ops::Mul::<u128>::mul`]"... (8 contracts)"#);
    eprint!("  ");
    // ## Semantics of non-overflowing multiplication
    // __Inputs:__ `x : u128, y : u128`
    ...
    // __Postcondition:__ `x * y == u128::down(x.up() * y.up())`
    {
        ...
        assert!(
            7639995825759736334u128 * 17860086828532616057u128
                == 136450988817695634443839018347574715038u128
        );
        assert!(
            16281002121915483873u128 * 14148649613035636975u128
                == 230354194372071895384022840199895004175u128
        );
        assert!(
            11845496803890765291u128 * 17181543683154905681u128
                == 203523920784721002956806729200013518171u128
        );
        assert!(
            14384219805716337283u128 * 12666709440447847079u128
                == 182200732806544026248484060674770346357u128
        );
        assert!(
            13152133472268433799u128 * 6558971202327073955u128
    ...
    // __Postcondition:__ `panics!(x * y)`
    {
        ...
        assert!(panics!(
            92215479319180434583445357332287493602u128 * 94588336230098751161255056992706707629u128
        ));
        assert!(panics!(
        ...
        assert!(panics!(
            2143163717716865484452562791705878744u128 * 95899835590197703861268552289701909710u128
        ));
        assert!(panics!(
    ...
    // __Postcondition:__ `x * 1 == x`
    {
        ...
        assert!(
            340282366920938463463374607431768211454u128 * 1
                == 340282366920938463463374607431768211454u128
        );
        assert!(
            340282366920938463463374607431768211455u128 * 1
                == 340282366920938463463374607431768211455u128
        );
        assert!(
            323398883111353050535216765365422167135u128 * 1
                == 323398883111353050535216765365422167135u128
        );
        assert!(
            27084669087016087507040569092277562128u128 * 1
                == 27084669087016087507040569092277562128u128
        );
        assert!(
            301728536402245270044733024919450119512u128 * 1
                == 301728536402245270044733024919450119512u128
        );
        assert!(
            43693108635911089097878490538692307499u128 * 1
                == 43693108635911089097878490538692307499u128
        );
        assert!(
            139345012202111874863187473531434707926u128 * 1
                == 139345012202111874863187473531434707926u128
        );
        assert!(
            192561938780087606125017869802848647664u128 * 1
    ...
    // __Postcondition:__ `1 * x == x`
    {
        ...
        assert!(
            1 * 340282366920938463463374607431768211454u128
                == 340282366920938463463374607431768211454u128
        );
        assert!(1 * 1u128 == 1u128);
        assert!(
            1 * 340282366920938463463374607431768211455u128
                == 340282366920938463463374607431768211455u128
        );
        assert!(
            1 * 83773179705874749868750107536879646905u128
                == 83773179705874749868750107536879646905u128
        );
        assert!(
            1 * 149234296699894407131051174300472455942u128
                == 149234296699894407131051174300472455942u128
        );
        assert!(
            1 * 289075967976799078005570046526840138916u128
                == 289075967976799078005570046526840138916u128
        );
        assert!(
            1 * 284262508681214563494059192615803605835u128
                == 284262508681214563494059192615803605835u128
        );
        assert!(
            1 * 124319690496438992226313912496406185831u128
                == 124319690496438992226313912496406185831u128
        );
        assert!(
            1 * 300904288351288325486295304777504366228u128
    ...
    // __Postcondition:__ `x * y == y * x`
    {
        ...
        assert!(
            15016942196816340231u128 * 12345843113174583806u128
                == 12345843113174583806u128 * 15016942196816340231u128
        );
        assert!(
            15806478996168778861u128 * 2740748031492392192u128
                == 2740748031492392192u128 * 15806478996168778861u128
        );
        assert!(
            11679538403219276618u128 * 14230299515892364820u128
                == 14230299515892364820u128 * 11679538403219276618u128
        );
        assert!(
            16531867865092608363u128 * 9033901760114313633u128
    ...
    {
        assert!(
            340282366920938463463374607431768211455u128 * (0u128 + 1u128)
                == 340282366920938463463374607431768211455u128 * 0u128
                    + 340282366920938463463374607431768211455u128 * 1u128
        );
        assert!(
            1u128 * (340282366920938463463374607431768211455u128 + 0u128)
                == 1u128 * 340282366920938463463374607431768211455u128 + 1u128 * 0u128
        );
        assert!(
            1u128 * (340282366920938463463374607431768211454u128 + 0u128)
        ...
        assert!(
            5898985982122711071u128 * (5957257819438293248u128 + 8652392982135836625u128)
                == 5898985982122711071u128 * 5957257819438293248u128
                    + 5898985982122711071u128 * 8652392982135836625u128
        );
        assert!(
            9340906336555069035u128 * (16556051974108873240u128 + 13947051649383322990u128)
                == 9340906336555069035u128 * 16556051974108873240u128
                    + 9340906336555069035u128 * 13947051649383322990u128
        );
        assert!(
            11427994037182123460u128 * (7786704897076756510u128 + 13858717242893798616u128)
                == 11427994037182123460u128 * 7786704897076756510u128
                    + 11427994037182123460u128 * 13858717242893798616u128
        );
        assert!(
            6964794453614375117u128 * (17600176743911101129u128 + 16202619245868132820u128)
...
pub fn core_ops_mul_u128_checked_mul() {
    eprintln!(r#"Testing "Properties for [`u128::checked_mul`]"... (2 contracts)"#);
    eprint!("  ");
    // ## Semantics of the non-overflowing checked multiplication
    // __Inputs:__ `x : u128, y : u128`
    // __Precondition:__ `x.up() * y.up() <= u128::MAX.up()`
    // __Postcondition:__ `x.checked_mul(y) == Some(u128::down(x.up() * y.up()))`
    {
        ...
        assert!(
            340282366920938463463374607431768211454u128.checked_mul(1u128)
                == Some(340282366920938463463374607431768211454u128)
        );
        assert!(
            340282366920938463463374607431768211455u128.checked_mul(1u128)
                == Some(340282366920938463463374607431768211455u128)
        );
        assert!(
            1u128.checked_mul(340282366920938463463374607431768211454u128)
                == Some(340282366920938463463374607431768211454u128)
        );
        assert!(0u128.checked_mul(340282366920938463463374607431768211454u128) == Some(0u128));
        assert!(
            6136768359858718133u128.checked_mul(15347231840232234668u128)
                == Some(94182406768553467195007648652522834844u128)
        );
        assert!(
            10908014639762018711u128.checked_mul(12898676648544309170u128)
                == Some(140698953715877815419831474130108879870u128)
        );
        assert!(
            12898939477827596505u128.checked_mul(17492212708577413464u128)
                == Some(225630993061226789143676169232746343320u128)
        );
        assert!(
            9169616702823755461u128.checked_mul(5205773636491371835u128)
    ...
    // __Postcondition:__ `x.checked_mul(y) == None`
    {
        assert!(
            340282366920938463463374607431768211454u128
                .checked_mul(340282366920938463463374607431768211455u128)
                == None
        );
        assert!(
            340282366920938463463374607431768211455u128
        ...
        assert!(
            340282366920938463463374607431768211455u128
                .checked_mul(340282366920938463463374607431768211454u128)
                == None
        );
        assert!(
            340282366920938463463374607431768211454u128
        ...
        assert!(
            221748335776609949256544284742171585881u128
                .checked_mul(190362380640128762393949254536487829340u128)
                == None
        );
        assert!(
            235301169679648115261743680948244280774u128
                .checked_mul(306380302565617946266920760430976921209u128)
                == None
        );
        assert!(
            204224071637174755534954224039238200006u128
                .checked_mul(18936636328705431901592599959960136588u128)
                == None
        );
        assert!(
            331896815991296150407279098636294031100u128
                .checked_mul(88301723616399097115663870940643555475u128)
                == None
        );
        assert!(
            205732473912876210947930349937433490002u128
                .checked_mul(217134854608511427202510890834433496580u128)
                == None
        );
        assert!(
            186993511356311878625085581084737497995u128
                .checked_mul(186988225838583575157246587679914581726u128)
                == None
        );
    }
    eprint!("... ");
...
pub fn core_ops_mul_u128_overflowing_mul() {
    eprintln!(r#"Testing "Properties for [`u128::overflowing_mul`]"... (2 contracts)"#);
    eprint!("  ");
    // ## Semantics of the overflowing multiplication when in bounds
    // __Inputs:__ `x : u128, y : u128`
    // __Precondition:__ `x.up() * y.up() <= u128::MAX.up()`
    ...
    {
        assert!(
            340282366920938463463374607431768211454u128.overflowing_mul(0u128) == (0u128, false)
        );
        assert!(0u128.overflowing_mul(1u128) == (0u128, false));
        assert!(1u128.overflowing_mul(0u128) == (0u128, false));
        assert!(
            1u128.overflowing_mul(340282366920938463463374607431768211454u128)
                == (340282366920938463463374607431768211454u128, false)
        );
        assert!(
            0u128.overflowing_mul(340282366920938463463374607431768211455u128) == (0u128, false)
        );
        assert!(
            10232124421129252380u128.overflowing_mul(3543015323713380429u128)
                == (36252573618202843455000781467293671020u128, false)
        );
        assert!(
            17476534979218915543u128.overflowing_mul(16057178037469094367u128)
                == (280623833639374366185447584432070046281u128, false)
        );
        assert!(
            14114500363151530245u128.overflowing_mul(7163060420961511969u128)
                == (101103018912937613796017445791233002405u128, false)
        );
        assert!(
            12624718350544214166u128.overflowing_mul(14674724001239809405u128)
                == (185264257387623837229420987591341031230u128, false)
        );
        assert!(
            15358422219417496785u128.overflowing_mul(16052642578017461333u128)
    ...
    // __Postcondition:__ `x.overflowing_mul(y) == (x.wrapping_mul(y), true)`
    {
        assert!(
            340282366920938463463374607431768211455u128
                .overflowing_mul(340282366920938463463374607431768211455u128)
                == (1u128, true)
        );
        assert!(
            340282366920938463463374607431768211455u128
                .overflowing_mul(340282366920938463463374607431768211454u128)
                == (2u128, true)
        );
        assert!(
            340282366920938463463374607431768211454u128
...
pub fn core_ops_mul_u128_saturating_mul() {
    eprintln!(r#"Testing "Properties for [`u128::saturating_mul`]"... (3 contracts)"#);
    eprint!("  ");
    // ## Semantics of the saturating multiplication
    // __Inputs:__ `x : u128, y : u128`
    // __Precondition:__ `true`
    ...
    // __Postcondition:__ `x.saturating_mul(y) == u128::down(x.up() * y.up())`
    {
        ...
        assert!(0u128.saturating_mul(0u128) == 0u128);
        assert!(
            340282366920938463463374607431768211455u128.saturating_mul(1u128)
                == 340282366920938463463374607431768211455u128
        );
        assert!(340282366920938463463374607431768211454u128.saturating_mul(0u128) == 0u128);
        assert!(
            18168050045269303466u128.saturating_mul(8261079935280064872u128)
                == 150087713692138317144816496390734446352u128
        );
        assert!(
            7274003378862387191u128.saturating_mul(13753017313961715456u128)
                == 100039494411310430758780619241641124096u128
        );
        assert!(
            15710251315056545666u128.saturating_mul(13024228629657693130u128)
                == 204613904956676885177449227560059474580u128
        );
        assert!(
            16016299688410010759u128.saturating_mul(14394901454365648286u128)
                == 230553055678249343352014198085269909074u128
        );
        assert!(
            1047053115119855844u128.saturating_mul(2874681260604707387u128)
                == 3009943968892833001942621659241919628u128
        );
        assert!(
            6888895277811543253u128.saturating_mul(13114439470974434990u128)
    ...
    // __Postcondition:__ `x.saturating_mul(y) == u128::MAX`
    {
        ...
        assert!(
            152655857682783739587724770132257899302u128
                .saturating_mul(871986886696027129086090492793655398u128)
                == u128::MAX
        );
        assert!(
            200067121025386001049477070757751746616u128
                .saturating_mul(205278458886601658283074201746925767725u128)
                == u128::MAX
        );
        assert!(
            262293487562446711520297159954927324048u128
                .saturating_mul(125767360997567494472567630003926370127u128)
                == u128::MAX
        );
        assert!(
            61157613018998877327259364970692897676u128
                .saturating_mul(219182754227738990891335401600982023503u128)
                == u128::MAX
        );
        assert!(
            340221532097369931781236547007425212446u128
                .saturating_mul(21344994603407580659752222081881278726u128)
                == u128::MAX
        );
        assert!(
            138294415375063936906823893086764848731u128
                .saturating_mul(264313627132524095141221102690857120451u128)
                == u128::MAX
        );
    }
    eprint!("... ");
...
pub fn core_ops_mul_u128_wrapped_mul() {
    eprintln!(r#"Testing "Properties for [`u128::wrapping_mul`]"... (8 contracts)"#);
    eprint!("  ");
    // ## Semantics of the wrapping multiplication
    // __Inputs:__ `x : u128, y : u128`
    // __Precondition:__ `true`
    ...
    // __Postcondition:__ `x.wrapping_mul(y) == u128::down(x.up() * y.up())`
    {
        ...
        assert!(340282366920938463463374607431768211455u128.wrapping_mul(0u128) == 0u128);
        assert!(
            340282366920938463463374607431768211454u128.wrapping_mul(1u128)
                == 340282366920938463463374607431768211454u128
        );
        assert!(340282366920938463463374607431768211454u128.wrapping_mul(0u128) == 0u128);
        assert!(0u128.wrapping_mul(340282366920938463463374607431768211455u128) == 0u128);
        assert!(
            6706775253665056244u128.wrapping_mul(10322403795401668106u128)
                == 69230042333338161945461358679910953864u128
        );
        assert!(
            17248674751419608654u128.wrapping_mul(12446606697342508389u128)
                == 214687470681301927131489261461091998406u128
        );
        assert!(
            4160913603170403992u128.wrapping_mul(7756968626799266473u128)
                == 32276076278615116637752885408670960216u128
        );
        assert!(
            17973624695585511250u128.wrapping_mul(15508857771688031017u128)
                == 278750389045535276823050438465802441250u128
        );
        assert!(
            11337436215167763360u128.wrapping_mul(11498826207341162568u128)
    ...
    // __Postcondition:__ `x * 1 == x`
    {
        ...
        assert!(
            92863575057343933443545159766182736853u128 * 1
                == 92863575057343933443545159766182736853u128
        );
        assert!(
            198752970825428019385407160876006302092u128 * 1
                == 198752970825428019385407160876006302092u128
        );
        assert!(
            287668735832803286290181217460546414343u128 * 1
                == 287668735832803286290181217460546414343u128
        );
        assert!(
            84047572791268238329799534663139296567u128 * 1
                == 84047572791268238329799534663139296567u128
        );
        assert!(
            59901799106292277935294546515479776520u128 * 1
                == 59901799106292277935294546515479776520u128
        );
        assert!(
            302008068677625209419888759010573610748u128 * 1
    ...
    // __Postcondition:__ `1 * x == x`
    {
        ...
        assert!(
            1 * 124938293316028451678258228193558418771u128
                == 124938293316028451678258228193558418771u128
        );
        assert!(
            1 * 97832907324038184495489921042580196548u128
                == 97832907324038184495489921042580196548u128
        );
        assert!(
            1 * 96704978626616652805801710737304681515u128
                == 96704978626616652805801710737304681515u128
        );
        assert!(
            1 * 67483562640087098402294644169981875089u128
                == 67483562640087098402294644169981875089u128
        );
        assert!(
            1 * 15652904113442507816759326997384029866u128
                == 15652904113442507816759326997384029866u128
        );
        assert!(
            1 * 164011194762317928508866230883293220507u128
    ...
    // __Postcondition:__ `x * y == y * x`
    {
        ...
        assert!(
            6218433177738553010u128 * 12934635555881116211u128
                == 12934635555881116211u128 * 6218433177738553010u128
        );
        assert!(
            17163154773858441826u128 * 12544206052579421996u128
                == 12544206052579421996u128 * 17163154773858441826u128
        );
        assert!(
            15935218679389863603u128 * 10897245658253586361u128
                == 10897245658253586361u128 * 15935218679389863603u128
        );
        assert!(
            17043376793527952834u128 * 17448616984493853765u128
                == 17448616984493853765u128 * 17043376793527952834u128
        );
        assert!(
            5388883090749838654u128 * 17654972217719228667u128
    ...
    // __Postcondition:__ `x * (y + z) == x * y + x * z`
    {
        ...
        assert!(
            340282366920938463463374607431768211455u128 * (1u128 + 0u128)
                == 340282366920938463463374607431768211455u128 * 1u128
                    + 340282366920938463463374607431768211455u128 * 0u128
        );
        assert!(
        ...
        assert!(
            340282366920938463463374607431768211454u128 * (0u128 + 1u128)
                == 340282366920938463463374607431768211454u128 * 0u128
                    + 340282366920938463463374607431768211454u128 * 1u128
        );
        assert!(
            4411281305389873256u128 * (18333013477917433226u128 + 12758968112387997964u128)
                == 4411281305389873256u128 * 18333013477917433226u128
                    + 4411281305389873256u128 * 12758968112387997964u128
        );
        assert!(
            18292798235004740926u128 * (4184227115489703159u128 + 5135888625247464584u128)
                == 18292798235004740926u128 * 4184227115489703159u128
                    + 18292798235004740926u128 * 5135888625247464584u128
        );
        assert!(
            12843481744384164754u128 * (5847697820990077348u128 + 12415087972943749689u128)
                == 12843481744384164754u128 * 5847697820990077348u128
                    + 12843481744384164754u128 * 12415087972943749689u128
        );
        assert!(
            3115621852453512841u128 * (9034150424233014682u128 + 13065566186211447271u128)
...
pub fn core_ops_add_u128_sub() {
    eprintln!(r#"Testing "Properties for [`core::ops::Sub::<u128>::sub`]"... (4 contracts)"#);
    eprint!("  ");
    // ## Semantics of non-underflowing subtraction
    // __Inputs:__ `x : u128, y : u128`
    // __Precondition:__ `x.up() - y.up() >= 0u8.up()`
    ...
    // __Postcondition:__ `(x - y) + y == x`
    {
        ...
        assert!((1u128 - 0u128) + 0u128 == 1u128);
        assert!(
            (340282366920938463463374607431768211454u128 - 0u128) + 0u128
                == 340282366920938463463374607431768211454u128
        );
        assert!(
    ...
    // __Postcondition:__ `x - 0 == x`
    {
        ...
        assert!(
            340282366920938463463374607431768211454u128 - 0
                == 340282366920938463463374607431768211454u128
        );
        assert!(
            102113077015681685439940293961327685316u128 - 0
                == 102113077015681685439940293961327685316u128
        );
        assert!(
            232143579340495455340564653734530585074u128 - 0
                == 232143579340495455340564653734530585074u128
        );
        assert!(
            230578159457531543485743650564392778084u128 - 0
                == 230578159457531543485743650564392778084u128
        );
        assert!(
            51964755331951094876823476764326328018u128 - 0
                == 51964755331951094876823476764326328018u128
        );
        assert!(
            190704915079162475221843123736397469462u128 - 0
                == 190704915079162475221843123736397469462u128
        );
        assert!(
            252374353068261827444968925591396553691u128 - 0
...
pub fn core_ops_add_u128_wrapping_sub() {
    eprintln!(r#"Testing "Properties for [`u128::wrapping_sub`]"... (5 contracts)"#);
    eprint!("  ");
    // ## Semantics of non-underflowing wrapping subtraction
    // __Inputs:__ `x : u128, y : u128`
    // __Precondition:__ `x.up() - y.up() >= 0u8.up()`
    // __Postcondition:__ `x.wrapping_sub(y) == u128::down(x.up() - y.up())`
    {
        ...
        assert!(
            340282366920938463463374607431768211454u128.wrapping_sub(1u128)
                == 340282366920938463463374607431768211453u128
        );
        assert!(
            340282366920938463463374607431768211454u128
                .wrapping_sub(340282366920938463463374607431768211454u128)
                == 0u128
        );
        assert!(
            340282366920938463463374607431768211455u128.wrapping_sub(1u128)
                == 340282366920938463463374607431768211454u128
        );
        assert!(
            331212102269665705423070394652588756454u128
                .wrapping_sub(265983025411672115516787985297771616866u128)
                == 65229076857993589906282409354817139588u128
        );
        assert!(
            310787618222722702417388155513825930283u128
                .wrapping_sub(54078497135665599492774104073159880701u128)
                == 256709121087057102924614051440666049582u128
        );
        assert!(
            219457690023692169263346807525226151943u128
                .wrapping_sub(92776153890829518341998243460376486936u128)
                == 126681536132862650921348564064849665007u128
        );
        assert!(
            305957126811589579516926325646657526884u128
                .wrapping_sub(92837606085896084196276515964515836843u128)
                == 213119520725693495320649809682141690041u128
        );
        assert!(
            148821587805439394773725988333198410208u128
    ...
    // __Postcondition:__ `x.wrapping_sub(y) == u128::down((x.up() - y.up()).rem_euclid(&(u128::MAX.up() + 1)))`
    {
        ...
        assert!(0u128.wrapping_sub(340282366920938463463374607431768211454u128) == 2u128);
        assert!(
            340282366920938463463374607431768211454u128.wrapping_sub(0u128)
                == 340282366920938463463374607431768211454u128
        );
        assert!(0u128.wrapping_sub(1u128) == 340282366920938463463374607431768211455u128);
        assert!(
    ...
    // __Postcondition:__ `(x.wrapping_sub(y)).wrapping_add(y) == x`
    {
        ...
        assert!(
            (0u128.wrapping_sub(340282366920938463463374607431768211455u128))
                .wrapping_add(340282366920938463463374607431768211455u128)
                == 0u128
        );
    ...
    // __Postcondition:__ `x.wrapping_sub(0) == x`
    {
        ...
        assert!(
            340282366920938463463374607431768211455u128.wrapping_sub(0)
                == 340282366920938463463374607431768211455u128
        );
        assert!(
            340282366920938463463374607431768211454u128.wrapping_sub(0)
                == 340282366920938463463374607431768211454u128
        );
        assert!(
            296842306751223418847129440026079402460u128.wrapping_sub(0)
                == 296842306751223418847129440026079402460u128
        );
        assert!(
            125763885868815211103411711606252770435u128.wrapping_sub(0)
                == 125763885868815211103411711606252770435u128
        );
        assert!(
            208830102679249089206257293293923307653u128.wrapping_sub(0)
                == 208830102679249089206257293293923307653u128
        );
        assert!(
            60440491316098117593351879995532430705u128.wrapping_sub(0)
                == 60440491316098117593351879995532430705u128
        );
        assert!(
            8207322446052094959614503653303215546u128.wrapping_sub(0)
                == 8207322446052094959614503653303215546u128
        );
        assert!(
            84928516961523580438020624670252398493u128.wrapping_sub(0)
...
pub fn core_ops_add_u128_checked_sub() {
    eprintln!(r#"Testing "Properties for [`u128::checked_sub`]"... (4 contracts)"#);
    eprint!("  ");
    // ## Semantics of non-underflowing checked subtraction
    // __Inputs:__ `x : u128, y : u128`
    // __Precondition:__ `x.up() - y.up() >= 0u8.up()`
    ...
    // __Postcondition:__ `x.checked_sub(y) == None`
    {
        ...
        assert!(
            3573155333155607439973779129569079563u128
                .checked_sub(295099082308046163133549843217490607341u128)
                == None
        );
        assert!(
            90393277041472185105602856517476929333u128
                .checked_sub(123486629688607242816543740178982449194u128)
                == None
        );
        assert!(
            120826033967346355946613454509464297492u128
                .checked_sub(309736537325948896290458410665516657999u128)
                == None
        );
        assert!(
            168945371201032833571013500763894358262u128
                .checked_sub(222854800006775922049790743498845978652u128)
                == None
        );
        assert!(
            128912419501300525373252954299520902321u128
                .checked_sub(251615150623898974087978002169231852453u128)
                == None
        );
    }
    eprint!("... ");
    ...
    // __Postcondition:__ `(x.checked_sub(y)).and_then(|r| r.checked_add(y)) == Some(x)`
    {
        ...
        assert!(
            (307738931443466688447833788417334376736u128
        ...
        assert!(
            (296820961309910155576870179870545267253u128
        ...
        assert!(
            (119791999257336495746335682330627997367u128
        ...
        assert!(
            (77674113626624670245487546541793060744u128
        ...
        assert!(
            (257493873211306374617510930773382620962u128
        ...
        assert!(
            (291504101662103912241597043271972172251u128
    ...
    // __Postcondition:__ `x.checked_sub(0) == Some(x)`
    {
        ...
        assert!(
            340282366920938463463374607431768211454u128.checked_sub(0)
                == Some(340282366920938463463374607431768211454u128)
        );
        assert!(
            340282366920938463463374607431768211455u128.checked_sub(0)
                == Some(340282366920938463463374607431768211455u128)
        );
        assert!(0u128.checked_sub(0) == Some(0u128));
        assert!(
            58248140096010563214276624709667003393u128.checked_sub(0)
                == Some(58248140096010563214276624709667003393u128)
        );
        assert!(
            233033253878850905527726372579491873861u128.checked_sub(0)
                == Some(233033253878850905527726372579491873861u128)
        );
        assert!(
            321644061561264169155837343187837950989u128.checked_sub(0)
                == Some(321644061561264169155837343187837950989u128)
        );
        assert!(
            124922121132025500670959031561818016353u128.checked_sub(0)
                == Some(124922121132025500670959031561818016353u128)
        );
        assert!(
            130229793495196763542320204450724117273u128.checked_sub(0)
                == Some(130229793495196763542320204450724117273u128)
        );
        assert!(
            286147228978110681187709145664224590161u128.checked_sub(0)
...
pub fn core_ops_sub_u128_saturating_sub() {
    eprintln!(r#"Testing "Properties for [`u128::saturating_sub`]"... (3 contracts)"#);
    eprint!("  ");
    // ## Semantics of the saturating subtraction
    // __Inputs:__ `x : u128, y : u128`
    // __Precondition:__ `true`
    // __Postcondition:__ `x.saturating_sub(y) == u128::down((x.up() - y.up()).max(0u8.up()))`
    {
        ...
        assert!(
            340282366920938463463374607431768211454u128
                .saturating_sub(340282366920938463463374607431768211454u128)
                == 0u128
        );
        assert!(
            212771345942265575709097622646549462788u128
                .saturating_sub(212940492699729623059057010602793944939u128)
                == 0u128
        );
        assert!(
            88651915468057252608315744109464897238u128
                .saturating_sub(37212010419471683334601529186001298444u128)
                == 51439905048585569273714214923463598794u128
        );
        assert!(
            294028574184221987844192650193766999457u128
                .saturating_sub(190818468687017625853429609951681843199u128)
                == 103210105497204361990763040242085156258u128
        );
        assert!(
            10151632302752216511708251664948717061u128
                .saturating_sub(226389655873033814261106634099658298070u128)
                == 0u128
        );
    }
    eprint!("... ");
    ...
    // __Postcondition:__ `x.saturating_sub(y) == 0`
    {
        ...
        assert!(
            29108012290890390052269254938395357452u128
                .saturating_sub(86927524167343890209446733157318089075u128)
                == 0
        );
        assert!(
            149782262324170800553744029757852099634u128
                .saturating_sub(249940680675008946507357696349261692435u128)
                == 0
        );
        assert!(
            41408892082187155529703700007354167343u128
                .saturating_sub(151013982893428427069922389849045696998u128)
                == 0
        );
        assert!(
            197828722165431089600002215202170885693u128
                .saturating_sub(267108352084172017528154524854891298521u128)
                == 0
        );
        assert!(
            65271919398206813884420043203621990066u128
                .saturating_sub(303521788259598006211644396972251908090u128)
                == 0
        );
        assert!(
            181925156618926734138796026523559226915u128
                .saturating_sub(221117934993052571917490212672703848215u128)
                == 0
        );
    }
    eprint!("... ");
...
pub fn core_ops_add_u128_add() {
    ...
    // __Postcondition:__ `x + y == u128::down(x.up() + y.up())`
    {
        ...
        assert!(
            31260428026565787699205391969663969716u128 + 8813049861258178571983467463330261825u128
                == 40073477887823966271188859432994231541u128
        );
        assert!(
            26579532723013893507528579586811191051u128
                + 176615356947651334767459367617919468626u128
                == 203194889670665228274987947204730659677u128
        );
        assert!(
            23203015145443803039863053781828558910u128
                + 203971162721054368374408170395367296643u128
                == 227174177866498171414271224177195855553u128
        );
        assert!(
            8490538342001926739051480324506348141u128 + 146139455483337632769053827213470893033u128
                == 154629993825339559508105307537977241174u128
        );
        assert!(
            54920313343234889718480393564112832945u128 + 74401548510693126373451374013171631979u128
    ...
    // __Postcondition:__ `x + y == y + x`
    {
        ...
        assert!(
            81437501676382383541757664652001679235u128 + 66860497665477457406970272320051459246u128
    ...
    // __Postcondition:__ `x + 0 == x`
    {
        ...
        assert!(
            212370292985986765105212048148260531385u128 + 0
                == 212370292985986765105212048148260531385u128
        );
        assert!(
            67771181602578205616749005235766596184u128 + 0
                == 67771181602578205616749005235766596184u128
        );
        assert!(
            339445703344308354334043753011425119791u128 + 0
                == 339445703344308354334043753011425119791u128
        );
        assert!(
            45248522375968810379034228292674061463u128 + 0
                == 45248522375968810379034228292674061463u128
        );
        assert!(
            112840324329566792291820000193893145995u128 + 0
                == 112840324329566792291820000193893145995u128
        );
        assert!(
            50526360278671693303338594509923181584u128 + 0
    ...
    // __Postcondition:__ `0 + x == x`
    {
        ...
        assert!(
            0 + 340282366920938463463374607431768211454u128
                == 340282366920938463463374607431768211454u128
        );
        assert!(
            0 + 120870557475871112294413400453042418199u128
                == 120870557475871112294413400453042418199u128
        );
        assert!(
            0 + 201287459350042088859177076472916879293u128
                == 201287459350042088859177076472916879293u128
        );
        assert!(
            0 + 14629941313787401990914527735304414553u128
                == 14629941313787401990914527735304414553u128
        );
        assert!(
            0 + 133004994005792120092963278370266013415u128
                == 133004994005792120092963278370266013415u128
        );
        assert!(
            0 + 276370362254611122677357305962264476403u128
                == 276370362254611122677357305962264476403u128
        );
        assert!(
            0 + 246686880293652174700357539518937784865u128
...
pub fn core_ops_add_u128_wrapping_add() {
    eprintln!(r#"Testing "Properties for [`u128::wrapping_add`]"... (7 contracts)"#);
    eprint!("  ");
    // ## Semantics of the wrapping addition
    // __Inputs:__ `x : u128, y : u128`
    // __Precondition:__ `true`
    ...
    {
        assert!(
            340282366920938463463374607431768211454u128.wrapping_add(0u128)
                == 340282366920938463463374607431768211454u128
        );
        assert!(0u128.wrapping_add(0u128) == 0u128);
        assert!(
    ...
    // __Postcondition:__ `x.wrapping_add(y) == y.wrapping_add(x)`
    {
        ...
        assert!(
            340282366920938463463374607431768211455u128.wrapping_add(1u128)
                == 1u128.wrapping_add(340282366920938463463374607431768211455u128)
        );
        assert!(
            44519606772400966076677875555967533312u128
        ...
        assert!(
            132564707117559214188740531150018812439u128
        ...
        assert!(
            124420467991881265241698223998321691943u128
        ...
        assert!(
            247277000117004692738531503260757946475u128
        ...
        assert!(
            180956882296782419368705635627271990813u128
    ...
    // __Postcondition:__ `x.wrapping_add(0) == x`
    {
        ...
        assert!(
            340282366920938463463374607431768211454u128.wrapping_add(0)
                == 340282366920938463463374607431768211454u128
        );
        assert!(
            340282366920938463463374607431768211455u128.wrapping_add(0)
                == 340282366920938463463374607431768211455u128
        );
        assert!(
            54133492327068534212689444164682200115u128.wrapping_add(0)
                == 54133492327068534212689444164682200115u128
        );
        assert!(
            117340417229796565695111050913478401557u128.wrapping_add(0)
                == 117340417229796565695111050913478401557u128
        );
        assert!(
            210847686842078248027124137107895408718u128.wrapping_add(0)
                == 210847686842078248027124137107895408718u128
        );
        assert!(
            97950583331651851568600387576231061122u128.wrapping_add(0)
                == 97950583331651851568600387576231061122u128
        );
        assert!(
            138823441328994184522831901166579679151u128.wrapping_add(0)
                == 138823441328994184522831901166579679151u128
        );
        assert!(
            199498747531517303902630071690238983832u128.wrapping_add(0)
    ...
    // __Postcondition:__ `(x.wrapping_add(y)).wrapping_add(z) == x.wrapping_add(y.wrapping_add(z))`
    {
        ...
        assert!(
            (0u128.wrapping_add(340282366920938463463374607431768211454u128)).wrapping_add(1u128)
                == 0u128
                    .wrapping_add(340282366920938463463374607431768211454u128.wrapping_add(1u128),)
        );
        assert!(
            (340282366920938463463374607431768211455u128.wrapping_add(0u128)).wrapping_add(0u128)
                == 340282366920938463463374607431768211455u128
        ...
        assert!(
            (0u128.wrapping_add(340282366920938463463374607431768211455u128)).wrapping_add(0u128)
                == 0u128
                    .wrapping_add(340282366920938463463374607431768211455u128.wrapping_add(0u128),)
        );
        assert!(
            ...
            .wrapping_add(597291081928901870437529320540504337u128)
                == 15504112552480245600253346032458649055u128.wrapping_add(
        ...
        assert!(
            ...
            .wrapping_add(73606642365885032650253200504946917857u128)
                == 11777338193848155079324584227671016340u128.wrapping_add(
        ...
        assert!(
            ...
            .wrapping_add(11485477793605046245358031705730920761u128)
                == 82571736886964476570984074426108394822u128.wrapping_add(
        ...
        assert!(
            ...
            .wrapping_add(516467323985977652731342686499674497u128)
                == 21441519883273966463641844823564417866u128.wrapping_add(
...
pub fn core_ops_add_u128_checked_add() {
    ...
    // __Postcondition:__ `x.checked_add(y) == Some(u128::down(x.up() + y.up()))`
    {
        ...
        assert!(
            340282366920938463463374607431768211454u128.checked_add(1u128)
                == Some(340282366920938463463374607431768211455u128)
        );
        assert!(
    ...
    // __Postcondition:__ `x.checked_add(y) == None`
    {
        ...
        assert!(
            309501773591659534595607403613475089698u128
                .checked_add(214732482049775202665533815351942767021u128)
                == None
        );
        assert!(
            107003499999086825983349737574701749983u128
                .checked_add(340240172877488693838031160349436983343u128)
                == None
        );
        assert!(
            114158794601093977887317899219464045784u128
                .checked_add(313722503116604457665135290279052844854u128)
                == None
        );
        assert!(
            276278614716976805018922235338577627871u128
                .checked_add(67083826260676700400815006103980446645u128)
                == None
        );
    }
    eprint!("... ");
    ...
    // __Postcondition:__ `x.checked_add(y) == y.checked_add(x)`
    {
        ...
        assert!(
            237595766136034124012057740023886154347u128
        ...
        assert!(
            205547517706496394916232382448597904334u128
        ...
        assert!(
            27552976708036324590422648232809826676u128
        ...
        assert!(
            207060228453483245581539405907254676567u128
        ...
        assert!(
            188476846338279241483649507225877327068u128
    ...
    // __Postcondition:__ `x.checked_add(0u128) == Some(x)`
    {
        ...
        assert!(
            75030266591803476592615014930662884824u128.checked_add(0u128)
                == Some(75030266591803476592615014930662884824u128)
        );
        assert!(
            11457686889215267385215361145129116901u128.checked_add(0u128)
                == Some(11457686889215267385215361145129116901u128)
        );
        assert!(
            20933923478159774185515442296622368660u128.checked_add(0u128)
                == Some(20933923478159774185515442296622368660u128)
        );
        assert!(
            157276967044919865897295139411036839548u128.checked_add(0u128)
                == Some(157276967044919865897295139411036839548u128)
        );
        assert!(
            138773838477336850951583348765392894511u128.checked_add(0u128)
                == Some(138773838477336850951583348765392894511u128)
        );
        assert!(
            313903236904223345789895378726860058598u128.checked_add(0u128)
    ...
    // __Postcondition:__ `0u128.checked_add(x) == Some(x)`
    {
        ...
        assert!(
            0u128.checked_add(306134191640695087524567760617816791075u128)
                == Some(306134191640695087524567760617816791075u128)
        );
        assert!(
            0u128.checked_add(318578428616860112091537844954110596225u128)
                == Some(318578428616860112091537844954110596225u128)
        );
        assert!(
            0u128.checked_add(313630214728920392790928180968968333817u128)
                == Some(313630214728920392790928180968968333817u128)
        );
        assert!(
            0u128.checked_add(257845377313547057086836958872196726885u128)
                == Some(257845377313547057086836958872196726885u128)
        );
        assert!(
            0u128.checked_add(181537328384071247898613333248664596275u128)
                == Some(181537328384071247898613333248664596275u128)
        );
        assert!(
            0u128.checked_add(134111443424895414636184145021550671836u128)
    ...
    //         == y.checked_add(z).and_then(|iv| x.checked_add(iv))`
    {
        ...
        assert!(
            318774967170143800612177093420144578982u128
        ...
        assert!(
            147857797279422181678708978852108577760u128
        ...
        assert!(
            64934913851359240392675547582045641013u128
        ...
        assert!(
            98243382631985090572423823991257364883u128
        ...
        assert!(
            181043248718462050000872445698872853315u128
...
pub fn core_ops_add_u128_saturating_add() {
    eprintln!(r#"Testing "Properties for [`u128::saturating_add`]"... (3 contracts)"#);
    eprint!("  ");
    // ## Semantics of the saturating addition
    // __Inputs:__ `x : u128, y : u128`
    // __Precondition:__ `true`
    // __Postcondition:__ `x.saturating_add(y) == u128::down((x.up() + y.up()).min(u128::MAX.up()))`
    {
        ...
        assert!(
            340282366920938463463374607431768211455u128.saturating_add(0u128)
                == 340282366920938463463374607431768211455u128
        );
        assert!(
            1u128.saturating_add(340282366920938463463374607431768211454u128)
                == 340282366920938463463374607431768211455u128
        );
        assert!(
            0u128.saturating_add(340282366920938463463374607431768211455u128)
                == 340282366920938463463374607431768211455u128
        );
        assert!(
            340282366920938463463374607431768211454u128
    ...
    // __Postcondition:__ `x.saturating_add(y) == u128::down(x.up() + y.up())`
    {
        assert!(0u128.saturating_add(0u128) == 0u128);
        assert!(
            340282366920938463463374607431768211454u128.saturating_add(0u128)
                == 340282366920938463463374607431768211454u128
        );
        assert!(
            340282366920938463463374607431768211455u128.saturating_add(0u128)
    ...
    // __Postcondition:__ `x.saturating_add(y) == u128::MAX`
    {
        assert!(
            340282366920938463463374607431768211455u128
                .saturating_add(340282366920938463463374607431768211454u128)
                == u128::MAX
        );
        assert!(
            340282366920938463463374607431768211454u128
        ...
        assert!(
            87275455623633662107696689340241681012u128
                .saturating_add(336710644903255472216025176276934773221u128)
                == u128::MAX
        );
        assert!(
            167006100359884391157121180512385012483u128
                .saturating_add(252520611075255214790444828703024809713u128)
                == u128::MAX
        );
        assert!(
            97898449377870206414082796747437005652u128
                .saturating_add(325384812433553582171141758309393673324u128)
                == u128::MAX
        );
        assert!(
            337426167745264976070126812258795640446u128
                .saturating_add(296121561831788197273545289949290902573u128)
                == u128::MAX
        );
    }
    eprint!("... ");
...
pub fn core_ops_rem_usize_rem() {
    eprintln!(r#"Testing "Properties for [`core::ops::Rem::<usize>::rem`]"... (2 contracts)"#);
    eprint!("  ");
    // ## Semantics of rem
...
pub fn core_ops_rem_usize_checked_rem() {
    eprintln!(r#"Testing "Properties for [`usize::checked_rem`]"... (2 contracts)"#);
    eprint!("  ");
    // ## Semantics of checked_rem
    // __Inputs:__ `x : usize, y : usize`
    // __Precondition:__ `y != 0`
    // __Postcondition:__ `x.checked_rem(y) == Some(usize::down(x.up() % y.up()))`
    {
        ...
        assert!(
            18446744073709551614usize.checked_rem(18446744073709551615usize)
        ...
        assert!(
            14119586892509753237usize.checked_rem(2132848150489044270usize)
                == Some(1322497989575487617usize)
        );
        assert!(
            14269138334217754229usize.checked_rem(2354551194310871546usize)
                == Some(141831168352524953usize)
        );
        assert!(
            10805739091458340663usize.checked_rem(14941705138694464462usize)
                == Some(10805739091458340663usize)
        );
        assert!(
            286728536247391742usize.checked_rem(7121376054063824048usize)
...
pub fn t_usize_checked_neg() {
    eprintln!(r#"Testing "Properties for [`usize::checked_neg`]"... (2 contracts)"#);
    eprint!("  ");
    // ## Semantics of checked neg when out of bounds
    // __Inputs:__ `x : usize`
...
pub fn core_ops_shl_usize_shl() {
    eprintln!(r#"Testing "Properties for [`core::ops::Shl::<usize>::shl`]"... (2 contracts)"#);
    eprint!("  ");
    // ## Semantics of the left shift when the number of bits is right
...
pub fn core_ops_shl_usize_checked_shl() {
    eprintln!(
        r#"Testing "Properties for [`core::ops::Shl::<usize>::checked_shl`]"... (2 contracts)"#
    );
    eprint!("  ");
    // ## Semantics of the left shift when the number of bits is right
    // __Inputs:__ `x : usize, y : u32`
...
pub fn core_ops_shl_usize_overflowing_shl() {
    eprintln!(
        r#"Testing "Properties for [`core::ops::Shl::<usize>::overflowing_shl`]"... (2 contracts)"#
    );
    eprint!("  ");
    // ## Semantics of the left shift when the number of bits is right
    // __Inputs:__ `x : usize, y : u32`
    ...
    // __Postcondition:__ `x.overflowing_shl(y) == (usize::down((x.up() << y) & usize::MAX.up()), false)`
    {
        ...
        assert!(
            18446744073709551614usize.overflowing_shl(0u32) == (18446744073709551614usize, false)
        );
        assert!(0usize.overflowing_shl(0u32) == (0usize, false));
        assert!(
            15867813355090826313usize.overflowing_shl(19u32) == (7018511588462690304usize, false)
        );
        assert!(
            6892421183486171610usize.overflowing_shl(60u32) == (11529215046068469760usize, false)
        );
        assert!(
            13769335653585112222usize.overflowing_shl(62u32) == (9223372036854775808usize, false)
        );
        assert!(
            6473683240919787057usize.overflowing_shl(38u32) == (15787804175229779968usize, false)
        );
        assert!(
            7826618729451075893usize.overflowing_shl(47u32) == (15896158572245942272usize, false)
        );
        assert!(
            203399862213772129usize.overflowing_shl(21u32) == (16364624950685859840usize, false)
        );
        assert!(
            11046333707493418511usize.overflowing_shl(46u32) == (7603131702164062208usize, false)
        );
    }
    eprint!("... ");
    // ## Semantics of the left shift otherwise
    ...
    //         == (usize::down((x.up() << (y & (usize::BITS - 1)) & usize::MAX.up())), true)`
    {
        ...
        assert!(
            18446744073709551615usize.overflowing_shl(4294967294u32)
        ...
        assert!(
            8419705401190674703usize.overflowing_shl(126u32) == (13835058055282163712usize, true)
        );
        assert!(
            15389357193705231286usize.overflowing_shl(78u32) == (9130262204357902336usize, true)
        );
        assert!(
            9846453716013877465usize.overflowing_shl(131u32) == (4984653433272813256usize, true)
        );
    }
    eprint!("... ");
    eprintln!("✓\n");
...
pub fn core_ops_shr_usize_shr() {
    eprintln!(r#"Testing "Properties for [`core::ops::Shr::<usize>::shr`]"... (2 contracts)"#);
    eprint!("  ");
    // ## Semantics of the right shift when the number of bits is right
    // __Inputs:__ `x : usize, y : u32`
    // __Precondition:__ `y < usize::BITS`
...
pub fn core_ops_shr_usize_checked_shr() {
    eprintln!(
        r#"Testing "Properties for [`core::ops::Shr::<usize>::checked_shr`]"... (2 contracts)"#
    );
    eprint!("  ");
    // ## Semantics of the right shift when the number of bits is right
    // __Inputs:__ `x : usize, y : u32`
...
pub fn core_ops_shr_usize_overflowing_shr() {
    eprintln!(
        r#"Testing "Properties for [`core::ops::Shr::<usize>::overflowing_shr`]"... (2 contracts)"#
    );
    eprint!("  ");
    // ## Semantics of the right shift when the number of bits is right
    // __Inputs:__ `x : usize, y : u32`
    ...
    // __Postcondition:__ `x.overflowing_shr(y) == (usize::down((x.up() >> y) & usize::MAX.up()), false)`
    {
        ...
        assert!(
            18446744073709551615usize.overflowing_shr(0u32) == (18446744073709551615usize, false)
        );
        assert!(
            18446744073709551614usize.overflowing_shr(0u32) == (18446744073709551614usize, false)
        );
    ...
    //         == (usize::down((x.up() >> (y & (usize::BITS - 1)) & usize::MAX.up())), true)`
    {
        ...
        assert!(
            3420357223361652958usize.overflowing_shr(64u32) == (3420357223361652958usize, true)
        );
        assert!(
            16098067900464932022usize.overflowing_shr(70u32) == (251532310944764562usize, true)
        );
    }
    eprint!("... ");
    eprintln!("✓\n");
...
pub fn core_ops_div_usize_div() {
    eprintln!(r#"Testing "Properties for [`core::ops::Div::<usize>::div`]"... (2 contracts)"#);
    eprint!("  ");
    // ## Semantics of the division by non-zero
    // __Inputs:__ `x : usize, y : usize`
    // __Precondition:__ `y != 0`
    ...
    // __Postcondition:__ `{ #[allow(unconditional_panic)] { panics!(x / 0) } }`
    {
        ...
        assert!({
            #[allow(unconditional_panic)]
            {
                panics!(18446744073709551614usize / 0)
            }
        });
        assert!({
            #[allow(unconditional_panic)]
        ...
        assert!({
            #[allow(unconditional_panic)]
            {
                panics!(18446744073709551615usize / 0)
            }
        });
        assert!({
            #[allow(unconditional_panic)]
            {
                panics!(16680128449987326697usize / 0)
            }
        });
        assert!({
            #[allow(unconditional_panic)]
            {
                panics!(9605006638616355691usize / 0)
            }
        });
        assert!({
            #[allow(unconditional_panic)]
            {
                panics!(2715739621160822106usize / 0)
            }
        });
        assert!({
            #[allow(unconditional_panic)]
            {
                panics!(7341635105764792779usize / 0)
            }
        });
        assert!({
            #[allow(unconditional_panic)]
            {
                panics!(2153266043876155996usize / 0)
            }
        });
        assert!({
            #[allow(unconditional_panic)]
            {
                panics!(4164769598989491820usize / 0)
            }
        });
    }
    eprint!("... ");
...
pub fn core_ops_div_usize_saturating_div() {
    eprintln!(r#"Testing "Properties for [`usize::saturating_div`]"... (2 contracts)"#);
    eprint!("  ");
    // ## Semantics of the saturating division by non-zero
    // __Inputs:__ `x : usize, y : usize`
    // __Precondition:__ `y != 0`
    ...
    // __Postcondition:__ `{ #[allow(unconditional_panic)] { panics!(x.saturating_div(0)) } }`
    {
        ...
        assert!({
            #[allow(unconditional_panic)]
            {
                panics!(0usize.saturating_div(0))
            }
        });
        assert!({
            #[allow(unconditional_panic)]
            {
                panics!(1usize.saturating_div(0))
            }
        });
        assert!({
            #[allow(unconditional_panic)]
...
pub fn core_ops_div_usize_checked_div() {
    eprintln!(r#"Testing "Properties for [`usize::checked_div`]"... (2 contracts)"#);
    eprint!("  ");
    // ## Semantics of the checked division by non-zero
    // __Inputs:__ `x : usize, y : usize`
    // __Precondition:__ `y != 0`
...
pub fn core_ops_mul_usize_mul() {
    eprintln!(r#"Testing "Properties for [`core::ops::Mul::<usize>::mul`]"... (8 contracts)"#);
    eprint!("  ");
    // ## Semantics of non-overflowing multiplication
    // __Inputs:__ `x : usize, y : usize`
    ...
    {
        assert!(panics!(
            18446744073709551614usize * 18446744073709551614usize
        ));
        assert!(panics!(
            18446744073709551615usize * 18446744073709551615usize
        ));
        assert!(panics!(
            18446744073709551614usize * 18446744073709551615usize
        ));
        assert!(panics!(
            18446744073709551615usize * 18446744073709551614usize
        ));
        assert!(panics!(4246902401213591213usize * 5920912703605098720usize));
        assert!(panics!(
            18020892827008775563usize * 17521116796223147057usize
        ));
        assert!(panics!(
            14572316386170312207usize * 6423616553461701347usize
        ));
        assert!(panics!(
            12870164199461361001usize * 9280220150025981702usize
        ));
...
pub fn core_ops_mul_usize_checked_mul() {
    eprintln!(r#"Testing "Properties for [`usize::checked_mul`]"... (2 contracts)"#);
    eprint!("  ");
    // ## Semantics of the non-overflowing checked multiplication
    // __Inputs:__ `x : usize, y : usize`
    // __Precondition:__ `x.up() * y.up() <= usize::MAX.up()`
...
pub fn core_ops_mul_usize_overflowing_mul() {
    eprintln!(r#"Testing "Properties for [`usize::overflowing_mul`]"... (2 contracts)"#);
    eprint!("  ");
    // ## Semantics of the overflowing multiplication when in bounds
    // __Inputs:__ `x : usize, y : usize`
    // __Precondition:__ `x.up() * y.up() <= usize::MAX.up()`
    // __Postcondition:__ `x.overflowing_mul(y) == (usize::down(x.up() * y.up()), false)`
    {
        ...
        assert!(
            1213709560usize.overflowing_mul(3117306887usize) == (3783505170205739720usize, false)
        );
        assert!(
            1521575579usize.overflowing_mul(2642904319usize) == (4021378669424025701usize, false)
        );
        assert!(
            3559221032usize.overflowing_mul(2189456071usize) == (7792758096543285272usize, false)
        );
        assert!(
            2786117801usize.overflowing_mul(859978183usize) == (2396000524127935583usize, false)
        );
        assert!(
            3220377871usize.overflowing_mul(3297437700usize) == (10618995400081136700usize, false)
        );
        assert!(
            2806538027usize.overflowing_mul(4253929964usize) == (11938816208160741028usize, false)
        );
    }
    eprint!("... ");
    // ## Semantics of the overflowing multiplication when out of bounds
    ...
    {
        assert!(
            18446744073709551615usize.overflowing_mul(18446744073709551614usize) == (2usize, true)
        );
        assert!(
            18446744073709551615usize.overflowing_mul(18446744073709551615usize) == (1usize, true)
        );
        assert!(
            18446744073709551614usize.overflowing_mul(18446744073709551614usize) == (4usize, true)
        );
        assert!(
            18446744073709551614usize.overflowing_mul(18446744073709551615usize) == (2usize, true)
        );
        assert!(
            2984813091513258770usize.overflowing_mul(3253999293998930784usize)
                == (5175961572693314752usize, true)
        );
        assert!(
            4944671647444128688usize.overflowing_mul(17867882411095943610usize)
                == (6141691223538925024usize, true)
        );
        assert!(
            170672305380167992usize.overflowing_mul(5182641788585481758usize)
                == (14800755590253761680usize, true)
        );
        assert!(
            13371320694887560382usize.overflowing_mul(10837579643558261415usize)
                == (14913850775347069938usize, true)
        );
        assert!(
            15838653568912680813usize.overflowing_mul(5433950436544696559usize)
                == (7074624757288050371usize, true)
        );
        assert!(
            3553343937050982791usize.overflowing_mul(15387743040150678481usize)
...
pub fn core_ops_mul_usize_saturating_mul() {
    eprintln!(r#"Testing "Properties for [`usize::saturating_mul`]"... (3 contracts)"#);
    eprint!("  ");
    // ## Semantics of the saturating multiplication
    // __Inputs:__ `x : usize, y : usize`
    // __Precondition:__ `true`
    // __Postcondition:__ `x.saturating_mul(y) == usize::down((x.up() * y.up()).min(usize::MAX.up()))`
    {
        ...
        assert!(
            18446744073709551614usize.saturating_mul(18446744073709551615usize)
                == 18446744073709551615usize
        );
        assert!(1usize.saturating_mul(18446744073709551614usize) == 18446744073709551614usize);
        assert!(
            18446744073709551614usize.saturating_mul(18446744073709551614usize)
                == 18446744073709551615usize
        );
        assert!(
            8066106433330115032usize.saturating_mul(11684952187620457164usize)
                == 18446744073709551615usize
        );
        assert!(
            1764736033412924511usize.saturating_mul(3796132533754322783usize)
                == 18446744073709551615usize
        );
        assert!(
            8346019181201749863usize.saturating_mul(3257811310763673317usize)
                == 18446744073709551615usize
        );
        assert!(
            9136966644361857397usize.saturating_mul(1602752880872706098usize)
                == 18446744073709551615usize
        );
        assert!(
            6891633035226532748usize.saturating_mul(4177969595199353031usize)
                == 18446744073709551615usize
        );
    }
    eprint!("... ");
...
pub fn core_ops_mul_usize_wrapped_mul() {
    eprintln!(r#"Testing "Properties for [`usize::wrapping_mul`]"... (8 contracts)"#);
    eprint!("  ");
    // ## Semantics of the wrapping multiplication
    // __Inputs:__ `x : usize, y : usize`
    // __Precondition:__ `true`
    // __Postcondition:__ `x.wrapping_mul(y) == usize::down((x.up() * y.up()) % (usize::MAX.up() + 1))`
    {
        ...
        assert!(
            18199225839339507784usize.wrapping_mul(2464485787756397267usize)
                == 5242558069192325976usize
        );
        assert!(
            4976255843189435361usize.wrapping_mul(14096030979498471850usize)
                == 2035911812219696234usize
        );
        assert!(
            6968615943836015702usize.wrapping_mul(15996251836502209607usize)
                == 7211782125178115034usize
        );
        assert!(
            18441590983222119058usize.wrapping_mul(2445256036724001291usize)
...
pub fn core_ops_add_usize_sub() {
    eprintln!(r#"Testing "Properties for [`core::ops::Sub::<usize>::sub`]"... (4 contracts)"#);
    eprint!("  ");
    // ## Semantics of non-underflowing subtraction
    // __Inputs:__ `x : usize, y : usize`
    // __Precondition:__ `x.up() - y.up() >= 0u8.up()`
    ...
    // __Postcondition:__ `panics!(x - y)`
    {
        ...
        assert!(panics!(
            10008001737330562144usize - 10794788476270211805usize
        ));
        assert!(panics!(1713898964998039585usize - 4689212225853307237usize));
        assert!(panics!(
            1006199177340080048usize - 14406582031551508367usize
        ));
        assert!(panics!(
            5331667419182117725usize - 16353101313237034631usize
        ));
        assert!(panics!(
            1469668556580630529usize - 16755197154863959040usize
        ));
    }
    eprint!("... ");
    // ## Subtraction is the reverse of addition
    ...
    // __Postcondition:__ `(x - y) + y == x`
    {
        ...
        assert!((18446744073709551614usize - 0usize) + 0usize == 18446744073709551614usize);
        assert!(
            (18446744073709551615usize - 18446744073709551614usize) + 18446744073709551614usize
                == 18446744073709551615usize
        );
        assert!(
            (18446744073709551615usize - 18446744073709551615usize) + 18446744073709551615usize
                == 18446744073709551615usize
        );
        assert!((1usize - 0usize) + 0usize == 1usize);
        assert!((18446744073709551615usize - 0usize) + 0usize == 18446744073709551615usize);
        assert!(
            (15648276777229511765usize - 4569254080613650786usize) + 4569254080613650786usize
                == 15648276777229511765usize
        );
        assert!(
            (5986174390327718178usize - 5770749895494975749usize) + 5770749895494975749usize
                == 5986174390327718178usize
        );
        assert!(
            (17261072257105501671usize - 11285076950106828105usize) + 11285076950106828105usize
                == 17261072257105501671usize
        );
        assert!(
            (13540026440620963897usize - 3786550932260136959usize) + 3786550932260136959usize
...
pub fn core_ops_add_usize_wrapping_sub() {
    eprintln!(r#"Testing "Properties for [`usize::wrapping_sub`]"... (5 contracts)"#);
    eprint!("  ");
    // ## Semantics of non-underflowing wrapping subtraction
    // __Inputs:__ `x : usize, y : usize`
    // __Precondition:__ `x.up() - y.up() >= 0u8.up()`
    // __Postcondition:__ `x.wrapping_sub(y) == usize::down(x.up() - y.up())`
    {
        ...
        assert!(
            9618329076396404692usize.wrapping_sub(2524219794991593736usize)
                == 7094109281404810956usize
        );
        assert!(
            8032143646255138464usize.wrapping_sub(4833867149834665782usize)
                == 3198276496420472682usize
        );
        assert!(
            18023290624867980503usize.wrapping_sub(16227474899174132712usize)
                == 1795815725693847791usize
        );
        assert!(
            12834869958359206327usize.wrapping_sub(7140782562572098726usize)
                == 5694087395787107601usize
        );
        assert!(
            5161985927819903861usize.wrapping_sub(2844024543866770046usize)
    ...
    // __Postcondition:__ `x.wrapping_sub(y) == usize::down(x.up() - y.up() + usize::MAX + 1)`
    {
        ...
        assert!(
            18446744073709551614usize.wrapping_sub(18446744073709551615usize)
                == 18446744073709551615usize
        );
        assert!(0usize.wrapping_sub(1usize) == 18446744073709551615usize);
        assert!(0usize.wrapping_sub(18446744073709551614usize) == 2usize);
        assert!(
            8528798374265485529usize.wrapping_sub(16960996106428388294usize)
                == 10014546341546648851usize
        );
        assert!(
            12499931743021894938usize.wrapping_sub(12720968333190574286usize)
                == 18225707483540872268usize
        );
        assert!(
            1871788318447475180usize.wrapping_sub(3032588117673362142usize)
                == 17285944274483664654usize
        );
        assert!(
            12683891304210764318usize.wrapping_sub(14239759657187578678usize)
                == 16890875720732737256usize
        );
        assert!(
            13592660959437109449usize.wrapping_sub(16559068177565733340usize)
    ...
    //         == usize::down((x.up() - y.up()).rem_euclid(&(usize::MAX.up() + 1)))`
    {
        ...
        assert!(
            10310899596092219019usize.wrapping_sub(5745234032727480330usize)
                == 4565665563364738689usize
        );
        assert!(
            11656330812887640927usize.wrapping_sub(3801354160368896324usize)
                == 7854976652518744603usize
        );
        assert!(
            6312216297519966773usize.wrapping_sub(11651405377768632641usize)
                == 13107554993460885748usize
        );
        assert!(
            5516559987185446446usize.wrapping_sub(18155916541093719130usize)
    ...
    {
        assert!(
            (18446744073709551615usize.wrapping_sub(1usize)).wrapping_add(1usize)
                == 18446744073709551615usize
        );
        assert!((0usize.wrapping_sub(0usize)).wrapping_add(0usize) == 0usize);
        assert!(
            (18446744073709551615usize.wrapping_sub(18446744073709551614usize))
                .wrapping_add(18446744073709551614usize)
                == 18446744073709551615usize
        );
        assert!((1usize.wrapping_sub(0usize)).wrapping_add(0usize) == 1usize);
        assert!(
            (18446744073709551614usize.wrapping_sub(0usize)).wrapping_add(0usize)
                == 18446744073709551614usize
        );
        assert!(
            (3777659140235671407usize.wrapping_sub(17184108981392586987usize))
                .wrapping_add(17184108981392586987usize)
                == 3777659140235671407usize
        );
        assert!(
            (2462705600177277105usize.wrapping_sub(16172497647415432226usize))
                .wrapping_add(16172497647415432226usize)
                == 2462705600177277105usize
        );
        assert!(
            (15011242359811499821usize.wrapping_sub(2071096935029956885usize))
                .wrapping_add(2071096935029956885usize)
                == 15011242359811499821usize
        );
        assert!(
            (12112415515546201325usize.wrapping_sub(6132671271335831002usize))
                .wrapping_add(6132671271335831002usize)
                == 12112415515546201325usize
        );
        assert!(
            (9614483651844652471usize.wrapping_sub(6909438265035934954usize))
                .wrapping_add(6909438265035934954usize)
                == 9614483651844652471usize
        );
    }
    eprint!("... ");
    // ## Left identity
...
pub fn core_ops_add_usize_checked_sub() {
    eprintln!(r#"Testing "Properties for [`usize::checked_sub`]"... (4 contracts)"#);
    eprint!("  ");
    // ## Semantics of non-underflowing checked subtraction
    // __Inputs:__ `x : usize, y : usize`
    // __Precondition:__ `x.up() - y.up() >= 0u8.up()`
    // __Postcondition:__ `x.checked_sub(y) == Some(usize::down(x.up() - y.up()))`
    {
        ...
        assert!(
            5865508096022319613usize.checked_sub(2009356697088308638usize)
                == Some(3856151398934010975usize)
        );
        assert!(
            14145182192843625720usize.checked_sub(11054776169478634192usize)
                == Some(3090406023364991528usize)
        );
        assert!(
            16949318387516325180usize.checked_sub(7519447801116950488usize)
                == Some(9429870586399374692usize)
        );
        assert!(
            9099261935371435610usize.checked_sub(5527093864065406773usize)
                == Some(3572168071306028837usize)
        );
        assert!(
            14919261016548175147usize.checked_sub(7394339025379615873usize)
    ...
    {
        assert!(
            (18446744073709551615usize.checked_sub(0usize)).and_then(|r| r.checked_add(0usize))
                == Some(18446744073709551615usize)
        );
        assert!(
            (18446744073709551614usize.checked_sub(0usize)).and_then(|r| r.checked_add(0usize))
                == Some(18446744073709551614usize)
        );
        assert!(
            (18446744073709551614usize.checked_sub(1usize)).and_then(|r| r.checked_add(1usize))
                == Some(18446744073709551614usize)
        );
        assert!((0usize.checked_sub(0usize)).and_then(|r| r.checked_add(0usize)) == Some(0usize));
        assert!(
            (8009728807838115217usize.checked_sub(67256516030928668usize))
                .and_then(|r| r.checked_add(67256516030928668usize))
                == Some(8009728807838115217usize)
        );
        assert!(
            (10561639564784232478usize.checked_sub(8785087237299076002usize))
                .and_then(|r| r.checked_add(8785087237299076002usize))
                == Some(10561639564784232478usize)
        );
        assert!(
            (12705662100520079542usize.checked_sub(6141599397915733761usize))
                .and_then(|r| r.checked_add(6141599397915733761usize))
                == Some(12705662100520079542usize)
        );
        assert!(
            (16777284374870699054usize.checked_sub(6149564933671681785usize))
                .and_then(|r| r.checked_add(6149564933671681785usize))
                == Some(16777284374870699054usize)
        );
        assert!(
            (12249011539979776523usize.checked_sub(10884483193190351510usize))
                .and_then(|r| r.checked_add(10884483193190351510usize))
                == Some(12249011539979776523usize)
        );
        assert!(
            (11471000977050504534usize.checked_sub(1093058913877942105usize))
...
pub fn core_ops_sub_usize_saturating_sub() {
    eprintln!(r#"Testing "Properties for [`usize::saturating_sub`]"... (3 contracts)"#);
    eprint!("  ");
    // ## Semantics of the saturating subtraction
    // __Inputs:__ `x : usize, y : usize`
    // __Precondition:__ `true`
    // __Postcondition:__ `x.saturating_sub(y) == usize::down((x.up() - y.up()).max(0u8.up()))`
    {
        ...
        assert!(
            14556166693713666600usize.saturating_sub(4974257548872593863usize)
    ...
    // __Postcondition:__ `x.saturating_sub(y) == usize::down(x.up() - y.up())`
    {
        ...
        assert!(18446744073709551614usize.saturating_sub(0usize) == 18446744073709551614usize);
        assert!(
            17785595566364221454usize.saturating_sub(17443230930833566353usize)
                == 342364635530655101usize
        );
        assert!(
            12155225723683947891usize.saturating_sub(7171606477013558856usize)
                == 4983619246670389035usize
        );
        assert!(
            6687858734855333682usize.saturating_sub(4955158948495689148usize)
                == 1732699786359644534usize
        );
        assert!(
            17746810948255230576usize.saturating_sub(10769109137096537950usize)
...
pub fn core_ops_add_usize_add() {
    eprintln!(r#"Testing "Properties for [`core::ops::Add::<usize>::add`]"... (6 contracts)"#);
    eprint!("  ");
    // ## Semantics of non-overflowing addition
    // __Inputs:__ `x : usize, y : usize`
    // __Precondition:__ `x.up() + y.up() <= usize::MAX.up()`
    ...
    // __Postcondition:__ `panics!(x + y)`
    {
        ...
        assert!(panics!(
            10368113762359142120usize + 9963635987456779731usize
        ));
        assert!(panics!(
            16702656358892486099usize + 12451637191121733539usize
        ));
        assert!(panics!(
            9178086077756098535usize + 11171267287681670382usize
        ));
        assert!(panics!(
            15757977677384182039usize + 13605745617189664170usize
        ));
    }
    eprint!("... ");
    // ## Commutativity
    ...
    // __Postcondition:__ `x + y == y + x`
    {
        ...
        assert!(
            5876305528482333115usize + 11908109937929691380usize
                == 11908109937929691380usize + 5876305528482333115usize
        );
        assert!(
            5230015868462562393usize + 8943556176772194075usize
                == 8943556176772194075usize + 5230015868462562393usize
        );
        assert!(
            5152756109861782526usize + 10231222079206075967usize
                == 10231222079206075967usize + 5152756109861782526usize
        );
        assert!(
            6209498648946889356usize + 11037203673558055150usize
    ...
    // __Postcondition:__ `(x + y) + z == x + (y + z)`
    {
        ...
        assert!(
            (246396164729737932usize + 209359616097460718usize) + 16588232868187314087usize
                == 246396164729737932usize + (209359616097460718usize + 16588232868187314087usize)
        );
        assert!(
            (8316783747032347160usize + 1172275417719601977usize) + 5360233930547054744usize
                == 8316783747032347160usize + (1172275417719601977usize + 5360233930547054744usize)
        );
        assert!(
            (9519153513488759590usize + 2517331321474669830usize) + 5346181409655037304usize
                == 9519153513488759590usize + (2517331321474669830usize + 5346181409655037304usize)
        );
        assert!(
            (90748060878042810usize + 4339070313265244573usize) + 11277636240973771139usize
                == 90748060878042810usize + (4339070313265244573usize + 11277636240973771139usize)
        );
        assert!(
            (1701848048845129566usize + 6545293069332945680usize) + 1610212533647520436usize
                == 1701848048845129566usize + (6545293069332945680usize + 1610212533647520436usize)
        );
        assert!(
            (3910330855743005224usize + 1020447958184037288usize) + 13395077936000434289usize
...
pub fn core_ops_add_usize_wrapping_add() {
    eprintln!(r#"Testing "Properties for [`usize::wrapping_add`]"... (7 contracts)"#);
    eprint!("  ");
    // ## Semantics of the wrapping addition
    // __Inputs:__ `x : usize, y : usize`
    // __Precondition:__ `true`
    // __Postcondition:__ `x.wrapping_add(y) == usize::down((x.up() + y.up()) % (usize::MAX.up() + 1))`
    {
        ...
        assert!(
            15235124485451831874usize.wrapping_add(6747328178760566213usize)
                == 3535708590502846471usize
        );
        assert!(
            1802855230305248732usize.wrapping_add(13129040570932964408usize)
                == 14931895801238213140usize
        );
        assert!(
            3671613585811602930usize.wrapping_add(16388886141393815456usize)
                == 1613755653495866770usize
        );
        assert!(
            6703559748608055576usize.wrapping_add(12926559008937643417usize)
    ...
    // __Postcondition:__ `x.wrapping_add(y) == usize::down(x.up() + y.up())`
    {
        ...
        assert!(0usize.wrapping_add(18446744073709551615usize) == 18446744073709551615usize);
        assert!(
            3648819298171859381usize.wrapping_add(5315207303443876597usize)
                == 8964026601615735978usize
        );
        assert!(
            8643717940146586930usize.wrapping_add(1043042728609468183usize)
                == 9686760668756055113usize
        );
        assert!(
            4351032966922141358usize.wrapping_add(10070919490876838042usize)
                == 14421952457798979400usize
        );
        assert!(
            1442824337817309790usize.wrapping_add(10633846441590723547usize)
    ...
    // __Postcondition:__ `x.wrapping_add(y) == usize::down(x.up() + y.up() - usize::MAX - 1)`
    {
        ...
        assert!(
            18446744073709551615usize.wrapping_add(18446744073709551614usize)
                == 18446744073709551613usize
        );
        assert!(1usize.wrapping_add(18446744073709551615usize) == 0usize);
        assert!(
            18446744073709551614usize.wrapping_add(18446744073709551615usize)
                == 18446744073709551613usize
        );
        assert!(
            18446744073709551615usize.wrapping_add(18446744073709551615usize)
                == 18446744073709551614usize
        );
        assert!(
            16784322590542482783usize.wrapping_add(2049831613461701502usize)
                == 387410130294632669usize
        );
        assert!(
            17725414183693633968usize.wrapping_add(16313791575174388742usize)
                == 15592461685158471094usize
        );
        assert!(
            16097914311492656061usize.wrapping_add(11883608587744380932usize)
                == 9534778825527485377usize
        );
        assert!(
            3221882536032842762usize.wrapping_add(15661504760417905068usize)
    ...
    {
        assert!(
            1usize.wrapping_add(18446744073709551615usize)
                == 18446744073709551615usize.wrapping_add(1usize)
        );
        assert!(
            1usize.wrapping_add(18446744073709551614usize)
        ...
        assert!(
            18446744073709551614usize.wrapping_add(0usize)
                == 0usize.wrapping_add(18446744073709551614usize)
        );
        assert!(
            18446744073709551615usize.wrapping_add(0usize)
                == 0usize.wrapping_add(18446744073709551615usize)
        );
        assert!(
            5749525150258181653usize.wrapping_add(17042020308703899379usize)
                == 17042020308703899379usize.wrapping_add(5749525150258181653usize)
        );
        assert!(
            9686283840241351837usize.wrapping_add(15169358232551433622usize)
                == 15169358232551433622usize.wrapping_add(9686283840241351837usize)
        );
        assert!(
            507497753849002659usize.wrapping_add(17399171964854022573usize)
                == 17399171964854022573usize.wrapping_add(507497753849002659usize)
        );
        assert!(
            6165197429896190800usize.wrapping_add(11385056947126196306usize)
                == 11385056947126196306usize.wrapping_add(6165197429896190800usize)
        );
        assert!(
            11550396722627664018usize.wrapping_add(11351437391092708074usize)
    ...
    // __Postcondition:__ `(x.wrapping_add(y)).wrapping_add(z) == x.wrapping_add(y.wrapping_add(z))`
    {
        ...
        assert!(
            (3648157078776609435usize.wrapping_add(3148346129954011099usize))
                .wrapping_add(1649643555090817231usize)
                == 3648157078776609435usize
                    .wrapping_add(3148346129954011099usize.wrapping_add(1649643555090817231usize),)
        );
        assert!(
        (2718308695701804333usize.wrapping_add(10086994836505627977usize))
            .wrapping_add(4891952302632464397usize)
            == 2718308695701804333usize
                .wrapping_add(10086994836505627977usize.wrapping_add(4891952302632464397usize),)
    );
        assert!(
            (2816163504889826859usize.wrapping_add(2290296657238555457usize))
                .wrapping_add(4604218036408271915usize)
                == 2816163504889826859usize
                    .wrapping_add(2290296657238555457usize.wrapping_add(4604218036408271915usize),)
        );
        assert!(
            (6819670602500472543usize.wrapping_add(7404044978454508990usize))
        ...
        assert!(
            (411283087666211931usize.wrapping_add(13519459569222751417usize))
                .wrapping_add(682478499063716272usize)
                == 411283087666211931usize
                    .wrapping_add(13519459569222751417usize.wrapping_add(682478499063716272usize),)
        );
    }
    eprint!("... ");
    eprintln!("✓\n");
...
pub fn core_ops_add_usize_checked_add() {
    eprintln!(r#"Testing "Properties for [`usize::checked_add`]"... (6 contracts)"#);
    eprint!("  ");
    // ## Semantics of non-overflowing checked addition
    // __Inputs:__ `x : usize, y : usize`
    // __Precondition:__ `x.up() + y.up() <= usize::MAX.up()`
    // __Postcondition:__ `x.checked_add(y) == Some(usize::down(x.up() + y.up()))`
    {
        ...
        assert!(
            5795064554200689617usize.checked_add(7089888634905344749usize)
                == Some(12884953189106034366usize)
        );
        assert!(
            3558026152131867016usize.checked_add(7129031300367899975usize)
                == Some(10687057452499766991usize)
        );
        assert!(
            5458309914845725198usize.checked_add(9388159314455024305usize)
                == Some(14846469229300749503usize)
        );
        assert!(
            650579054521983677usize.checked_add(4499550872796186994usize)
                == Some(5150129927318170671usize)
        );
        assert!(
            8960009763094956822usize.checked_add(4661163856034892818usize)
    ...
    // __Postcondition:__ `x.checked_add(y) == y.checked_add(x)`
    {
        ...
        assert!(
            13177314144719991371usize.checked_add(5010917382322908355usize)
                == 5010917382322908355usize.checked_add(13177314144719991371usize)
        );
        assert!(
            16647434911058556091usize.checked_add(1462777363391334641usize)
                == 1462777363391334641usize.checked_add(16647434911058556091usize)
        );
        assert!(
            16316707662556971123usize.checked_add(8948323433076700077usize)
                == 8948323433076700077usize.checked_add(16316707662556971123usize)
        );
        assert!(
            18247883173692627419usize.checked_add(6678583807915110081usize)
    ...
    //         == y.checked_add(z).and_then(|iv| x.checked_add(iv))`
    {
        assert!(
            0usize
                .checked_add(1usize)
                .and_then(|iv| iv.checked_add(0usize))
                == 1usize
                    .checked_add(0usize)
        ...
        assert!(
            1usize
                .checked_add(0usize)
                .and_then(|iv| iv.checked_add(1usize))
                == 0usize
                    .checked_add(1usize)
...
pub fn core_ops_add_usize_saturating_add() {
    eprintln!(r#"Testing "Properties for [`usize::saturating_add`]"... (3 contracts)"#);
    eprint!("  ");
    // ## Semantics of the saturating addition
    // __Inputs:__ `x : usize, y : usize`
    // __Precondition:__ `true`
    // __Postcondition:__ `x.saturating_add(y) == usize::down((x.up() + y.up()).min(usize::MAX.up()))`
    {
        ...
        assert!(
            16281818915477680200usize.saturating_add(15920020320886183702usize)
                == 18446744073709551615usize
        );
        assert!(
            16138103697042413005usize.saturating_add(9356069411504569164usize)
                == 18446744073709551615usize
        );
        assert!(
            6707462531948697530usize.saturating_add(18093601426847002073usize)
                == 18446744073709551615usize
        );
        assert!(
            14938868503558851222usize.saturating_add(5395529792953060883usize)
                == 18446744073709551615usize
        );
        assert!(
            4821371318193376756usize.saturating_add(1673283564027971069usize)
    ...
    // __Postcondition:__ `x.saturating_add(y) == usize::down(x.up() + y.up())`
    {
        ...
        assert!(0usize.saturating_add(0usize) == 0usize);
        assert!(
            8098007502630414795usize.saturating_add(5366467384943610202usize)
                == 13464474887574024997usize
        );
        assert!(
            13551396658887834946usize.saturating_add(964271122464769230usize)
                == 14515667781352604176usize
        );
        assert!(
            8771660348056251754usize.saturating_add(9380314853244878430usize)
                == 18151975201301130184usize
        );
        assert!(
            4277429013620711612usize.saturating_add(881573156142959911usize)
                == 5159002169763671523usize
        );
        assert!(
            2296352774178396621usize.saturating_add(12303135946414054671usize)
                == 14599488720592451292usize
        );
        assert!(
            11335173689290817817usize.saturating_add(3035755102787251309usize)
...
pub fn t_i8_checked_neg() {
    eprintln!(r#"Testing "Properties for [`i8::checked_neg`]"... (2 contracts)"#);
    eprint!("  ");
    // ## Semantics of checked neg
    // __Inputs:__ `x : i8`
...
pub fn t_i8_neg() {
    eprintln!(r#"Testing "Properties for [`i8::neg`]"... (2 contracts)"#);
    eprint!("  ");
    // ## Semantics of checked neg
    // __Inputs:__ `x : i8`
    // __Precondition:__ `x != i8::MIN`
...
pub fn t_i8_overflowing_neg() {
    eprintln!(r#"Testing "Properties for [`i8::overflowing_neg`]"... (2 contracts)"#);
    eprint!("  ");
...
pub fn core_ops_sub_i8_sub() {
    eprintln!(r#"Testing "Properties for [`i8::sub`]"... (2 contracts)"#);
    eprint!("  ");
...
pub fn core_ops_sub_i8_checked_sub() {
    eprintln!(r#"Testing "Properties for [`i8::checked_sub`]"... (2 contracts)"#);
    eprint!("  ");
...
pub fn core_ops_sub_i8_wrapping_sub() {
    eprintln!(r#"Testing "Properties for [`i8::wrapping_sub`]"... (2 contracts)"#);
    eprint!("  ");
...
pub fn core_ops_sub_i8_overflowing_sub() {
    eprintln!(r#"Testing "Properties for [`i8::overflowing_sub`]"... (2 contracts)"#);
    eprint!("  ");
...
pub fn core_ops_add_i8_add() {
    eprintln!(r#"Testing "Properties for [`i8::add`]"... (2 contracts)"#);
    eprint!("  ");
    // ## Semantics of non-overflowing addition
    // __Inputs:__ `x : i8, y : i8`
    // __Precondition:__ `x.up() + y.up() <= i8::MAX.up() && x.up() + y.up() >= i8::MIN.up()`
...
pub fn t_i16_checked_neg() {
    eprintln!(r#"Testing "Properties for [`i16::checked_neg`]"... (2 contracts)"#);
    eprint!("  ");
    // ## Semantics of checked neg
    // __Inputs:__ `x : i16`
...
pub fn t_i16_neg() {
    eprintln!(r#"Testing "Properties for [`i16::neg`]"... (2 contracts)"#);
    eprint!("  ");
    // ## Semantics of checked neg
    // __Inputs:__ `x : i16`
    // __Precondition:__ `x != i16::MIN`
...
pub fn t_i16_overflowing_neg() {
    eprintln!(r#"Testing "Properties for [`i16::overflowing_neg`]"... (2 contracts)"#);
    eprint!("  ");
    // ## Semantics of overflowing neg
    // __Inputs:__ `x : i16`
    // __Precondition:__ `x != i16::MIN`
...
pub fn core_ops_sub_i16_sub() {
    eprintln!(r#"Testing "Properties for [`i16::sub`]"... (2 contracts)"#);
    eprint!("  ");
    // ## Semantics of non-overflowing subtraction
...
pub fn core_ops_sub_i16_checked_sub() {
    eprintln!(r#"Testing "Properties for [`i16::checked_sub`]"... (2 contracts)"#);
    eprint!("  ");
    // ## Semantics of non-overflowing checked subtraction
    // __Inputs:__ `x : i16, y : i16`
    // __Precondition:__ `x.up() - y.up() <= i16::MAX.up() && x.up() - y.up() >= i16::MIN.up()`
...
pub fn core_ops_sub_i16_wrapping_sub() {
    eprintln!(r#"Testing "Properties for [`i16::wrapping_sub`]"... (2 contracts)"#);
    eprint!("  ");
    // ## Semantics of non-overflowing wrapping subtraction
    // __Inputs:__ `x : i16, y : i16`
    // __Precondition:__ `x.up() - y.up() <= i16::MAX.up() && x.up() - y.up() >= i16::MIN.up()`
...
pub fn core_ops_sub_i16_overflowing_sub() {
    eprintln!(r#"Testing "Properties for [`i16::overflowing_sub`]"... (2 contracts)"#);
    eprint!("  ");
    // ## Semantics of overflowing subtraction when in bounds
    // __Inputs:__ `x : i16, y : i16`
    // __Precondition:__ `x.up() - y.up() <= i16::MAX.up() && x.up() - y.up() >= i16::MIN.up()`
...
pub fn core_ops_add_i16_add() {
    eprintln!(r#"Testing "Properties for [`i16::add`]"... (2 contracts)"#);
    eprint!("  ");
    // ## Semantics of non-overflowing addition
    // __Inputs:__ `x : i16, y : i16`
    // __Precondition:__ `x.up() + y.up() <= i16::MAX.up() && x.up() + y.up() >= i16::MIN.up()`
...
pub fn t_i32_checked_neg() {
    eprintln!(r#"Testing "Properties for [`i32::checked_neg`]"... (2 contracts)"#);
    eprint!("  ");
    // ## Semantics of checked neg
    // __Inputs:__ `x : i32`
...
pub fn t_i32_neg() {
    eprintln!(r#"Testing "Properties for [`i32::neg`]"... (2 contracts)"#);
    eprint!("  ");
    // ## Semantics of checked neg
    // __Inputs:__ `x : i32`
    // __Precondition:__ `x != i32::MIN`
...
pub fn t_i32_overflowing_neg() {
    eprintln!(r#"Testing "Properties for [`i32::overflowing_neg`]"... (2 contracts)"#);
    eprint!("  ");
    // ## Semantics of overflowing neg
    // __Inputs:__ `x : i32`
    // __Precondition:__ `x != i32::MIN`
...
pub fn core_ops_sub_i32_sub() {
    eprintln!(r#"Testing "Properties for [`i32::sub`]"... (2 contracts)"#);
    eprint!("  ");
    // ## Semantics of non-overflowing subtraction
...
pub fn core_ops_sub_i32_checked_sub() {
    eprintln!(r#"Testing "Properties for [`i32::checked_sub`]"... (2 contracts)"#);
    eprint!("  ");
    // ## Semantics of non-overflowing checked subtraction
    // __Inputs:__ `x : i32, y : i32`
    // __Precondition:__ `x.up() - y.up() <= i32::MAX.up() && x.up() - y.up() >= i32::MIN.up()`
...
pub fn core_ops_sub_i32_wrapping_sub() {
    eprintln!(r#"Testing "Properties for [`i32::wrapping_sub`]"... (2 contracts)"#);
    eprint!("  ");
    // ## Semantics of non-overflowing wrapping subtraction
    // __Inputs:__ `x : i32, y : i32`
    // __Precondition:__ `x.up() - y.up() <= i32::MAX.up() && x.up() - y.up() >= i32::MIN.up()`
...
pub fn core_ops_sub_i32_overflowing_sub() {
    eprintln!(r#"Testing "Properties for [`i32::overflowing_sub`]"... (2 contracts)"#);
    eprint!("  ");
    // ## Semantics of overflowing subtraction when in bounds
    // __Inputs:__ `x : i32, y : i32`
    // __Precondition:__ `x.up() - y.up() <= i32::MAX.up() && x.up() - y.up() >= i32::MIN.up()`
...
pub fn core_ops_add_i32_add() {
    eprintln!(r#"Testing "Properties for [`i32::add`]"... (2 contracts)"#);
    eprint!("  ");
    // ## Semantics of non-overflowing addition
    // __Inputs:__ `x : i32, y : i32`
    // __Precondition:__ `x.up() + y.up() <= i32::MAX.up() && x.up() + y.up() >= i32::MIN.up()`
...
pub fn t_i64_checked_neg() {
    eprintln!(r#"Testing "Properties for [`i64::checked_neg`]"... (2 contracts)"#);
    eprint!("  ");
    // ## Semantics of checked neg
    // __Inputs:__ `x : i64`
...
pub fn t_i64_neg() {
    eprintln!(r#"Testing "Properties for [`i64::neg`]"... (2 contracts)"#);
    eprint!("  ");
    // ## Semantics of checked neg
    // __Inputs:__ `x : i64`
    // __Precondition:__ `x != i64::MIN`
...
pub fn t_i64_overflowing_neg() {
    eprintln!(r#"Testing "Properties for [`i64::overflowing_neg`]"... (2 contracts)"#);
    eprint!("  ");
    // ## Semantics of overflowing neg
    // __Inputs:__ `x : i64`
    // __Precondition:__ `x != i64::MIN`
...
pub fn core_ops_sub_i64_sub() {
    eprintln!(r#"Testing "Properties for [`i64::sub`]"... (2 contracts)"#);
    eprint!("  ");
    // ## Semantics of non-overflowing subtraction
...
pub fn core_ops_sub_i64_checked_sub() {
    eprintln!(r#"Testing "Properties for [`i64::checked_sub`]"... (2 contracts)"#);
    eprint!("  ");
    // ## Semantics of non-overflowing checked subtraction
    // __Inputs:__ `x : i64, y : i64`
    // __Precondition:__ `x.up() - y.up() <= i64::MAX.up() && x.up() - y.up() >= i64::MIN.up()`
    // __Postcondition:__ `x.checked_sub(y) == Some(i64::down(x.up() - y.up()))`
    {
        ...
        assert!(
            (-675474367875466285i64).checked_sub((-8213321647790490525i64))
                == Some(7537847279915024240i64)
        );
        assert!(
            3131397178010228959i64.checked_sub(3023851924244293686i64)
                == Some(107545253765935273i64)
        );
        assert!(
            (-5923300338445224751i64).checked_sub((-5504770060523554130i64))
                == Some((-418530277921670621i64))
        );
        assert!(
            (-5328545996397710522i64).checked_sub((-8259734336471976319i64))
...
pub fn core_ops_sub_i64_wrapping_sub() {
    eprintln!(r#"Testing "Properties for [`i64::wrapping_sub`]"... (2 contracts)"#);
    eprint!("  ");
    // ## Semantics of non-overflowing wrapping subtraction
    // __Inputs:__ `x : i64, y : i64`
    // __Precondition:__ `x.up() - y.up() <= i64::MAX.up() && x.up() - y.up() >= i64::MIN.up()`
    // __Postcondition:__ `x.wrapping_sub(y) == i64::down(x.up() - y.up())`
    {
        ...
        assert!(
            4650256851600532737i64.wrapping_sub((-1548690037373197277i64))
                == 6198946888973730014i64
        );
        assert!(
            (-5658730372590221865i64).wrapping_sub((-3107812320211324630i64))
                == (-2550918052378897235i64)
        );
        assert!(
            (-6144459618722878189i64).wrapping_sub((-7186011627347797588i64))
                == 1041552008624919399i64
        );
        assert!(
            1431166605943135254i64.wrapping_sub(3523538221879879649i64)
    ...
    //         )`
    {
        ...
        assert!(
            7759304140136766403i64.wrapping_sub((-7930152515246132592i64))
                == (-2757287418326652621i64)
        );
        assert!(
            8552738389447771133i64.wrapping_sub((-2193554659142067736i64))
                == (-7700451025119712747i64)
        );
        assert!(
            8761243009880037112i64.wrapping_sub((-4526372616397489629i64))
                == (-5159128447432024875i64)
        );
        assert!(
            (-4634166286968915093i64).wrapping_sub(7592200324226771329i64)
...
pub fn core_ops_sub_i64_overflowing_sub() {
    eprintln!(r#"Testing "Properties for [`i64::overflowing_sub`]"... (2 contracts)"#);
    eprint!("  ");
    // ## Semantics of overflowing subtraction when in bounds
    // __Inputs:__ `x : i64, y : i64`
    // __Precondition:__ `x.up() - y.up() <= i64::MAX.up() && x.up() - y.up() >= i64::MIN.up()`
    // __Postcondition:__ `x.overflowing_sub(y) == (i64::down(x.up() - y.up()), false)`
    {
        ...
        assert!(
            (-9223372036854775808i64).overflowing_sub(0i64) == ((-9223372036854775808i64), false)
        );
        assert!(
            (-1i64).overflowing_sub(9223372036854775806i64) == ((-9223372036854775807i64), false)
        );
        assert!(0i64.overflowing_sub(9223372036854775806i64) == ((-9223372036854775806i64), false));
        assert!(
            (-9223372036854775807i64).overflowing_sub((-9223372036854775808i64)) == (1i64, false)
        );
        assert!(
            (-9223372036854775808i64).overflowing_sub((-9223372036854775808i64)) == (0i64, false)
        );
        assert!(
            4885767896873992467i64.overflowing_sub((-2467685871866010984i64))
                == (7353453768740003451i64, false)
        );
        assert!(
            (-7623464496184309353i64).overflowing_sub((-7233330922901274582i64))
                == ((-390133573283034771i64), false)
        );
        assert!(
            6145624956655326524i64.overflowing_sub(4945474956446646384i64)
                == (1200150000208680140i64, false)
        );
        assert!(
            3884913078009884102i64.overflowing_sub(781597362745179102i64)
    ...
    {
        assert!(
            1i64.overflowing_sub((-9223372036854775808i64)) == ((-9223372036854775807i64), true)
        );
        assert!(
            9223372036854775806i64.overflowing_sub((-9223372036854775808i64)) == ((-2i64), true)
        );
        assert!(
            1i64.overflowing_sub((-9223372036854775807i64)) == ((-9223372036854775808i64), true)
        );
        assert!(
            9223372036854775807i64.overflowing_sub((-9223372036854775807i64)) == ((-2i64), true)
        );
        assert!(
            0i64.overflowing_sub((-9223372036854775808i64)) == ((-9223372036854775808i64), true)
        );
        assert!((-9223372036854775807i64).overflowing_sub(9223372036854775806i64) == (3i64, true));
        assert!(
            7496220779045867418i64.overflowing_sub((-5671854986977583365i64))
                == ((-5278668307686100833i64), true)
        );
        assert!(
            8744409281176406064i64.overflowing_sub((-5301131656463161579i64))
                == ((-4401203136069983973i64), true)
        );
        assert!(
            (-6441517664081339448i64).overflowing_sub(4912532149531886868i64)
                == (7092694260096325300i64, true)
        );
        assert!(
            (-3216259431208045700i64).overflowing_sub(7231314152854285177i64)
...
pub fn core_ops_add_i64_add() {
    eprintln!(r#"Testing "Properties for [`i64::add`]"... (2 contracts)"#);
    eprint!("  ");
    // ## Semantics of non-overflowing addition
    // __Inputs:__ `x : i64, y : i64`
    // __Precondition:__ `x.up() + y.up() <= i64::MAX.up() && x.up() + y.up() >= i64::MIN.up()`
    ...
    // __Postcondition:__ `panics!(x + y)`
    {
        ...
        assert!(panics!(
            (-6936367409590020761i64) + (-9033068373086772228i64)
        ));
...
pub fn t_i128_checked_neg() {
    eprintln!(r#"Testing "Properties for [`i128::checked_neg`]"... (2 contracts)"#);
    eprint!("  ");
    // ## Semantics of checked neg
    // __Inputs:__ `x : i128`
    ...
    // __Postcondition:__ `x.checked_neg() == Some(i128::down(-x.up()))`
    {
        ...
        assert!(1i128.checked_neg() == Some((-1i128)));
        assert!(
            170141183460469231731687303715884105726i128.checked_neg()
                == Some((-170141183460469231731687303715884105726i128))
        );
        assert!(0i128.checked_neg() == Some(0i128));
        assert!(
            (-170141183460469231731687303715884105727i128).checked_neg()
        ...
        assert!(
            (-95691907531638855238485391376099019901i128).checked_neg()
                == Some(95691907531638855238485391376099019901i128)
        );
        assert!(
            (-152154770813539598248062471685986355254i128).checked_neg()
                == Some(152154770813539598248062471685986355254i128)
        );
        assert!(
            (-157673484561825246698680963746651689048i128).checked_neg()
                == Some(157673484561825246698680963746651689048i128)
        );
        assert!(
            46404704159008687264559839693591623727i128.checked_neg()
...
pub fn t_i128_neg() {
    eprintln!(r#"Testing "Properties for [`i128::neg`]"... (2 contracts)"#);
    eprint!("  ");
    // ## Semantics of checked neg
    // __Inputs:__ `x : i128`
    // __Precondition:__ `x != i128::MIN`
...
pub fn t_i128_overflowing_neg() {
    eprintln!(r#"Testing "Properties for [`i128::overflowing_neg`]"... (2 contracts)"#);
    eprint!("  ");
    // ## Semantics of overflowing neg
    // __Inputs:__ `x : i128`
    // __Precondition:__ `x != i128::MIN`
    ...
    {
        assert!(
            170141183460469231731687303715884105727i128.overflowing_neg()
                == ((-170141183460469231731687303715884105727i128), false)
        );
        assert!(
            170141183460469231731687303715884105726i128.overflowing_neg()
        ...
        assert!((-1i128).overflowing_neg() == (1i128, false));
        assert!(
            (-103938548178536339650223508405074132511i128).overflowing_neg()
                == (103938548178536339650223508405074132511i128, false)
        );
        assert!(
            87499038819484424366699419514517538100i128.overflowing_neg()
                == ((-87499038819484424366699419514517538100i128), false)
        );
        assert!(
            154435988416512551977935013582630987646i128.overflowing_neg()
                == ((-154435988416512551977935013582630987646i128), false)
        );
        assert!(
            152630260867229930608098369419641102959i128.overflowing_neg()
    ...
    {
        assert!(
            (-170141183460469231731687303715884105728i128).overflowing_neg()
...
pub fn core_ops_sub_i128_sub() {
    eprintln!(r#"Testing "Properties for [`i128::sub`]"... (2 contracts)"#);
    eprint!("  ");
    // ## Semantics of non-overflowing subtraction
    ...
    // __Postcondition:__ `x - y == i128::down(x.up() - y.up())`
    {
        ...
        assert!(
            1i128 - 170141183460469231731687303715884105726i128
                == (-170141183460469231731687303715884105725i128)
        );
        assert!(1i128 - (-1i128) == 2i128);
        assert!((-1i128) - 1i128 == (-2i128));
        assert!(
            (-21650826256048792566864100460291287012i128)
                - 128356083602329650645731014433393769712i128
                == (-150006909858378443212595114893685056724i128)
        );
        assert!(
            9031863670541152078126849445699999355i128 - 131345265424897630197103601983014214080i128
                == (-122313401754356478118976752537314214725i128)
        );
        assert!(
            (-28023893896328724345624169264545137888i128)
                - 121847989662082453816844541365708401874i128
                == (-149871883558411178162468710630253539762i128)
        );
        assert!(
            (-52442831776145319212826734233957583335i128)
    ...
    {
        assert!(panics!(
            0i128 - (-170141183460469231731687303715884105728i128)
        ));
        assert!(panics!(
            1i128 - (-170141183460469231731687303715884105728i128)
        ));
        assert!(panics!(
            170141183460469231731687303715884105727i128
...
pub fn core_ops_sub_i128_checked_sub() {
    eprintln!(r#"Testing "Properties for [`i128::checked_sub`]"... (2 contracts)"#);
    eprint!("  ");
    // ## Semantics of non-overflowing checked subtraction
    // __Inputs:__ `x : i128, y : i128`
    // __Precondition:__ `x.up() - y.up() <= i128::MAX.up() && x.up() - y.up() >= i128::MIN.up()`
    ...
    // __Postcondition:__ `x.checked_sub(y) == None`
    {
        ...
        assert!(
            162303195280770273463417786457500213469i128
                .checked_sub((-144685974033130641849832814924542770611i128))
                == None
        );
        assert!(
            83292051398199712710118212332722217418i128
                .checked_sub((-143984272439330058949420176257235358538i128))
                == None
        );
        assert!(
            (-31608659230758124729196379437770870955i128)
                .checked_sub(143763419195495013300798496587328613634i128)
                == None
        );
        assert!(
            128047356692809347951430474820080441791i128
                .checked_sub((-144629683881386173652609868891837568624i128))
                == None
        );
    }
    eprint!("... ");
...
pub fn core_ops_sub_i128_wrapping_sub() {
    eprintln!(r#"Testing "Properties for [`i128::wrapping_sub`]"... (2 contracts)"#);
    eprint!("  ");
    // ## Semantics of non-overflowing wrapping subtraction
    // __Inputs:__ `x : i128, y : i128`
    // __Precondition:__ `x.up() - y.up() <= i128::MAX.up() && x.up() - y.up() >= i128::MIN.up()`
    ...
    {
        assert!(
            (-1i128).wrapping_sub((-170141183460469231731687303715884105728i128))
                == 170141183460469231731687303715884105727i128
        );
        assert!(
            (-1i128).wrapping_sub((-170141183460469231731687303715884105727i128))
                == 170141183460469231731687303715884105726i128
        );
        assert!(
            170141183460469231731687303715884105726i128.wrapping_sub(0i128)
                == 170141183460469231731687303715884105726i128
        );
        assert!(
            170141183460469231731687303715884105726i128
                .wrapping_sub(170141183460469231731687303715884105726i128)
                == 0i128
        );
        assert!(1i128.wrapping_sub((-1i128)) == 2i128);
        assert!(
            1i128.wrapping_sub(170141183460469231731687303715884105726i128)
                == (-170141183460469231731687303715884105725i128)
        );
        assert!(
            77136355809977261699074636867802433040i128
                .wrapping_sub(49371806888733199449413887565612051395i128)
                == 27764548921244062249660749302190381645i128
        );
        assert!(
            (-54953360832168655964648344409768109544i128)
                .wrapping_sub(107675275980606498045267042780456393011i128)
                == (-162628636812775154009915387190224502555i128)
        );
        assert!(
            128228348890160810579199112700847296693i128
                .wrapping_sub(54081701298020160317925865331831709467i128)
                == 74146647592140650261273247369015587226i128
        );
        assert!(
            143712645059049495049787259774421251605i128
    ...
    //         )`
    {
        assert!(
            170141183460469231731687303715884105726i128
                .wrapping_sub((-170141183460469231731687303715884105727i128))
                == (-3i128)
        );
        assert!(
            1i128.wrapping_sub((-170141183460469231731687303715884105727i128))
...
pub fn core_ops_sub_i128_overflowing_sub() {
    eprintln!(r#"Testing "Properties for [`i128::overflowing_sub`]"... (2 contracts)"#);
    eprint!("  ");
    // ## Semantics of overflowing subtraction when in bounds
    // __Inputs:__ `x : i128, y : i128`
    // __Precondition:__ `x.up() - y.up() <= i128::MAX.up() && x.up() - y.up() >= i128::MIN.up()`
    ...
    {
        assert!(
            170141183460469231731687303715884105726i128.overflowing_sub(1i128)
    ...
    {
        assert!(
            1i128.overflowing_sub((-170141183460469231731687303715884105727i128))
                == ((-170141183460469231731687303715884105728i128), true)
        );
        assert!(
            (-170141183460469231731687303715884105727i128)
        ...
        assert!(
            (-170141183460469231731687303715884105728i128)
                .overflowing_sub(170141183460469231731687303715884105726i128)
                == (2i128, true)
        );
        assert!(
            (-170141183460469231731687303715884105728i128).overflowing_sub(1i128)
...
pub fn core_ops_add_i128_add() {
    eprintln!(r#"Testing "Properties for [`i128::add`]"... (2 contracts)"#);
    eprint!("  ");
    // ## Semantics of non-overflowing addition
    // __Inputs:__ `x : i128, y : i128`
    // __Precondition:__ `x.up() + y.up() <= i128::MAX.up() && x.up() + y.up() >= i128::MIN.up()`
    // __Postcondition:__ `x + y == i128::down(x.up() + y.up())`
    {
        ...
        assert!(
            0i128 + 170141183460469231731687303715884105726i128
                == 170141183460469231731687303715884105726i128
        );
        assert!(
            170141183460469231731687303715884105727i128 + (-1i128)
...
pub fn t_isize_checked_neg() {
    eprintln!(r#"Testing "Properties for [`isize::checked_neg`]"... (2 contracts)"#);
    eprint!("  ");
    // ## Semantics of checked neg
    // __Inputs:__ `x : isize`
...
pub fn t_isize_neg() {
    eprintln!(r#"Testing "Properties for [`isize::neg`]"... (2 contracts)"#);
    eprint!("  ");
    // ## Semantics of checked neg
    // __Inputs:__ `x : isize`
    // __Precondition:__ `x != isize::MIN`
...
pub fn t_isize_overflowing_neg() {
    eprintln!(r#"Testing "Properties for [`isize::overflowing_neg`]"... (2 contracts)"#);
    eprint!("  ");
    // ## Semantics of overflowing neg
    // __Inputs:__ `x : isize`
    // __Precondition:__ `x != isize::MIN`
    ...
    {
        assert!(
            (-9223372036854775808isize).overflowing_neg() == ((-9223372036854775808isize), true)
        );
    }
    eprint!("... ");
    eprintln!("✓\n");
...
pub fn core_ops_sub_isize_sub() {
    eprintln!(r#"Testing "Properties for [`isize::sub`]"... (2 contracts)"#);
    eprint!("  ");
    // ## Semantics of non-overflowing subtraction
    ...
    // __Postcondition:__ `x - y == isize::down(x.up() - y.up())`
    {
        ...
        assert!(
            (-7338477564517266696isize) - (-5628106797884762622isize)
                == (-1710370766632504074isize)
        );
        assert!(
            (-8138309089473986692isize) - (-8686489985010777830isize) == 548180895536791138isize
        );
        assert!(
            (-6270893275237448604isize) - (-6535369047831633476isize) == 264475772594184872isize
        );
    ...
    // __Postcondition:__ `panics!(x - y)`
    {
        ...
        assert!(panics!(
            (-9223372036854775808isize) - 9223372036854775807isize
        ));
        assert!(panics!(
            9223372036854775807isize - (-9223372036854775807isize)
        ));
        assert!(panics!(
            (-9223372036854775807isize) - 9223372036854775807isize
        ));
        assert!(panics!(
            (-9223372036854775807isize) - 9223372036854775806isize
        ));
        assert!(panics!(
            9223372036854775806isize - (-9223372036854775807isize)
        ));
        assert!(panics!(
            4503853598369427710isize - (-7617894189483393931isize)
        ));
        assert!(panics!(
            (-8454894531472910545isize) - 3684059865734408602isize
        ));
        assert!(panics!(
            7284450373288922992isize - (-4050578844854945209isize)
        ));
        assert!(panics!(
            3476275717907553625isize - (-6676084141611179642isize)
        ));
    }
    eprint!("... ");
    eprintln!("✓\n");
...
pub fn core_ops_sub_isize_checked_sub() {
    eprintln!(r#"Testing "Properties for [`isize::checked_sub`]"... (2 contracts)"#);
    eprint!("  ");
    // ## Semantics of non-overflowing checked subtraction
    // __Inputs:__ `x : isize, y : isize`
    // __Precondition:__ `x.up() - y.up() <= isize::MAX.up() && x.up() - y.up() >= isize::MIN.up()`
    ...
    {
        assert!(
            (-9223372036854775807isize).checked_sub((-1isize)) == Some((-9223372036854775806isize))
        );
        ...
        assert!(
            (-6124743656760643910isize).checked_sub((-7907625948738860370isize))
                == Some(1782882291978216460isize)
        );
        assert!(
            4060881704856995796isize.checked_sub((-1311929649082019865isize))
                == Some(5372811353939015661isize)
        );
        assert!(
            (-4843263809085804003isize).checked_sub(3990304723078083787isize)
                == Some((-8833568532163887790isize))
        );
        assert!(
            1525253900160419680isize.checked_sub(3498927651472102397isize)
...
pub fn core_ops_sub_isize_wrapping_sub() {
    eprintln!(r#"Testing "Properties for [`isize::wrapping_sub`]"... (2 contracts)"#);
    eprint!("  ");
    // ## Semantics of non-overflowing wrapping subtraction
    // __Inputs:__ `x : isize, y : isize`
    // __Precondition:__ `x.up() - y.up() <= isize::MAX.up() && x.up() - y.up() >= isize::MIN.up()`
    // __Postcondition:__ `x.wrapping_sub(y) == isize::down(x.up() - y.up())`
    {
        ...
        assert!(
            (-2118665846411122691isize).wrapping_sub((-4093022624106893409isize))
                == 1974356777695770718isize
        );
        assert!(
            1765633544314613545isize.wrapping_sub((-6155539524046151672isize))
                == 7921173068360765217isize
        );
        assert!(
            (-3878262326622918773isize).wrapping_sub(364310167721180810isize)
                == (-4242572494344099583isize)
        );
        assert!(
            (-3325162980394686616isize).wrapping_sub(4897713338364617322isize)
    ...
    //         )`
    {
        ...
        assert!(
            (-5480730541309930839isize).wrapping_sub(4681652054233516845isize)
                == 8284361478166103932isize
        );
        assert!(
            5141794441144812228isize.wrapping_sub((-7919222970651713296isize))
                == (-5385726661913026092isize)
        );
        assert!(
            4386896238067475151isize.wrapping_sub((-5828049264749490187isize))
                == (-8231798570892586278isize)
        );
        assert!(
            (-8866738695397750423isize).wrapping_sub(2576013731143679621isize)
...
pub fn core_ops_sub_isize_overflowing_sub() {
    eprintln!(r#"Testing "Properties for [`isize::overflowing_sub`]"... (2 contracts)"#);
    eprint!("  ");
    // ## Semantics of overflowing subtraction when in bounds
    // __Inputs:__ `x : isize, y : isize`
    // __Precondition:__ `x.up() - y.up() <= isize::MAX.up() && x.up() - y.up() >= isize::MIN.up()`
    ...
    {
        assert!(
            0isize.overflowing_sub(9223372036854775806isize)
        ...
        assert!(
            1isize.overflowing_sub(9223372036854775807isize)
                == ((-9223372036854775806isize), false)
        );
        assert!(
            (-9223372036854775808isize).overflowing_sub((-9223372036854775807isize))
                == ((-1isize), false)
        );
        assert!((-1isize).overflowing_sub(1isize) == ((-2isize), false));
        assert!(
            (-4100590147257551976isize).overflowing_sub((-768463483533997689isize))
                == ((-3332126663723554287isize), false)
        );
        assert!(
            2652201538014560302isize.overflowing_sub(7062037720623157490isize)
                == ((-4409836182608597188isize), false)
        );
        assert!(
            1526972100056696383isize.overflowing_sub((-78161275453106386isize))
                == (1605133375509802769isize, false)
        );
        assert!(
            5320482458855998708isize.overflowing_sub(4870150821354305526isize)
    ...
    {
        assert!(
            0isize.overflowing_sub((-9223372036854775808isize))
                == ((-9223372036854775808isize), true)
        );
        assert!(
            (-9223372036854775807isize).overflowing_sub(9223372036854775807isize) == (2isize, true)
        );
        assert!(
            (-9223372036854775808isize).overflowing_sub(1isize) == (9223372036854775807isize, true)
        );
        assert!(
            9223372036854775807isize.overflowing_sub((-9223372036854775807isize))
                == ((-2isize), true)
        );
        assert!(
            9223372036854775806isize.overflowing_sub((-9223372036854775808isize))
                == ((-2isize), true)
        );
        assert!(
            9223372036854775807isize.overflowing_sub((-9223372036854775808isize))
                == ((-1isize), true)
        );
        assert!(
            9165045295486714134isize.overflowing_sub((-6435302149633211661isize))
                == ((-2846396628589625821isize), true)
        );
        assert!(
            8485965147729987740isize.overflowing_sub((-8641414842229566103isize))
                == ((-1319364083749997773isize), true)
        );
        assert!(
            (-9219609676091240046isize).overflowing_sub(5753357497040942061isize)
                == (3473776900577369509isize, true)
        );
        assert!(
            4605438822403994148isize.overflowing_sub((-4968905245923248448isize))
...
pub fn core_ops_add_isize_add() {
    eprintln!(r#"Testing "Properties for [`isize::add`]"... (2 contracts)"#);
    eprint!("  ");
    // ## Semantics of non-overflowing addition
    // __Inputs:__ `x : isize, y : isize`
    // __Precondition:__ `x.up() + y.up() <= isize::MAX.up() && x.up() + y.up() >= isize::MIN.up()`
    // __Postcondition:__ `x + y == isize::down(x.up() + y.up())`
    {
        ...
        assert!(
            (-7703283440005635866isize) + 531052765719112566isize == (-7172230674286523300isize)
        );
    ...
    // __Postcondition:__ `panics!(x + y)`
    {
        ...
        assert!(panics!(
            (-9223372036854775807isize) + (-9223372036854775808isize)
        ));
        ...
        assert!(panics!(
            (-9023495905589270361isize) + (-3790890983243907443isize)
        ));
...
pub fn core_cmp_partial_ord_u8_cmp() {
    eprintln!(r#"Testing "Properties for [`core::cmp::PartialOrd::<u8>::cmp`]"... (1 contracts)"#);
    eprint!("  ");
...
pub fn core_cmp_partial_ord_u8_lt() {
    eprintln!(r#"Testing "Properties for [`core::cmp::PartialOrd::<u8>::lt`]"... (1 contracts)"#);
    eprint!("  ");
    // ## Semantics of comparaison
    // __Inputs:__ `x : u8, y : u8`
    // __Precondition:__ `true`
...
pub fn core_cmp_partial_ord_u8_gt() {
    eprintln!(r#"Testing "Properties for [`core::cmp::PartialOrd::<u8>::gt`]"... (1 contracts)"#);
    eprint!("  ");
    // ## Semantics of comparaison
    // __Inputs:__ `x : u8, y : u8`
    // __Precondition:__ `true`
...
pub fn core_cmp_partial_ord_u8_ge() {
    eprintln!(r#"Testing "Properties for [`core::cmp::PartialOrd::<u8>::ge`]"... (1 contracts)"#);
    eprint!("  ");
    // ## Semantics of comparaison
    // __Inputs:__ `x : u8, y : u8`
    // __Precondition:__ `true`
...
pub fn core_cmp_partial_ord_u8_le() {
    eprintln!(r#"Testing "Properties for [`core::cmp::PartialOrd::<u8>::le`]"... (1 contracts)"#);
    eprint!("  ");
    // ## Semantics of comparaison
    // __Inputs:__ `x : u8, y : u8`
    // __Precondition:__ `true`
...
pub fn core_ops_bit_xor_u8_xor() {
    eprintln!(r#"Testing "Properties for [`core::ops::BitXor::<u8>::bitxor`]"... (1 contracts)"#);
    eprint!("  ");
...
pub fn core_ops_bit_and_u8_and() {
    eprintln!(r#"Testing "Properties for [`core::ops::BitAnd::<u8>::bitand`]"... (1 contracts)"#);
    eprint!("  ");
...
pub fn core_ops_bit_and_u8_or() {
    eprintln!(r#"Testing "Properties for [`core::ops::BitAnd::<u8>::bitor`]"... (1 contracts)"#);
    eprint!("  ");
    // ## Semantics of bitwise or
    // __Inputs:__ `x : u8, y : u8`
    // __Precondition:__ `true`
...
pub fn core_cmp_partial_ord_u16_cmp() {
    eprintln!(r#"Testing "Properties for [`core::cmp::PartialOrd::<u16>::cmp`]"... (1 contracts)"#);
    eprint!("  ");
    // ## Semantics of comparaison
    // __Inputs:__ `x : u16, y : u16`
    // __Precondition:__ `true`
...
pub fn core_cmp_partial_ord_u16_lt() {
    eprintln!(r#"Testing "Properties for [`core::cmp::PartialOrd::<u16>::lt`]"... (1 contracts)"#);
    eprint!("  ");
    // ## Semantics of comparaison
    // __Inputs:__ `x : u16, y : u16`
    // __Precondition:__ `true`
...
pub fn core_cmp_partial_ord_u16_gt() {
    eprintln!(r#"Testing "Properties for [`core::cmp::PartialOrd::<u16>::gt`]"... (1 contracts)"#);
    eprint!("  ");
    // ## Semantics of comparaison
    // __Inputs:__ `x : u16, y : u16`
    // __Precondition:__ `true`
...
pub fn core_cmp_partial_ord_u16_ge() {
    eprintln!(r#"Testing "Properties for [`core::cmp::PartialOrd::<u16>::ge`]"... (1 contracts)"#);
    eprint!("  ");
    // ## Semantics of comparaison
    // __Inputs:__ `x : u16, y : u16`
    // __Precondition:__ `true`
...
pub fn core_cmp_partial_ord_u16_le() {
    eprintln!(r#"Testing "Properties for [`core::cmp::PartialOrd::<u16>::le`]"... (1 contracts)"#);
    eprint!("  ");
    // ## Semantics of comparaison
    // __Inputs:__ `x : u16, y : u16`
    // __Precondition:__ `true`
...
pub fn core_ops_bit_xor_u16_xor() {
    eprintln!(r#"Testing "Properties for [`core::ops::BitXor::<u16>::bitxor`]"... (1 contracts)"#);
    eprint!("  ");
    // ## Semantics of bitwise or
    // __Inputs:__ `x : u16, y : u16`
    // __Precondition:__ `true`
...
pub fn core_ops_bit_and_u16_and() {
    eprintln!(r#"Testing "Properties for [`core::ops::BitAnd::<u16>::bitand`]"... (1 contracts)"#);
    eprint!("  ");
    // ## Semantics of bitwise and
    // __Inputs:__ `x : u16, y : u16`
    // __Precondition:__ `true`
...
pub fn core_ops_bit_and_u16_or() {
    eprintln!(r#"Testing "Properties for [`core::ops::BitAnd::<u16>::bitor`]"... (1 contracts)"#);
    eprint!("  ");
    // ## Semantics of bitwise or
    // __Inputs:__ `x : u16, y : u16`
    // __Precondition:__ `true`
...
pub fn core_cmp_partial_ord_u32_cmp() {
    eprintln!(r#"Testing "Properties for [`core::cmp::PartialOrd::<u32>::cmp`]"... (1 contracts)"#);
    eprint!("  ");
    // ## Semantics of comparaison
    // __Inputs:__ `x : u32, y : u32`
    // __Precondition:__ `true`
...
pub fn core_cmp_partial_ord_u32_lt() {
    eprintln!(r#"Testing "Properties for [`core::cmp::PartialOrd::<u32>::lt`]"... (1 contracts)"#);
    eprint!("  ");
    // ## Semantics of comparaison
    // __Inputs:__ `x : u32, y : u32`
    // __Precondition:__ `true`
...
pub fn core_cmp_partial_ord_u32_gt() {
    eprintln!(r#"Testing "Properties for [`core::cmp::PartialOrd::<u32>::gt`]"... (1 contracts)"#);
    eprint!("  ");
    // ## Semantics of comparaison
    // __Inputs:__ `x : u32, y : u32`
    // __Precondition:__ `true`
...
pub fn core_cmp_partial_ord_u32_ge() {
    eprintln!(r#"Testing "Properties for [`core::cmp::PartialOrd::<u32>::ge`]"... (1 contracts)"#);
    eprint!("  ");
    // ## Semantics of comparaison
    // __Inputs:__ `x : u32, y : u32`
    // __Precondition:__ `true`
...
pub fn core_cmp_partial_ord_u32_le() {
    eprintln!(r#"Testing "Properties for [`core::cmp::PartialOrd::<u32>::le`]"... (1 contracts)"#);
    eprint!("  ");
    // ## Semantics of comparaison
    // __Inputs:__ `x : u32, y : u32`
    // __Precondition:__ `true`
...
pub fn core_ops_bit_xor_u32_xor() {
    eprintln!(r#"Testing "Properties for [`core::ops::BitXor::<u32>::bitxor`]"... (1 contracts)"#);
    eprint!("  ");
    // ## Semantics of bitwise or
    // __Inputs:__ `x : u32, y : u32`
    // __Precondition:__ `true`
...
pub fn core_ops_bit_and_u32_and() {
    eprintln!(r#"Testing "Properties for [`core::ops::BitAnd::<u32>::bitand`]"... (1 contracts)"#);
    eprint!("  ");
    // ## Semantics of bitwise and
    // __Inputs:__ `x : u32, y : u32`
    // __Precondition:__ `true`
...
pub fn core_ops_bit_and_u32_or() {
    eprintln!(r#"Testing "Properties for [`core::ops::BitAnd::<u32>::bitor`]"... (1 contracts)"#);
    eprint!("  ");
    // ## Semantics of bitwise or
    // __Inputs:__ `x : u32, y : u32`
    // __Precondition:__ `true`
...
pub fn core_cmp_partial_ord_u64_cmp() {
    eprintln!(r#"Testing "Properties for [`core::cmp::PartialOrd::<u64>::cmp`]"... (1 contracts)"#);
    eprint!("  ");
    // ## Semantics of comparaison
    // __Inputs:__ `x : u64, y : u64`
    // __Precondition:__ `true`
    // __Postcondition:__ `x.cmp(&(y)) == x.up().cmp(&(y).up())`
    {
        ...
        assert!(
            18446744073709551614u64.cmp(&(18446744073709551615u64)) == core::cmp::Ordering::Less
        );
        ...
        assert!(
            13213794433460719651u64.cmp(&(437740726794001150u64)) == core::cmp::Ordering::Greater
        );
        assert!(
            16918565706134240658u64.cmp(&(4142892570982282199u64)) == core::cmp::Ordering::Greater
        );
        assert!(1789306540001491632u64.cmp(&(5167049413076872212u64)) == core::cmp::Ordering::Less);
        assert!(
            18221453977496644021u64.cmp(&(9815316640342419550u64)) == core::cmp::Ordering::Greater
        );
    }
    eprint!("... ");
    eprintln!("✓\n");
...
pub fn core_cmp_partial_ord_u64_lt() {
    eprintln!(r#"Testing "Properties for [`core::cmp::PartialOrd::<u64>::lt`]"... (1 contracts)"#);
    eprint!("  ");
    // ## Semantics of comparaison
    // __Inputs:__ `x : u64, y : u64`
    // __Precondition:__ `true`
...
pub fn core_cmp_partial_ord_u64_gt() {
    eprintln!(r#"Testing "Properties for [`core::cmp::PartialOrd::<u64>::gt`]"... (1 contracts)"#);
    eprint!("  ");
    // ## Semantics of comparaison
    // __Inputs:__ `x : u64, y : u64`
    // __Precondition:__ `true`
...
pub fn core_cmp_partial_ord_u64_ge() {
    eprintln!(r#"Testing "Properties for [`core::cmp::PartialOrd::<u64>::ge`]"... (1 contracts)"#);
    eprint!("  ");
    // ## Semantics of comparaison
    // __Inputs:__ `x : u64, y : u64`
    // __Precondition:__ `true`
...
pub fn core_cmp_partial_ord_u64_le() {
    eprintln!(r#"Testing "Properties for [`core::cmp::PartialOrd::<u64>::le`]"... (1 contracts)"#);
    eprint!("  ");
    // ## Semantics of comparaison
    // __Inputs:__ `x : u64, y : u64`
    // __Precondition:__ `true`
...
pub fn core_ops_bit_xor_u64_xor() {
    eprintln!(r#"Testing "Properties for [`core::ops::BitXor::<u64>::bitxor`]"... (1 contracts)"#);
    eprint!("  ");
    // ## Semantics of bitwise or
    // __Inputs:__ `x : u64, y : u64`
    // __Precondition:__ `true`
...
pub fn core_ops_bit_and_u64_and() {
    eprintln!(r#"Testing "Properties for [`core::ops::BitAnd::<u64>::bitand`]"... (1 contracts)"#);
    eprint!("  ");
    // ## Semantics of bitwise and
    // __Inputs:__ `x : u64, y : u64`
    // __Precondition:__ `true`
...
pub fn core_ops_bit_and_u64_or() {
    eprintln!(r#"Testing "Properties for [`core::ops::BitAnd::<u64>::bitor`]"... (1 contracts)"#);
    eprint!("  ");
    // ## Semantics of bitwise or
    // __Inputs:__ `x : u64, y : u64`
    // __Precondition:__ `true`
...
pub fn core_cmp_partial_ord_u128_cmp() {
    eprintln!(
        r#"Testing "Properties for [`core::cmp::PartialOrd::<u128>::cmp`]"... (1 contracts)"#
    );
    eprint!("  ");
    // ## Semantics of comparaison
    // __Inputs:__ `x : u128, y : u128`
    ...
    // __Postcondition:__ `x.cmp(&(y)) == x.up().cmp(&(y).up())`
    {
        ...
        assert!(
            340282366920938463463374607431768211454u128.cmp(&(0u128))
                == core::cmp::Ordering::Greater
        );
        assert!(
            1u128.cmp(&(340282366920938463463374607431768211454u128)) == core::cmp::Ordering::Less
        );
        assert!(
            340282366920938463463374607431768211455u128
        ...
        assert!(
            44975951252517382259136865103509029750u128
                .cmp(&(257641522641119427820388980212092478833u128))
                == core::cmp::Ordering::Less
        );
        assert!(
            248434684924782269368664903704438068841u128
                .cmp(&(312374530296163019514539641492995103423u128))
                == core::cmp::Ordering::Less
        );
        assert!(
            276195689538573184530416463225100515095u128
                .cmp(&(160513775042236247494311639318765835762u128))
                == core::cmp::Ordering::Greater
        );
        assert!(
            175683973946606948385124461571982633367u128
                .cmp(&(123785432016582443496034597215545976793u128))
                == core::cmp::Ordering::Greater
        );
        assert!(
            303431222115574575076079116287094063580u128
...
pub fn core_cmp_partial_ord_u128_lt() {
    eprintln!(r#"Testing "Properties for [`core::cmp::PartialOrd::<u128>::lt`]"... (1 contracts)"#);
    eprint!("  ");
    // ## Semantics of comparaison
    // __Inputs:__ `x : u128, y : u128`
    // __Precondition:__ `true`
    // __Postcondition:__ `x.lt(&(y)) == x.up().lt(&(y).up())`
    {
        ...
        assert!(
            75011316906720783014415590577846840000u128
                .lt(&(266474547533521045769510423900201615758u128))
                == true
        );
        assert!(
            201038579442682444526088008712651054007u128
                .lt(&(192134843451051941324400975454732287608u128))
                == false
        );
        assert!(
            60311938750415042280017927889255909986u128
                .lt(&(55546713626375861041064972747374848283u128))
                == false
        );
        assert!(
            179693580295672571309301752130346329015u128
                .lt(&(45967089973199729865842876010949644173u128))
                == false
        );
    }
    eprint!("... ");
...
pub fn core_cmp_partial_ord_u128_gt() {
    eprintln!(r#"Testing "Properties for [`core::cmp::PartialOrd::<u128>::gt`]"... (1 contracts)"#);
    eprint!("  ");
    // ## Semantics of comparaison
    // __Inputs:__ `x : u128, y : u128`
    // __Precondition:__ `true`
    // __Postcondition:__ `x.gt(&(y)) == x.up().gt(&(y).up())`
    {
        assert!(
            340282366920938463463374607431768211455u128
                .gt(&(340282366920938463463374607431768211454u128))
                == true
        );
        ...
        assert!(
            97999415950712288112247566704919453034u128
                .gt(&(208998753070433299756390042979153216980u128))
                == false
        );
        assert!(
            334899404621691313609704411733688726564u128
                .gt(&(196339828089047844343060674069606985297u128))
                == true
        );
        assert!(
            137924494976594710027400828876862275552u128
                .gt(&(147811836854977082207430458620432092947u128))
                == false
        );
        assert!(
            234155103396747879709534580194692888023u128
                .gt(&(240559332697003469441202067648824230668u128))
                == false
        );
        assert!(
            242617701629624030176494084981164410872u128
                .gt(&(252969267285176317069776849254812791786u128))
                == false
        );
    }
    eprint!("... ");
...
pub fn core_cmp_partial_ord_u128_ge() {
    eprintln!(r#"Testing "Properties for [`core::cmp::PartialOrd::<u128>::ge`]"... (1 contracts)"#);
    eprint!("  ");
    // ## Semantics of comparaison
    // __Inputs:__ `x : u128, y : u128`
    // __Precondition:__ `true`
    // __Postcondition:__ `x.ge(&(y)) == x.up().ge(&(y).up())`
    {
        ...
        assert!(
            340282366920938463463374607431768211455u128
                .ge(&(340282366920938463463374607431768211455u128))
                == true
        );
        assert!(1u128.ge(&(0u128)) == true);
        assert!(
            85350778698249401943755168099500986728u128
                .ge(&(292989768023270401715577185850297719905u128))
                == false
        );
        assert!(
            99781833176100874890600342518182837382u128
                .ge(&(329073392374250701387799591442585294270u128))
                == false
        );
        assert!(
            109525442522514821699432389430748993314u128
                .ge(&(325185859195176575216648050576873446644u128))
                == false
        );
        assert!(
            209432661073022208893386794696369458418u128
                .ge(&(67843884735641090713812193561071478408u128))
                == true
        );
        assert!(
            248582467524149512075057417092736786156u128
                .ge(&(72510307087564574936643873496085211907u128))
                == true
        );
    }
    eprint!("... ");
...
pub fn core_cmp_partial_ord_u128_le() {
    eprintln!(r#"Testing "Properties for [`core::cmp::PartialOrd::<u128>::le`]"... (1 contracts)"#);
    eprint!("  ");
    // ## Semantics of comparaison
    // __Inputs:__ `x : u128, y : u128`
    // __Precondition:__ `true`
    // __Postcondition:__ `x.le(&(y)) == x.up().le(&(y).up())`
    {
        ...
        assert!(
            340282366920938463463374607431768211454u128
                .le(&(340282366920938463463374607431768211455u128))
                == true
        );
        assert!(
            250801215464997260551538121087393625146u128
                .le(&(153869002672428563982312923461117563158u128))
                == false
        );
        assert!(
            78003341282175475431923564063773996984u128
                .le(&(171178867677751175301008878294487976688u128))
                == true
        );
        assert!(
            27241733892516194315162783344863098721u128
                .le(&(132692428182727579328214936494804729172u128))
                == true
        );
        assert!(
            167440770341424486732373128370091033169u128
                .le(&(176041857438632164844136325937955598742u128))
                == true
        );
    }
    eprint!("... ");
...
pub fn core_ops_bit_xor_u128_xor() {
    eprintln!(r#"Testing "Properties for [`core::ops::BitXor::<u128>::bitxor`]"... (1 contracts)"#);
    eprint!("  ");
    // ## Semantics of bitwise or
    // __Inputs:__ `x : u128, y : u128`
    // __Precondition:__ `true`
...
pub fn core_ops_bit_and_u128_and() {
    eprintln!(r#"Testing "Properties for [`core::ops::BitAnd::<u128>::bitand`]"... (1 contracts)"#);
    eprint!("  ");
    // ## Semantics of bitwise and
    // __Inputs:__ `x : u128, y : u128`
    // __Precondition:__ `true`
...
pub fn core_ops_bit_and_u128_or() {
    eprintln!(r#"Testing "Properties for [`core::ops::BitAnd::<u128>::bitor`]"... (1 contracts)"#);
    eprint!("  ");
    // ## Semantics of bitwise or
    // __Inputs:__ `x : u128, y : u128`
    // __Precondition:__ `true`
...
pub fn core_cmp_partial_ord_usize_cmp() {
    eprintln!(
        r#"Testing "Properties for [`core::cmp::PartialOrd::<usize>::cmp`]"... (1 contracts)"#
    );
    eprint!("  ");
    // ## Semantics of comparaison
    // __Inputs:__ `x : usize, y : usize`
    ...
    // __Postcondition:__ `x.cmp(&(y)) == x.up().cmp(&(y).up())`
    {
        ...
        assert!(
            18446744073709551615usize.cmp(&(18446744073709551614usize))
                == core::cmp::Ordering::Greater
        );
        assert!(
            18446744073709551614usize.cmp(&(18446744073709551615usize))
                == core::cmp::Ordering::Less
        );
        assert!(
            18446744073709551614usize.cmp(&(18446744073709551614usize))
                == core::cmp::Ordering::Equal
        );
        assert!(
            11985131576077835587usize.cmp(&(3958291493197703931usize))
                == core::cmp::Ordering::Greater
        );
        assert!(
            11354775757869541389usize.cmp(&(4159345084370363883usize))
                == core::cmp::Ordering::Greater
        );
        assert!(
            15387150155922922713usize.cmp(&(11679247064800497855usize))
                == core::cmp::Ordering::Greater
        );
        assert!(
            4589999633741811223usize.cmp(&(11774579480904419386usize)) == core::cmp::Ordering::Less
        );
        assert!(
            16028514710437862525usize.cmp(&(3655407390760220609usize))
                == core::cmp::Ordering::Greater
        );
    }
    eprint!("... ");
...
pub fn core_cmp_partial_ord_usize_lt() {
    eprintln!(
        r#"Testing "Properties for [`core::cmp::PartialOrd::<usize>::lt`]"... (1 contracts)"#
    );
    eprint!("  ");
    // ## Semantics of comparaison
    // __Inputs:__ `x : usize, y : usize`
...
pub fn core_cmp_partial_ord_usize_gt() {
    eprintln!(
        r#"Testing "Properties for [`core::cmp::PartialOrd::<usize>::gt`]"... (1 contracts)"#
    );
    eprint!("  ");
    // ## Semantics of comparaison
    // __Inputs:__ `x : usize, y : usize`
...
pub fn core_cmp_partial_ord_usize_ge() {
    eprintln!(
        r#"Testing "Properties for [`core::cmp::PartialOrd::<usize>::ge`]"... (1 contracts)"#
    );
    eprint!("  ");
    // ## Semantics of comparaison
    // __Inputs:__ `x : usize, y : usize`
...
pub fn core_cmp_partial_ord_usize_le() {
    eprintln!(
        r#"Testing "Properties for [`core::cmp::PartialOrd::<usize>::le`]"... (1 contracts)"#
    );
    eprint!("  ");
    // ## Semantics of comparaison
    // __Inputs:__ `x : usize, y : usize`
...
pub fn core_ops_bit_xor_usize_xor() {
    eprintln!(
        r#"Testing "Properties for [`core::ops::BitXor::<usize>::bitxor`]"... (1 contracts)"#
    );
    eprint!("  ");
    // ## Semantics of bitwise or
    // __Inputs:__ `x : usize, y : usize`
...
pub fn core_ops_bit_and_usize_and() {
    eprintln!(
        r#"Testing "Properties for [`core::ops::BitAnd::<usize>::bitand`]"... (1 contracts)"#
    );
    eprint!("  ");
    // ## Semantics of bitwise and
    // __Inputs:__ `x : usize, y : usize`
...
pub fn core_ops_bit_and_usize_or() {
    eprintln!(r#"Testing "Properties for [`core::ops::BitAnd::<usize>::bitor`]"... (1 contracts)"#);
    eprint!("  ");
    // ## Semantics of bitwise or
    // __Inputs:__ `x : usize, y : usize`
    // __Precondition:__ `true`
...
pub fn core_cmp_partial_ord_i8_cmp() {
    eprintln!(r#"Testing "Properties for [`core::cmp::PartialOrd::<i8>::cmp`]"... (1 contracts)"#);
    eprint!("  ");
    // ## Semantics of comparaison
    // __Inputs:__ `x : i8, y : i8`
    // __Precondition:__ `true`
...
pub fn core_cmp_partial_ord_i8_lt() {
    eprintln!(r#"Testing "Properties for [`core::cmp::PartialOrd::<i8>::lt`]"... (1 contracts)"#);
    eprint!("  ");
    // ## Semantics of comparaison
    // __Inputs:__ `x : i8, y : i8`
    // __Precondition:__ `true`
...
pub fn core_cmp_partial_ord_i8_gt() {
    eprintln!(r#"Testing "Properties for [`core::cmp::PartialOrd::<i8>::gt`]"... (1 contracts)"#);
    eprint!("  ");
    // ## Semantics of comparaison
    // __Inputs:__ `x : i8, y : i8`
    // __Precondition:__ `true`
...
pub fn core_cmp_partial_ord_i8_ge() {
    eprintln!(r#"Testing "Properties for [`core::cmp::PartialOrd::<i8>::ge`]"... (1 contracts)"#);
    eprint!("  ");
    // ## Semantics of comparaison
    // __Inputs:__ `x : i8, y : i8`
    // __Precondition:__ `true`
...
pub fn core_cmp_partial_ord_i8_le() {
    eprintln!(r#"Testing "Properties for [`core::cmp::PartialOrd::<i8>::le`]"... (1 contracts)"#);
    eprint!("  ");
    // ## Semantics of comparaison
    // __Inputs:__ `x : i8, y : i8`
    // __Precondition:__ `true`
...
pub fn core_ops_bit_xor_i8_xor() {
    eprintln!(r#"Testing "Properties for [`core::ops::BitXor::<i8>::bitxor`]"... (1 contracts)"#);
    eprint!("  ");
    // ## Semantics of bitwise or
    // __Inputs:__ `x : i8, y : i8`
    // __Precondition:__ `true`
...
pub fn core_ops_bit_and_i8_and() {
    eprintln!(r#"Testing "Properties for [`core::ops::BitAnd::<i8>::bitand`]"... (1 contracts)"#);
    eprint!("  ");
    // ## Semantics of bitwise and
    // __Inputs:__ `x : i8, y : i8`
    // __Precondition:__ `true`
...
pub fn core_ops_bit_and_i8_or() {
    eprintln!(r#"Testing "Properties for [`core::ops::BitAnd::<i8>::bitor`]"... (1 contracts)"#);
    eprint!("  ");
    // ## Semantics of bitwise or
    // __Inputs:__ `x : i8, y : i8`
    // __Precondition:__ `true`
...
pub fn core_cmp_partial_ord_i16_cmp() {
    eprintln!(r#"Testing "Properties for [`core::cmp::PartialOrd::<i16>::cmp`]"... (1 contracts)"#);
    eprint!("  ");
    // ## Semantics of comparaison
    // __Inputs:__ `x : i16, y : i16`
    // __Precondition:__ `true`
...
pub fn core_cmp_partial_ord_i16_lt() {
    eprintln!(r#"Testing "Properties for [`core::cmp::PartialOrd::<i16>::lt`]"... (1 contracts)"#);
    eprint!("  ");
    // ## Semantics of comparaison
    // __Inputs:__ `x : i16, y : i16`
    // __Precondition:__ `true`
...
pub fn core_cmp_partial_ord_i16_gt() {
    eprintln!(r#"Testing "Properties for [`core::cmp::PartialOrd::<i16>::gt`]"... (1 contracts)"#);
    eprint!("  ");
    // ## Semantics of comparaison
    // __Inputs:__ `x : i16, y : i16`
    // __Precondition:__ `true`
...
pub fn core_cmp_partial_ord_i16_ge() {
    eprintln!(r#"Testing "Properties for [`core::cmp::PartialOrd::<i16>::ge`]"... (1 contracts)"#);
    eprint!("  ");
    // ## Semantics of comparaison
    // __Inputs:__ `x : i16, y : i16`
    // __Precondition:__ `true`
...
pub fn core_cmp_partial_ord_i16_le() {
    eprintln!(r#"Testing "Properties for [`core::cmp::PartialOrd::<i16>::le`]"... (1 contracts)"#);
    eprint!("  ");
    // ## Semantics of comparaison
    // __Inputs:__ `x : i16, y : i16`
    // __Precondition:__ `true`
...
pub fn core_ops_bit_xor_i16_xor() {
    eprintln!(r#"Testing "Properties for [`core::ops::BitXor::<i16>::bitxor`]"... (1 contracts)"#);
    eprint!("  ");
    // ## Semantics of bitwise or
    // __Inputs:__ `x : i16, y : i16`
    // __Precondition:__ `true`
...
pub fn core_ops_bit_and_i16_and() {
    eprintln!(r#"Testing "Properties for [`core::ops::BitAnd::<i16>::bitand`]"... (1 contracts)"#);
    eprint!("  ");
    // ## Semantics of bitwise and
    // __Inputs:__ `x : i16, y : i16`
    // __Precondition:__ `true`
...
pub fn core_ops_bit_and_i16_or() {
    eprintln!(r#"Testing "Properties for [`core::ops::BitAnd::<i16>::bitor`]"... (1 contracts)"#);
    eprint!("  ");
    // ## Semantics of bitwise or
    // __Inputs:__ `x : i16, y : i16`
    // __Precondition:__ `true`
...
pub fn core_cmp_partial_ord_i32_cmp() {
    eprintln!(r#"Testing "Properties for [`core::cmp::PartialOrd::<i32>::cmp`]"... (1 contracts)"#);
    eprint!("  ");
    // ## Semantics of comparaison
    // __Inputs:__ `x : i32, y : i32`
    // __Precondition:__ `true`
...
pub fn core_cmp_partial_ord_i32_lt() {
    eprintln!(r#"Testing "Properties for [`core::cmp::PartialOrd::<i32>::lt`]"... (1 contracts)"#);
    eprint!("  ");
    // ## Semantics of comparaison
    // __Inputs:__ `x : i32, y : i32`
    // __Precondition:__ `true`
...
pub fn core_cmp_partial_ord_i32_gt() {
    eprintln!(r#"Testing "Properties for [`core::cmp::PartialOrd::<i32>::gt`]"... (1 contracts)"#);
    eprint!("  ");
    // ## Semantics of comparaison
    // __Inputs:__ `x : i32, y : i32`
    // __Precondition:__ `true`
...
pub fn core_cmp_partial_ord_i32_ge() {
    eprintln!(r#"Testing "Properties for [`core::cmp::PartialOrd::<i32>::ge`]"... (1 contracts)"#);
    eprint!("  ");
    // ## Semantics of comparaison
    // __Inputs:__ `x : i32, y : i32`
    // __Precondition:__ `true`
...
pub fn core_cmp_partial_ord_i32_le() {
    eprintln!(r#"Testing "Properties for [`core::cmp::PartialOrd::<i32>::le`]"... (1 contracts)"#);
    eprint!("  ");
    // ## Semantics of comparaison
    // __Inputs:__ `x : i32, y : i32`
    // __Precondition:__ `true`
...
pub fn core_ops_bit_xor_i32_xor() {
    eprintln!(r#"Testing "Properties for [`core::ops::BitXor::<i32>::bitxor`]"... (1 contracts)"#);
    eprint!("  ");
    // ## Semantics of bitwise or
    // __Inputs:__ `x : i32, y : i32`
    // __Precondition:__ `true`
...
pub fn core_ops_bit_and_i32_and() {
    eprintln!(r#"Testing "Properties for [`core::ops::BitAnd::<i32>::bitand`]"... (1 contracts)"#);
    eprint!("  ");
    // ## Semantics of bitwise and
    // __Inputs:__ `x : i32, y : i32`
    // __Precondition:__ `true`
...
pub fn core_ops_bit_and_i32_or() {
    eprintln!(r#"Testing "Properties for [`core::ops::BitAnd::<i32>::bitor`]"... (1 contracts)"#);
    eprint!("  ");
    // ## Semantics of bitwise or
    // __Inputs:__ `x : i32, y : i32`
    // __Precondition:__ `true`
...
pub fn core_cmp_partial_ord_i64_cmp() {
    eprintln!(r#"Testing "Properties for [`core::cmp::PartialOrd::<i64>::cmp`]"... (1 contracts)"#);
    eprint!("  ");
    // ## Semantics of comparaison
    // __Inputs:__ `x : i64, y : i64`
    // __Precondition:__ `true`
    // __Postcondition:__ `x.cmp(&(y)) == x.up().cmp(&(y).up())`
    {
        ...
        assert!(
            9223372036854775807i64.cmp(&(9223372036854775807i64)) == core::cmp::Ordering::Equal
        );
        assert!(9223372036854775806i64.cmp(&(1i64)) == core::cmp::Ordering::Greater);
        assert!(0i64.cmp(&(1i64)) == core::cmp::Ordering::Less);
        assert!(
            (-2486683957138256793i64).cmp(&(8277996399471209820i64)) == core::cmp::Ordering::Less
        );
        assert!(
            (-99199504774803798i64).cmp(&(-1617081914795357605i64)) == core::cmp::Ordering::Greater
        );
        assert!(
            9085828950505881796i64.cmp(&(-8326902558348264350i64)) == core::cmp::Ordering::Greater
        );
        assert!(
            (-6705476182731419152i64).cmp(&(3094347331573725334i64)) == core::cmp::Ordering::Less
        );
    }
    eprint!("... ");
    eprintln!("✓\n");
...
pub fn core_cmp_partial_ord_i64_lt() {
    eprintln!(r#"Testing "Properties for [`core::cmp::PartialOrd::<i64>::lt`]"... (1 contracts)"#);
    eprint!("  ");
    // ## Semantics of comparaison
    // __Inputs:__ `x : i64, y : i64`
    // __Precondition:__ `true`
...
pub fn core_cmp_partial_ord_i64_gt() {
    eprintln!(r#"Testing "Properties for [`core::cmp::PartialOrd::<i64>::gt`]"... (1 contracts)"#);
    eprint!("  ");
    // ## Semantics of comparaison
    // __Inputs:__ `x : i64, y : i64`
    // __Precondition:__ `true`
...
pub fn core_cmp_partial_ord_i64_ge() {
    eprintln!(r#"Testing "Properties for [`core::cmp::PartialOrd::<i64>::ge`]"... (1 contracts)"#);
    eprint!("  ");
    // ## Semantics of comparaison
    // __Inputs:__ `x : i64, y : i64`
    // __Precondition:__ `true`
...
pub fn core_cmp_partial_ord_i64_le() {
    eprintln!(r#"Testing "Properties for [`core::cmp::PartialOrd::<i64>::le`]"... (1 contracts)"#);
    eprint!("  ");
    // ## Semantics of comparaison
    // __Inputs:__ `x : i64, y : i64`
    // __Precondition:__ `true`
...
pub fn core_ops_bit_xor_i64_xor() {
    eprintln!(r#"Testing "Properties for [`core::ops::BitXor::<i64>::bitxor`]"... (1 contracts)"#);
    eprint!("  ");
    // ## Semantics of bitwise or
    // __Inputs:__ `x : i64, y : i64`
    // __Precondition:__ `true`
...
pub fn core_ops_bit_and_i64_and() {
    eprintln!(r#"Testing "Properties for [`core::ops::BitAnd::<i64>::bitand`]"... (1 contracts)"#);
    eprint!("  ");
    // ## Semantics of bitwise and
    // __Inputs:__ `x : i64, y : i64`
    // __Precondition:__ `true`
...
pub fn core_ops_bit_and_i64_or() {
    eprintln!(r#"Testing "Properties for [`core::ops::BitAnd::<i64>::bitor`]"... (1 contracts)"#);
    eprint!("  ");
    // ## Semantics of bitwise or
    // __Inputs:__ `x : i64, y : i64`
    // __Precondition:__ `true`
...
pub fn core_cmp_partial_ord_i128_cmp() {
    eprintln!(
        r#"Testing "Properties for [`core::cmp::PartialOrd::<i128>::cmp`]"... (1 contracts)"#
    );
    eprint!("  ");
    // ## Semantics of comparaison
    // __Inputs:__ `x : i128, y : i128`
    ...
    {
        assert!(
            170141183460469231731687303715884105727i128.cmp(&(0i128))
                == core::cmp::Ordering::Greater
        );
        ...
        assert!(
            1i128.cmp(&(170141183460469231731687303715884105727i128)) == core::cmp::Ordering::Less
        );
        assert!(
            170141183460469231731687303715884105726i128.cmp(&(0i128))
                == core::cmp::Ordering::Greater
        );
        assert!(
            1i128.cmp(&(-170141183460469231731687303715884105727i128))
                == core::cmp::Ordering::Greater
        );
        assert!(
            (-154005287672288482704441483385659686472i128)
                .cmp(&(105818934551093860653441722273120519267i128))
                == core::cmp::Ordering::Less
        );
        assert!(
            (-128367413642486903913878523278718529067i128)
                .cmp(&(-64386684455420354136778675416075506643i128))
                == core::cmp::Ordering::Less
        );
        assert!(
            126908221513700786904155049784630929235i128
                .cmp(&(-9807736245756341038743965012486688995i128))
                == core::cmp::Ordering::Greater
        );
        assert!(
            (-10145858363607021331634454013201364899i128)
...
pub fn core_cmp_partial_ord_i128_lt() {
    eprintln!(r#"Testing "Properties for [`core::cmp::PartialOrd::<i128>::lt`]"... (1 contracts)"#);
    eprint!("  ");
    // ## Semantics of comparaison
    // __Inputs:__ `x : i128, y : i128`
    // __Precondition:__ `true`
    // __Postcondition:__ `x.lt(&(y)) == x.up().lt(&(y).up())`
    {
        ...
        assert!(
            (-170141183460469231731687303715884105727i128)
                .lt(&(170141183460469231731687303715884105726i128))
                == true
        );
        assert!(
            170141183460469231731687303715884105726i128
                .lt(&(-170141183460469231731687303715884105727i128))
                == false
        );
        assert!(
            43494519805289624778098993664600114576i128
                .lt(&(37154080335617078403397938962298082139i128))
                == false
        );
        assert!(
            (-153522660583401227602419573355031608777i128)
                .lt(&(26315143328660934995840236404587824943i128))
                == true
        );
        assert!(
            (-85446390431431338173136522106685719943i128)
                .lt(&(-43594033324359124220961588176967323834i128))
                == true
        );
        assert!(
            45465377380471421298298405612041857363i128
                .lt(&(-152973691226334666963048011591363144284i128))
                == false
        );
    }
    eprint!("... ");
...
pub fn core_cmp_partial_ord_i128_gt() {
    eprintln!(r#"Testing "Properties for [`core::cmp::PartialOrd::<i128>::gt`]"... (1 contracts)"#);
    eprint!("  ");
    // ## Semantics of comparaison
    // __Inputs:__ `x : i128, y : i128`
    // __Precondition:__ `true`
    // __Postcondition:__ `x.gt(&(y)) == x.up().gt(&(y).up())`
    {
        assert!(
            (-170141183460469231731687303715884105727i128)
                .gt(&(170141183460469231731687303715884105727i128))
                == false
        );
        ...
        assert!(
            (-168224518223778796411925806744106157139i128)
                .gt(&(90488014374171457124259142180165163249i128))
                == false
        );
        assert!(
            (-144204527530455254532306780851552032585i128)
                .gt(&(4677638839937728979555865463169347192i128))
                == false
        );
        assert!(
            (-126682904067865959319599376777694877503i128)
                .gt(&(73563520646578614602393507597805407307i128))
                == false
        );
        assert!(
            (-64436417572853670665172049096587459243i128)
                .gt(&(130260691661457861683895436324592121286i128))
                == false
        );
    }
    eprint!("... ");
...
pub fn core_cmp_partial_ord_i128_ge() {
    eprintln!(r#"Testing "Properties for [`core::cmp::PartialOrd::<i128>::ge`]"... (1 contracts)"#);
    eprint!("  ");
    // ## Semantics of comparaison
    // __Inputs:__ `x : i128, y : i128`
    // __Precondition:__ `true`
    // __Postcondition:__ `x.ge(&(y)) == x.up().ge(&(y).up())`
    {
        assert!(
            (-170141183460469231731687303715884105728i128)
                .ge(&(-170141183460469231731687303715884105727i128))
                == false
        );
        ...
        assert!(
            65225598775347068974441282010745471809i128
                .ge(&(-88598611435040776141686556543587509113i128))
                == true
        );
        assert!(
            (-17255447653047990277350209539298500020i128)
                .ge(&(-124625914073732369224663105049758509891i128))
                == true
        );
        assert!(
            36960009758739173754427666931105017954i128
                .ge(&(-116535350064549903866387028381304492526i128))
                == true
        );
        assert!(
            158399894553718110212841247075823117625i128
                .ge(&(36766367793339548227741183508187394298i128))
                == true
        );
    }
    eprint!("... ");
...
pub fn core_cmp_partial_ord_i128_le() {
    eprintln!(r#"Testing "Properties for [`core::cmp::PartialOrd::<i128>::le`]"... (1 contracts)"#);
    eprint!("  ");
    // ## Semantics of comparaison
    // __Inputs:__ `x : i128, y : i128`
    // __Precondition:__ `true`
    // __Postcondition:__ `x.le(&(y)) == x.up().le(&(y).up())`
    {
        ...
        assert!(
            (-170141183460469231731687303715884105728i128)
                .le(&(-170141183460469231731687303715884105727i128))
                == true
        );
        assert!(
            (-170141183460469231731687303715884105727i128)
        ...
        assert!(
            (-105983859324968750808104540289791978991i128)
                .le(&(-108206891368088591186818757067992248961i128))
                == false
        );
        assert!(
            29151295634163322121778123342254222493i128
                .le(&(-97452641186557571953861981070014384647i128))
                == false
        );
        assert!(
            (-83803146929455115818183204681317724575i128)
                .le(&(96547409580339960230828256369078193884i128))
                == true
        );
        assert!(
            (-148899579028549076558552846115914259341i128)
                .le(&(-110533491587967559700123238870981889461i128))
                == true
        );
    }
    eprint!("... ");
...
pub fn core_ops_bit_xor_i128_xor() {
    eprintln!(r#"Testing "Properties for [`core::ops::BitXor::<i128>::bitxor`]"... (1 contracts)"#);
    eprint!("  ");
    // ## Semantics of bitwise or
    // __Inputs:__ `x : i128, y : i128`
    // __Precondition:__ `true`
    // __Postcondition:__ `x ^ y == i128::down(x.up() ^ y.up())`
    {
        ...
        assert!(
            77296362785470245240239181943133653598i128 ^ 90260007152270549564515108336526189875i128
                == 161842859019710712841746717051533602669i128
        );
        assert!(
            (-147389228238145991813936313686024521410i128)
                ^ (-90215486678290606517857329198194672648i128)
                == 60131927158012058215459321311372952262i128
        );
        assert!(
            (-126854812254339674004734468123976960430i128)
                ^ 112755464497414256173281726983229082166i128
                == (-15601244421691506544746098691698951068i128)
        );
        assert!(
            (-28229598495790211054142589152522933926i128)
...
pub fn core_ops_bit_and_i128_and() {
    eprintln!(r#"Testing "Properties for [`core::ops::BitAnd::<i128>::bitand`]"... (1 contracts)"#);
    eprint!("  ");
    // ## Semantics of bitwise and
    // __Inputs:__ `x : i128, y : i128`
    // __Precondition:__ `true`
...
pub fn core_ops_bit_and_i128_or() {
    eprintln!(r#"Testing "Properties for [`core::ops::BitAnd::<i128>::bitor`]"... (1 contracts)"#);
    eprint!("  ");
    // ## Semantics of bitwise or
    // __Inputs:__ `x : i128, y : i128`
    // __Precondition:__ `true`
...
pub fn core_cmp_partial_ord_isize_cmp() {
    eprintln!(
        r#"Testing "Properties for [`core::cmp::PartialOrd::<isize>::cmp`]"... (1 contracts)"#
    );
    eprint!("  ");
    // ## Semantics of comparaison
    // __Inputs:__ `x : isize, y : isize`
    ...
    // __Postcondition:__ `x.cmp(&(y)) == x.up().cmp(&(y).up())`
    {
        ...
        assert!(
            9223372036854775806isize.cmp(&(9223372036854775806isize)) == core::cmp::Ordering::Equal
        );
        ...
        assert!(
            (-9223372036854775808isize).cmp(&(9223372036854775806isize))
                == core::cmp::Ordering::Less
        );
        assert!((-1isize).cmp(&(-9223372036854775807isize)) == core::cmp::Ordering::Greater);
        assert!(
            (-5841171655339116679isize).cmp(&(-169589993757841491isize))
                == core::cmp::Ordering::Less
        );
        assert!(
            (-8024312756574099332isize).cmp(&(-5737577747031126721isize))
                == core::cmp::Ordering::Less
        );
        assert!(
            (-1013218334373152959isize).cmp(&(-6479110904713568964isize))
                == core::cmp::Ordering::Greater
        );
        assert!(
            (-9022977326710961713isize).cmp(&(-2963655115610600578isize))
                == core::cmp::Ordering::Less
        );
    }
    eprint!("... ");
...
pub fn core_cmp_partial_ord_isize_lt() {
    eprintln!(
        r#"Testing "Properties for [`core::cmp::PartialOrd::<isize>::lt`]"... (1 contracts)"#
    );
    eprint!("  ");
    // ## Semantics of comparaison
    // __Inputs:__ `x : isize, y : isize`
...
pub fn core_cmp_partial_ord_isize_gt() {
    eprintln!(
        r#"Testing "Properties for [`core::cmp::PartialOrd::<isize>::gt`]"... (1 contracts)"#
    );
    eprint!("  ");
    // ## Semantics of comparaison
    // __Inputs:__ `x : isize, y : isize`
...
pub fn core_cmp_partial_ord_isize_ge() {
    eprintln!(
        r#"Testing "Properties for [`core::cmp::PartialOrd::<isize>::ge`]"... (1 contracts)"#
    );
    eprint!("  ");
    // ## Semantics of comparaison
    // __Inputs:__ `x : isize, y : isize`
...
pub fn core_cmp_partial_ord_isize_le() {
    eprintln!(
        r#"Testing "Properties for [`core::cmp::PartialOrd::<isize>::le`]"... (1 contracts)"#
    );
    eprint!("  ");
    // ## Semantics of comparaison
    // __Inputs:__ `x : isize, y : isize`
...
pub fn core_ops_bit_xor_isize_xor() {
    eprintln!(
        r#"Testing "Properties for [`core::ops::BitXor::<isize>::bitxor`]"... (1 contracts)"#
    );
    eprint!("  ");
    // ## Semantics of bitwise or
    // __Inputs:__ `x : isize, y : isize`
    ...
    // __Postcondition:__ `x ^ y == isize::down(x.up() ^ y.up())`
    {
        ...
        assert!(
            (-1250290473846053667isize) ^ (-5531171348753902369isize) == 6745063510149787650isize
        );
        assert!(2404659271098898348isize ^ 7313406798223135084isize == 4909311042728183488isize);
        assert!(
            5859673763593276063isize ^ (-4466438813660454551isize) == (-7830146021812917258isize)
        );
...
pub fn core_ops_bit_and_isize_and() {
    eprintln!(
        r#"Testing "Properties for [`core::ops::BitAnd::<isize>::bitand`]"... (1 contracts)"#
    );
    eprint!("  ");
    // ## Semantics of bitwise and
    // __Inputs:__ `x : isize, y : isize`
    ...
    // __Postcondition:__ `x & y == isize::down(x.up() & y.up())`
    {
        ...
        assert!(
            (-3666504517851182454isize) & (-1778719870413368240isize)
                == (-4246694813697245184isize)
        );
        assert!(
            (-8363742715638563772isize) & (-4080858321313711476isize)
                == (-8985806812359804924isize)
        );
        assert!(
            (-5765075418812885518isize) & (-452413953302846885isize) == (-6217199081986457518isize)
        );
    }
    eprint!("... ");
    eprintln!("✓\n");
...
pub fn core_ops_bit_and_isize_or() {
    eprintln!(r#"Testing "Properties for [`core::ops::BitAnd::<isize>::bitor`]"... (1 contracts)"#);
    eprint!("  ");
    // ## Semantics of bitwise or
    // __Inputs:__ `x : isize, y : isize`
    // __Precondition:__ `true`
    // __Postcondition:__ `x ^ y == isize::down(x.up() | y.up())`
    {
        ...
        assert!(
            (-4185871319422495601isize) ^ 926904095775268741isize == (-3603497079892369521isize)
        );
        assert!(4756165041642936274isize ^ 1131869617483972774isize == 5743637568456660982isize);
        assert!(
            (-1799399568822941922isize) ^ 8413847971207197461isize == (-592223734325872865isize)
        );
    }
    eprint!("... ");
    eprintln!("✓\n");
...
"
    ...
    slice_get();
    core_ops_rem_u8_rem();
    core_ops_rem_u8_checked_rem();
    t_u8_checked_neg();
    core_ops_shl_u8_shl();
    core_ops_shl_u8_checked_shl();
    core_ops_shl_u8_overflowing_shl();
    core_ops_shr_u8_shr();
    core_ops_shr_u8_checked_shr();
    core_ops_shr_u8_overflowing_shr();
    core_ops_div_u8_div();
    core_ops_div_u8_saturating_div();
    core_ops_div_u8_checked_div();
    core_ops_mul_u8_mul();
    core_ops_mul_u8_checked_mul();
    core_ops_mul_u8_overflowing_mul();
    core_ops_mul_u8_saturating_mul();
    core_ops_mul_u8_wrapped_mul();
    core_ops_add_u8_sub();
    core_ops_add_u8_wrapping_sub();
    core_ops_add_u8_checked_sub();
    core_ops_sub_u8_saturating_sub();
    core_ops_add_u8_add();
    core_ops_add_u8_wrapping_add();
    core_ops_add_u8_checked_add();
    core_ops_add_u8_saturating_add();
    core_ops_rem_u16_rem();
    core_ops_rem_u16_checked_rem();
    t_u16_checked_neg();
    core_ops_shl_u16_shl();
    core_ops_shl_u16_checked_shl();
    core_ops_shl_u16_overflowing_shl();
    core_ops_shr_u16_shr();
    core_ops_shr_u16_checked_shr();
    core_ops_shr_u16_overflowing_shr();
    core_ops_div_u16_div();
    core_ops_div_u16_saturating_div();
    core_ops_div_u16_checked_div();
    core_ops_mul_u16_mul();
    core_ops_mul_u16_checked_mul();
    core_ops_mul_u16_overflowing_mul();
    core_ops_mul_u16_saturating_mul();
    core_ops_mul_u16_wrapped_mul();
    core_ops_add_u16_sub();
    core_ops_add_u16_wrapping_sub();
    core_ops_add_u16_checked_sub();
    core_ops_sub_u16_saturating_sub();
    core_ops_add_u16_add();
    core_ops_add_u16_wrapping_add();
    core_ops_add_u16_checked_add();
    core_ops_add_u16_saturating_add();
    core_ops_rem_u32_rem();
    core_ops_rem_u32_checked_rem();
    t_u32_checked_neg();
    core_ops_shl_u32_shl();
    core_ops_shl_u32_checked_shl();
    core_ops_shl_u32_overflowing_shl();
    core_ops_shr_u32_shr();
    core_ops_shr_u32_checked_shr();
    core_ops_shr_u32_overflowing_shr();
    core_ops_div_u32_div();
    core_ops_div_u32_saturating_div();
    core_ops_div_u32_checked_div();
    core_ops_mul_u32_mul();
    core_ops_mul_u32_checked_mul();
    core_ops_mul_u32_overflowing_mul();
    core_ops_mul_u32_saturating_mul();
    core_ops_mul_u32_wrapped_mul();
    core_ops_add_u32_sub();
    core_ops_add_u32_wrapping_sub();
    core_ops_add_u32_checked_sub();
    core_ops_sub_u32_saturating_sub();
    core_ops_add_u32_add();
    core_ops_add_u32_wrapping_add();
    core_ops_add_u32_checked_add();
    core_ops_add_u32_saturating_add();
    core_ops_rem_u64_rem();
    core_ops_rem_u64_checked_rem();
    t_u64_checked_neg();
    core_ops_shl_u64_shl();
    core_ops_shl_u64_checked_shl();
    core_ops_shl_u64_overflowing_shl();
    core_ops_shr_u64_shr();
    core_ops_shr_u64_checked_shr();
    core_ops_shr_u64_overflowing_shr();
    core_ops_div_u64_div();
    core_ops_div_u64_saturating_div();
    core_ops_div_u64_checked_div();
    core_ops_mul_u64_mul();
    core_ops_mul_u64_checked_mul();
    core_ops_mul_u64_overflowing_mul();
    core_ops_mul_u64_saturating_mul();
    core_ops_mul_u64_wrapped_mul();
    core_ops_add_u64_sub();
    core_ops_add_u64_wrapping_sub();
    core_ops_add_u64_checked_sub();
    core_ops_sub_u64_saturating_sub();
    core_ops_add_u64_add();
    core_ops_add_u64_wrapping_add();
    core_ops_add_u64_checked_add();
    core_ops_add_u64_saturating_add();
    core_ops_rem_u128_rem();
    core_ops_rem_u128_checked_rem();
    t_u128_checked_neg();
    core_ops_shl_u128_shl();
    core_ops_shl_u128_checked_shl();
    core_ops_shl_u128_overflowing_shl();
    core_ops_shr_u128_shr();
    core_ops_shr_u128_checked_shr();
    core_ops_shr_u128_overflowing_shr();
    core_ops_div_u128_div();
    core_ops_div_u128_saturating_div();
    core_ops_div_u128_checked_div();
    core_ops_mul_u128_mul();
    core_ops_mul_u128_checked_mul();
    core_ops_mul_u128_overflowing_mul();
    core_ops_mul_u128_saturating_mul();
    core_ops_mul_u128_wrapped_mul();
    core_ops_add_u128_sub();
    core_ops_add_u128_wrapping_sub();
    core_ops_add_u128_checked_sub();
    core_ops_sub_u128_saturating_sub();
    core_ops_add_u128_add();
    core_ops_add_u128_wrapping_add();
    core_ops_add_u128_checked_add();
    core_ops_add_u128_saturating_add();
    core_ops_rem_usize_rem();
    core_ops_rem_usize_checked_rem();
    t_usize_checked_neg();
    core_ops_shl_usize_shl();
    core_ops_shl_usize_checked_shl();
    core_ops_shl_usize_overflowing_shl();
    core_ops_shr_usize_shr();
    core_ops_shr_usize_checked_shr();
    core_ops_shr_usize_overflowing_shr();
    core_ops_div_usize_div();
    core_ops_div_usize_saturating_div();
    core_ops_div_usize_checked_div();
    core_ops_mul_usize_mul();
    core_ops_mul_usize_checked_mul();
    core_ops_mul_usize_overflowing_mul();
    core_ops_mul_usize_saturating_mul();
    core_ops_mul_usize_wrapped_mul();
    core_ops_add_usize_sub();
    core_ops_add_usize_wrapping_sub();
    core_ops_add_usize_checked_sub();
    core_ops_sub_usize_saturating_sub();
    core_ops_add_usize_add();
    core_ops_add_usize_wrapping_add();
    core_ops_add_usize_checked_add();
    core_ops_add_usize_saturating_add();
    t_i8_checked_neg();
    t_i8_neg();
    t_i8_overflowing_neg();
    core_ops_sub_i8_sub();
    core_ops_sub_i8_checked_sub();
    core_ops_sub_i8_wrapping_sub();
    core_ops_sub_i8_overflowing_sub();
    core_ops_add_i8_add();
    t_i16_checked_neg();
    t_i16_neg();
    t_i16_overflowing_neg();
    core_ops_sub_i16_sub();
    core_ops_sub_i16_checked_sub();
    core_ops_sub_i16_wrapping_sub();
    core_ops_sub_i16_overflowing_sub();
    core_ops_add_i16_add();
    t_i32_checked_neg();
    t_i32_neg();
    t_i32_overflowing_neg();
    core_ops_sub_i32_sub();
    core_ops_sub_i32_checked_sub();
    core_ops_sub_i32_wrapping_sub();
    core_ops_sub_i32_overflowing_sub();
    core_ops_add_i32_add();
    t_i64_checked_neg();
    t_i64_neg();
    t_i64_overflowing_neg();
    core_ops_sub_i64_sub();
    core_ops_sub_i64_checked_sub();
    core_ops_sub_i64_wrapping_sub();
    core_ops_sub_i64_overflowing_sub();
    core_ops_add_i64_add();
    t_i128_checked_neg();
    t_i128_neg();
    t_i128_overflowing_neg();
    core_ops_sub_i128_sub();
    core_ops_sub_i128_checked_sub();
    core_ops_sub_i128_wrapping_sub();
    core_ops_sub_i128_overflowing_sub();
    core_ops_add_i128_add();
    t_isize_checked_neg();
    t_isize_neg();
    t_isize_overflowing_neg();
    core_ops_sub_isize_sub();
    core_ops_sub_isize_checked_sub();
    core_ops_sub_isize_wrapping_sub();
    core_ops_sub_isize_overflowing_sub();
    core_ops_add_isize_add();
    core_cmp_partial_ord_u8_cmp();
    core_cmp_partial_ord_u8_lt();
    core_cmp_partial_ord_u8_gt();
    core_cmp_partial_ord_u8_ge();
    core_cmp_partial_ord_u8_le();
    core_ops_bit_xor_u8_xor();
    core_ops_bit_and_u8_and();
    core_ops_bit_and_u8_or();
    core_cmp_partial_ord_u16_cmp();
    core_cmp_partial_ord_u16_lt();
    core_cmp_partial_ord_u16_gt();
    core_cmp_partial_ord_u16_ge();
    core_cmp_partial_ord_u16_le();
    core_ops_bit_xor_u16_xor();
    core_ops_bit_and_u16_and();
    core_ops_bit_and_u16_or();
    core_cmp_partial_ord_u32_cmp();
    core_cmp_partial_ord_u32_lt();
    core_cmp_partial_ord_u32_gt();
    core_cmp_partial_ord_u32_ge();
    core_cmp_partial_ord_u32_le();
    core_ops_bit_xor_u32_xor();
    core_ops_bit_and_u32_and();
    core_ops_bit_and_u32_or();
    core_cmp_partial_ord_u64_cmp();
    core_cmp_partial_ord_u64_lt();
    core_cmp_partial_ord_u64_gt();
    core_cmp_partial_ord_u64_ge();
    core_cmp_partial_ord_u64_le();
    core_ops_bit_xor_u64_xor();
    core_ops_bit_and_u64_and();
    core_ops_bit_and_u64_or();
    core_cmp_partial_ord_u128_cmp();
    core_cmp_partial_ord_u128_lt();
    core_cmp_partial_ord_u128_gt();
    core_cmp_partial_ord_u128_ge();
    core_cmp_partial_ord_u128_le();
    core_ops_bit_xor_u128_xor();
    core_ops_bit_and_u128_and();
    core_ops_bit_and_u128_or();
    core_cmp_partial_ord_usize_cmp();
    core_cmp_partial_ord_usize_lt();
    core_cmp_partial_ord_usize_gt();
    core_cmp_partial_ord_usize_ge();
    core_cmp_partial_ord_usize_le();
    core_ops_bit_xor_usize_xor();
    core_ops_bit_and_usize_and();
    core_ops_bit_and_usize_or();
    core_cmp_partial_ord_i8_cmp();
    core_cmp_partial_ord_i8_lt();
    core_cmp_partial_ord_i8_gt();
    core_cmp_partial_ord_i8_ge();
    core_cmp_partial_ord_i8_le();
    core_ops_bit_xor_i8_xor();
    core_ops_bit_and_i8_and();
    core_ops_bit_and_i8_or();
    core_cmp_partial_ord_i16_cmp();
    core_cmp_partial_ord_i16_lt();
    core_cmp_partial_ord_i16_gt();
    core_cmp_partial_ord_i16_ge();
    core_cmp_partial_ord_i16_le();
    core_ops_bit_xor_i16_xor();
    core_ops_bit_and_i16_and();
    core_ops_bit_and_i16_or();
    core_cmp_partial_ord_i32_cmp();
    core_cmp_partial_ord_i32_lt();
    core_cmp_partial_ord_i32_gt();
    core_cmp_partial_ord_i32_ge();
    core_cmp_partial_ord_i32_le();
    core_ops_bit_xor_i32_xor();
    core_ops_bit_and_i32_and();
    core_ops_bit_and_i32_or();
    core_cmp_partial_ord_i64_cmp();
    core_cmp_partial_ord_i64_lt();
    core_cmp_partial_ord_i64_gt();
    core_cmp_partial_ord_i64_ge();
    core_cmp_partial_ord_i64_le();
    core_ops_bit_xor_i64_xor();
    core_ops_bit_and_i64_and();
    core_ops_bit_and_i64_or();
    core_cmp_partial_ord_i128_cmp();
    core_cmp_partial_ord_i128_lt();
    core_cmp_partial_ord_i128_gt();
    core_cmp_partial_ord_i128_ge();
    core_cmp_partial_ord_i128_le();
    core_ops_bit_xor_i128_xor();
    core_ops_bit_and_i128_and();
    core_ops_bit_and_i128_or();
    core_cmp_partial_ord_isize_cmp();
    core_cmp_partial_ord_isize_lt();
    core_cmp_partial_ord_isize_gt();
    core_cmp_partial_ord_isize_ge();
    core_cmp_partial_ord_isize_le();
    core_ops_bit_xor_isize_xor();
    core_ops_bit_and_isize_and();
    core_ops_bit_and_isize_or();
}
