//! This module contains 5043 tests, organized in functions.
...
pub fn option_map() {
    ...
    // __Postcondition:__ `Some(v).map(f) == Some((f)(v))`
    {
        ...
        assert!(
            Some(0u8).map((|x: u8| x.wrapping_add(1u8)))
        ...
        assert!(
            Some(1u8).map((|x: u8| x.wrapping_add(x))) == Some((|x: u8| x.wrapping_add(x))(1u8))
        );
        assert!(
            Some(1u8).map((|x: u8| x.wrapping_add(0u8)))
                == Some((|x: u8| x.wrapping_add(0u8))(1u8))
        );
        assert!(
            Some(1u8).map((|x: u8| x.wrapping_add(1u8)))
                == Some((|x: u8| x.wrapping_add(1u8))(1u8))
        );
        assert!(
            Some(1u8).map((|x: u8| x.wrapping_add(254u8)))
                == Some((|x: u8| x.wrapping_add(254u8))(1u8))
        );
        assert!(
            Some(1u8).map((|x: u8| x.wrapping_add(255u8)))
...
pub fn core_ops_div_u8_saturating_div() {
    ...
    // __Postcondition:__ `{ #[allow(unconditional_panic)] { panics!(x.saturating_div(0)) } }`
    {
        ...
        assert!({
            #[allow(unconditional_panic)]
            {
                panics!(5u8.saturating_div(0))
            }
        });
        assert!({
            #[allow(unconditional_panic)]
            {
                panics!(198u8.saturating_div(0))
            }
        });
        assert!({
            #[allow(unconditional_panic)]
            {
                panics!(225u8.saturating_div(0))
            }
        });
        assert!({
            #[allow(unconditional_panic)]
            {
                panics!(75u8.saturating_div(0))
            }
        });
        assert!({
            #[allow(unconditional_panic)]
            {
                panics!(208u8.saturating_div(0))
            }
        });
        assert!({
            #[allow(unconditional_panic)]
            {
                panics!(94u8.saturating_div(0))
            }
        });
    }
    eprint!("... ");
...
pub fn core_ops_mul_u8_mul() {
    eprintln!(r#"Testing "Properties for [`core::ops::Mul::<u8>::mul`]"... (2 contracts)"#);
    eprint!("  ");
...
pub fn core_ops_mul_u8_wrapped_mul() {
    eprintln!(r#"Testing "Properties for [`u8::wrapping_mul`]"... (2 contracts)"#);
    eprint!("  ");
...
pub fn core_ops_add_u8_sub() {
    eprintln!(r#"Testing "Properties for [`core::ops::Sub::<u8>::sub`]"... (2 contracts)"#);
    eprint!("  ");
...
pub fn core_ops_add_u8_wrapping_sub() {
    eprintln!(r#"Testing "Properties for [`u8::wrapping_sub`]"... (3 contracts)"#);
    eprint!("  ");
...
pub fn core_ops_add_u8_checked_sub() {
    eprintln!(r#"Testing "Properties for [`u8::checked_sub`]"... (2 contracts)"#);
    eprint!("  ");
...
pub fn core_ops_add_u8_add() {
    eprintln!(r#"Testing "Properties for [`core::ops::Add::<u8>::add`]"... (2 contracts)"#);
    eprint!("  ");
...
pub fn core_ops_add_u8_wrapping_add() {
    eprintln!(r#"Testing "Properties for [`u8::wrapping_add`]"... (3 contracts)"#);
    eprint!("  ");
...
pub fn core_ops_add_u8_checked_add() {
    eprintln!(r#"Testing "Properties for [`u8::checked_add`]"... (2 contracts)"#);
    eprint!("  ");
...
pub fn core_ops_div_u16_saturating_div() {
    ...
    // __Postcondition:__ `{ #[allow(unconditional_panic)] { panics!(x.saturating_div(0)) } }`
    {
        ...
        assert!({
            #[allow(unconditional_panic)]
            {
                panics!(27937u16.saturating_div(0))
            }
        });
        assert!({
            #[allow(unconditional_panic)]
            {
                panics!(22389u16.saturating_div(0))
            }
        });
        assert!({
            #[allow(unconditional_panic)]
            {
                panics!(51472u16.saturating_div(0))
            }
        });
        assert!({
            #[allow(unconditional_panic)]
            {
                panics!(52287u16.saturating_div(0))
            }
        });
        assert!({
            #[allow(unconditional_panic)]
            {
                panics!(27487u16.saturating_div(0))
            }
        });
        assert!({
            #[allow(unconditional_panic)]
            {
                panics!(59335u16.saturating_div(0))
            }
        });
    }
    eprint!("... ");
...
pub fn core_ops_mul_u16_mul() {
    eprintln!(r#"Testing "Properties for [`core::ops::Mul::<u16>::mul`]"... (2 contracts)"#);
    eprint!("  ");
    // ## Semantics of non-overflowing multiplication
    // __Inputs:__ `x : u16, y : u16`
...
pub fn core_ops_mul_u16_wrapped_mul() {
    eprintln!(r#"Testing "Properties for [`u16::wrapping_mul`]"... (2 contracts)"#);
    eprint!("  ");
    // ## Semantics of the wrapping multiplication
    // __Inputs:__ `x : u16, y : u16`
    // __Precondition:__ `true`
...
pub fn core_ops_add_u16_sub() {
    eprintln!(r#"Testing "Properties for [`core::ops::Sub::<u16>::sub`]"... (2 contracts)"#);
    eprint!("  ");
    // ## Semantics of non-underflowing subtraction
    // __Inputs:__ `x : u16, y : u16`
    // __Precondition:__ `x.up() - y.up() >= 0u8.up()`
...
pub fn core_ops_add_u16_wrapping_sub() {
    eprintln!(r#"Testing "Properties for [`u16::wrapping_sub`]"... (3 contracts)"#);
    eprint!("  ");
    // ## Semantics of non-underflowing wrapping subtraction
    // __Inputs:__ `x : u16, y : u16`
    // __Precondition:__ `x.up() - y.up() >= 0u8.up()`
...
pub fn core_ops_add_u16_checked_sub() {
    eprintln!(r#"Testing "Properties for [`u16::checked_sub`]"... (2 contracts)"#);
    eprint!("  ");
    // ## Semantics of non-underflowing checked subtraction
    // __Inputs:__ `x : u16, y : u16`
    // __Precondition:__ `x.up() - y.up() >= 0u8.up()`
...
pub fn core_ops_add_u16_add() {
    eprintln!(r#"Testing "Properties for [`core::ops::Add::<u16>::add`]"... (2 contracts)"#);
    eprint!("  ");
    // ## Semantics of non-overflowing addition
    // __Inputs:__ `x : u16, y : u16`
    // __Precondition:__ `x.up() + y.up() <= u16::MAX.up()`
...
pub fn core_ops_add_u16_wrapping_add() {
    eprintln!(r#"Testing "Properties for [`u16::wrapping_add`]"... (3 contracts)"#);
    eprint!("  ");
    // ## Semantics of the wrapping addition
    // __Inputs:__ `x : u16, y : u16`
    // __Precondition:__ `true`
...
pub fn core_ops_add_u16_checked_add() {
    eprintln!(r#"Testing "Properties for [`u16::checked_add`]"... (2 contracts)"#);
    eprint!("  ");
    // ## Semantics of non-overflowing checked addition
    // __Inputs:__ `x : u16, y : u16`
    // __Precondition:__ `x.up() + y.up() <= u16::MAX.up()`
...
pub fn core_ops_div_u32_div() {
    ...
    // __Postcondition:__ `{ #[allow(unconditional_panic)] { panics!(x / 0) } }`
    {
        ...
        assert!({
            #[allow(unconditional_panic)]
            {
                panics!(2330809583u32 / 0)
            }
        });
        assert!({
            #[allow(unconditional_panic)]
            {
                panics!(508462633u32 / 0)
            }
        });
        assert!({
            #[allow(unconditional_panic)]
            {
                panics!(602814284u32 / 0)
            }
        });
        assert!({
            #[allow(unconditional_panic)]
            {
                panics!(1946474152u32 / 0)
            }
        });
        assert!({
            #[allow(unconditional_panic)]
            {
                panics!(1311212636u32 / 0)
            }
        });
        assert!({
            #[allow(unconditional_panic)]
            {
                panics!(1359574792u32 / 0)
            }
        });
    }
    eprint!("... ");
...
pub fn core_ops_div_u32_saturating_div() {
    ...
    // __Postcondition:__ `{ #[allow(unconditional_panic)] { panics!(x.saturating_div(0)) } }`
    {
        ...
        assert!({
            #[allow(unconditional_panic)]
            {
                panics!(348789308u32.saturating_div(0))
            }
        });
        assert!({
            #[allow(unconditional_panic)]
            {
                panics!(657258334u32.saturating_div(0))
            }
        });
        assert!({
            #[allow(unconditional_panic)]
            {
                panics!(254872448u32.saturating_div(0))
            }
        });
        assert!({
            #[allow(unconditional_panic)]
            {
                panics!(442158443u32.saturating_div(0))
            }
        });
        assert!({
            #[allow(unconditional_panic)]
            {
                panics!(2512110774u32.saturating_div(0))
            }
        });
        assert!({
            #[allow(unconditional_panic)]
            {
                panics!(79635956u32.saturating_div(0))
            }
        });
    }
    eprint!("... ");
...
pub fn core_ops_mul_u32_mul() {
    eprintln!(r#"Testing "Properties for [`core::ops::Mul::<u32>::mul`]"... (2 contracts)"#);
    eprint!("  ");
    // ## Semantics of non-overflowing multiplication
    // __Inputs:__ `x : u32, y : u32`
...
pub fn core_ops_mul_u32_wrapped_mul() {
    eprintln!(r#"Testing "Properties for [`u32::wrapping_mul`]"... (2 contracts)"#);
    eprint!("  ");
    // ## Semantics of the wrapping multiplication
    // __Inputs:__ `x : u32, y : u32`
    // __Precondition:__ `true`
...
pub fn core_ops_add_u32_sub() {
    eprintln!(r#"Testing "Properties for [`core::ops::Sub::<u32>::sub`]"... (2 contracts)"#);
    eprint!("  ");
    // ## Semantics of non-underflowing subtraction
    // __Inputs:__ `x : u32, y : u32`
    // __Precondition:__ `x.up() - y.up() >= 0u8.up()`
...
pub fn core_ops_add_u32_wrapping_sub() {
    eprintln!(r#"Testing "Properties for [`u32::wrapping_sub`]"... (3 contracts)"#);
    eprint!("  ");
    // ## Semantics of non-underflowing wrapping subtraction
    // __Inputs:__ `x : u32, y : u32`
    // __Precondition:__ `x.up() - y.up() >= 0u8.up()`
...
pub fn core_ops_add_u32_checked_sub() {
    eprintln!(r#"Testing "Properties for [`u32::checked_sub`]"... (2 contracts)"#);
    eprint!("  ");
    // ## Semantics of non-underflowing checked subtraction
    // __Inputs:__ `x : u32, y : u32`
    // __Precondition:__ `x.up() - y.up() >= 0u8.up()`
...
pub fn core_ops_add_u32_add() {
    eprintln!(r#"Testing "Properties for [`core::ops::Add::<u32>::add`]"... (2 contracts)"#);
    eprint!("  ");
    // ## Semantics of non-overflowing addition
    // __Inputs:__ `x : u32, y : u32`
    // __Precondition:__ `x.up() + y.up() <= u32::MAX.up()`
...
pub fn core_ops_add_u32_wrapping_add() {
    eprintln!(r#"Testing "Properties for [`u32::wrapping_add`]"... (3 contracts)"#);
    eprint!("  ");
    // ## Semantics of the wrapping addition
    // __Inputs:__ `x : u32, y : u32`
    // __Precondition:__ `true`
...
pub fn core_ops_add_u32_checked_add() {
    eprintln!(r#"Testing "Properties for [`u32::checked_add`]"... (2 contracts)"#);
    eprint!("  ");
    // ## Semantics of non-overflowing checked addition
    // __Inputs:__ `x : u32, y : u32`
    // __Precondition:__ `x.up() + y.up() <= u32::MAX.up()`
...
pub fn core_ops_rem_u64_checked_rem() {
    ...
    // __Postcondition:__ `x.checked_rem(y) == Some(u64::down(x.up() % y.up()))`
    {
        ...
        assert!(
            18446744073709551614u64.checked_rem(18446744073709551615u64)
...
pub fn core_ops_div_u64_div() {
    ...
    // __Postcondition:__ `{ #[allow(unconditional_panic)] { panics!(x / 0) } }`
    {
        ...
        assert!({
            #[allow(unconditional_panic)]
            {
                panics!(2393958748281874330u64 / 0)
            }
        });
        assert!({
            #[allow(unconditional_panic)]
            {
                panics!(746810819810400436u64 / 0)
            }
        });
        assert!({
            #[allow(unconditional_panic)]
            {
                panics!(15939434817728022736u64 / 0)
            }
        });
        assert!({
            #[allow(unconditional_panic)]
            {
                panics!(3350277772759675243u64 / 0)
            }
        });
        assert!({
            #[allow(unconditional_panic)]
            {
                panics!(16310632540691174614u64 / 0)
            }
        });
        assert!({
            #[allow(unconditional_panic)]
            {
                panics!(7233347218202530137u64 / 0)
            }
        });
    }
    eprint!("... ");
...
pub fn core_ops_mul_u64_mul() {
    eprintln!(r#"Testing "Properties for [`core::ops::Mul::<u64>::mul`]"... (2 contracts)"#);
    eprint!("  ");
    // ## Semantics of non-overflowing multiplication
    // __Inputs:__ `x : u64, y : u64`
...
pub fn core_ops_mul_u64_overflowing_mul() {
    ...
    // __Postcondition:__ `x.overflowing_mul(y) == (x.wrapping_mul(y), true)`
    {
        ...
        assert!(
            13195139549544680652u64.overflowing_mul(2283988923174603735u64)
                == (12087666251553768276u64, true)
        );
        assert!(
            12722360789284704144u64.overflowing_mul(5687553636082995914u64)
                == (762287324007688096u64, true)
        );
        assert!(
            472655799547661441u64.overflowing_mul(2204136525185030660u64)
                == (2960527894354807812u64, true)
        );
        assert!(
            2983965396577106891u64.overflowing_mul(13337576900273806172u64)
                == (10112170683917624820u64, true)
        );
        assert!(
            7452442574016340908u64.overflowing_mul(925614786037394238u64)
                == (3913203079594706856u64, true)
        );
        assert!(
            13608300127983576701u64.overflowing_mul(12780928886142458952u64)
...
pub fn core_ops_mul_u64_wrapped_mul() {
    eprintln!(r#"Testing "Properties for [`u64::wrapping_mul`]"... (2 contracts)"#);
    eprint!("  ");
    // ## Semantics of the wrapping multiplication
    // __Inputs:__ `x : u64, y : u64`
    // __Precondition:__ `true`
...
pub fn core_ops_add_u64_sub() {
    eprintln!(r#"Testing "Properties for [`core::ops::Sub::<u64>::sub`]"... (2 contracts)"#);
    eprint!("  ");
    // ## Semantics of non-underflowing subtraction
    // __Inputs:__ `x : u64, y : u64`
    // __Precondition:__ `x.up() - y.up() >= 0u8.up()`
...
pub fn core_ops_add_u64_wrapping_sub() {
    eprintln!(r#"Testing "Properties for [`u64::wrapping_sub`]"... (3 contracts)"#);
    eprint!("  ");
    // ## Semantics of non-underflowing wrapping subtraction
    // __Inputs:__ `x : u64, y : u64`
    // __Precondition:__ `x.up() - y.up() >= 0u8.up()`
    ...
    // __Postcondition:__ `x.wrapping_sub(y) == u64::down(x.up() - y.up() + u64::MAX + 1)`
    {
        ...
        assert!(
            5878459738075178336u64.wrapping_sub(7183990408370643356u64) == 17141213403414086596u64
        );
        assert!(
            3730329075477823665u64.wrapping_sub(5982794385126705711u64) == 16194278764060669570u64
        );
        assert!(
            7034167705933885151u64.wrapping_sub(11812137164304713243u64) == 13668774615338723524u64
        );
        assert!(
            11333767894596695119u64.wrapping_sub(18189835492054069584u64)
...
pub fn core_ops_add_u64_checked_sub() {
    eprintln!(r#"Testing "Properties for [`u64::checked_sub`]"... (2 contracts)"#);
    eprint!("  ");
    // ## Semantics of non-underflowing checked subtraction
    // __Inputs:__ `x : u64, y : u64`
    // __Precondition:__ `x.up() - y.up() >= 0u8.up()`
...
pub fn core_ops_add_u64_add() {
    eprintln!(r#"Testing "Properties for [`core::ops::Add::<u64>::add`]"... (2 contracts)"#);
    eprint!("  ");
    // ## Semantics of non-overflowing addition
    // __Inputs:__ `x : u64, y : u64`
    // __Precondition:__ `x.up() + y.up() <= u64::MAX.up()`
...
pub fn core_ops_add_u64_wrapping_add() {
    eprintln!(r#"Testing "Properties for [`u64::wrapping_add`]"... (3 contracts)"#);
    eprint!("  ");
    // ## Semantics of the wrapping addition
    // __Inputs:__ `x : u64, y : u64`
    // __Precondition:__ `true`
    ...
    // __Postcondition:__ `x.wrapping_add(y) == u64::down(x.up() + y.up() - u64::MAX - 1)`
    {
        ...
        assert!(
            16169412380638655792u64.wrapping_add(7553746068175034106u64) == 5276414375104138282u64
        );
        assert!(
            18110369949102128835u64.wrapping_add(5758695292733290984u64) == 5422321168125868203u64
        );
        assert!(
            5034225414382787550u64.wrapping_add(13762123097102891650u64) == 349604437776127584u64
        );
        assert!(
            12929650550306515647u64.wrapping_add(15775877549990446634u64)
...
pub fn core_ops_add_u64_checked_add() {
    eprintln!(r#"Testing "Properties for [`u64::checked_add`]"... (2 contracts)"#);
    eprint!("  ");
    // ## Semantics of non-overflowing checked addition
    // __Inputs:__ `x : u64, y : u64`
    // __Precondition:__ `x.up() + y.up() <= u64::MAX.up()`
...
pub fn core_ops_rem_u128_checked_rem() {
    ...
    // __Postcondition:__ `x.checked_rem(y) == Some(u128::down(x.up() % y.up()))`
    {
        ...
        assert!(
            340282366920938463463374607431768211454u128
                .checked_rem(340282366920938463463374607431768211454u128)
                == Some(0u128)
        );
        assert!(
            340282366920938463463374607431768211454u128
...
pub fn core_ops_shl_u128_shl() {
    ...
    // __Postcondition:__ `x << y == u128::down((x.up() << y) & u128::MAX.up())`
    {
        ...
        assert!(
            236874679604612805226843349983273168613u128 << 123u32
                == 53169119831396634916152282411213783040u128
        );
        assert!(
            267728748332624959855304654538945266398u128 << 115u32
    ...
    // __Postcondition:__ `panics!(x << y)`
    {
        ...
        assert!(panics!(
            214241830059530030967841527796753579484u128 << 137u32
        ));
        assert!(panics!(
            68999428739042363722058781434812394187u128 << 130u32
        ));
    }
    eprint!("... ");
    eprintln!("✓\n");
...
pub fn core_ops_shl_u128_checked_shl() {
    ...
    // __Postcondition:__ `x.checked_shl(y) == Some(u128::down((x.up() << y) & u128::MAX.up()))`
    {
        ...
        assert!(
            340282366920938463463374607431768211454u128.checked_shl(0u32)
                == Some(340282366920938463463374607431768211454u128)
        );
        assert!(
        ...
        assert!(
            340282366920938463463374607431768211455u128.checked_shl(1u32)
                == Some(340282366920938463463374607431768211454u128)
        );
        assert!(
            99458653056135931001705141828900066903u128.checked_shl(75u32)
                == Some(225648470958036513454680048052140507136u128)
        );
        assert!(
            327752596679603086725586765203600262309u128.checked_shl(22u32)
...
pub fn core_ops_shl_u128_overflowing_shl() {
    ...
    // __Postcondition:__ `x.overflowing_shl(y) == (u128::down((x.up() << y) & u128::MAX.up()), false)`
    {
        ...
        assert!(
            340282366920938463463374607431768211454u128.overflowing_shl(1u32)
        ...
        assert!(
            340282366920938463463374607431768211455u128.overflowing_shl(1u32)
                == (340282366920938463463374607431768211454u128, false)
        );
        assert!(
            311767090994655368604411815315976924074u128.overflowing_shl(30u32)
                == (163560655895988147600567255405332267008u128, false)
        );
        assert!(
            134490828625379025413551471095210807982u128.overflowing_shl(32u32)
    ...
    //         == (u128::down((x.up() << (y & (u128::BITS - 1)) & u128::MAX.up())), true)`
    {
        ...
        assert!(
            1u128.overflowing_shl(4294967294u32)
        ...
        assert!(
            340282366920938463463374607431768211455u128.overflowing_shl(4294967295u32)
                == (170141183460469231731687303715884105728u128, true)
        );
        assert!(
            139333737271630274446874898930230082366u128.overflowing_shl(139u32)
                == (198870452552369684891871981289447485440u128, true)
        );
        assert!(
            61544771544160783430890872203498998270u128.overflowing_shl(130u32)
...
pub fn core_ops_shr_u128_shr() {
    ...
    // __Postcondition:__ `x >> y == u128::down((x.up() >> y) & u128::MAX.up())`
    {
        ...
        assert!(
            307086435482115175459951608857732372278u128 >> 32u32
    ...
    // __Postcondition:__ `panics!(x >> y)`
    {
        ...
        assert!(panics!(
            189912662630679158210173696604930771614u128 >> 134u32
        ));
...
pub fn core_ops_shr_u128_checked_shr() {
    ...
    // __Postcondition:__ `x.checked_shr(y) == Some(u128::down((x.up() >> y) & u128::MAX.up()))`
    {
        ...
        assert!(
            340282366920938463463374607431768211454u128.checked_shr(0u32)
                == Some(340282366920938463463374607431768211454u128)
        );
        assert!(
        ...
        assert!(
            340282366920938463463374607431768211455u128.checked_shr(1u32)
                == Some(170141183460469231731687303715884105727u128)
        );
        assert!(163594850825552139051553903837263301833u128.checked_shr(111u32) == Some(63014u128));
        assert!(
            160771083071170830471569018696904558575u128.checked_shr(42u32)
...
pub fn core_ops_shr_u128_overflowing_shr() {
    ...
    // __Postcondition:__ `x.overflowing_shr(y) == (u128::down((x.up() >> y) & u128::MAX.up()), false)`
    {
        ...
        assert!(
            340282366920938463463374607431768211454u128.overflowing_shr(1u32)
                == (170141183460469231731687303715884105727u128, false)
        );
        assert!(
            340282366920938463463374607431768211455u128.overflowing_shr(0u32)
                == (340282366920938463463374607431768211455u128, false)
        );
        assert!(
            340282366920938463463374607431768211455u128.overflowing_shr(1u32)
                == (170141183460469231731687303715884105727u128, false)
        );
        assert!(
            272856445613720225621324447799185709787u128.overflowing_shr(61u32)
                == (118332620444427342324u128, false)
        );
        assert!(
            37501528119929969177921026281020832156u128.overflowing_shr(44u32)
    ...
    //         == (u128::down((x.up() >> (y & (u128::BITS - 1)) & u128::MAX.up())), true)`
    {
        ...
        assert!(
            340282366920938463463374607431768211455u128.overflowing_shr(4294967295u32)
                == (1u128, true)
        );
        assert!(
            26743545863835572476552916318354585836u128.overflowing_shr(129u32)
                == (13371772931917786238276458159177292918u128, true)
        );
        assert!(
            113803292843924092616552455990689082753u128.overflowing_shr(139u32)
...
pub fn core_ops_div_u128_saturating_div() {
    ...
    // __Postcondition:__ `x.saturating_div(y) == u128::down(x.up() / y.up())`
    {
        ...
        assert!(
            340282366920938463463374607431768211454u128.saturating_div(1u128)
                == 340282366920938463463374607431768211454u128
        );
        assert!(
            340282366920938463463374607431768211454u128
                .saturating_div(340282366920938463463374607431768211454u128)
                == 1u128
        );
        assert!(
            340282366920938463463374607431768211454u128
        ...
        assert!(
            340282366920938463463374607431768211455u128.saturating_div(1u128)
                == 340282366920938463463374607431768211455u128
        );
    }
    eprint!("... ");
...
pub fn core_ops_div_u128_checked_div() {
    ...
    // __Postcondition:__ `x.checked_div(y) == Some(u128::down(x.up() / y.up()))`
    {
        ...
        assert!(
            340282366920938463463374607431768211454u128.checked_div(1u128)
                == Some(340282366920938463463374607431768211454u128)
        );
        assert!(
            340282366920938463463374607431768211454u128
                .checked_div(340282366920938463463374607431768211454u128)
                == Some(1u128)
        );
        assert!(
            340282366920938463463374607431768211454u128
...
pub fn core_ops_mul_u128_mul() {
    eprintln!(r#"Testing "Properties for [`core::ops::Mul::<u128>::mul`]"... (2 contracts)"#);
    eprint!("  ");
    // ## Semantics of non-overflowing multiplication
    // __Inputs:__ `x : u128, y : u128`
    ...
    // __Postcondition:__ `panics!(x * y)`
    {
        ...
        assert!(panics!(
            6860403187591554593301922829284711715u128 * 121218187544161630917260768366478285837u128
        ));
        assert!(panics!(
            191361031229009198443305008132439428304u128 * 4862618298087658813161706953119861432u128
        ));
    }
    eprint!("... ");
    eprintln!("✓\n");
...
pub fn core_ops_mul_u128_checked_mul() {
    ...
    // __Postcondition:__ `x.checked_mul(y) == Some(u128::down(x.up() * y.up()))`
    {
        ...
        assert!(
            1u128.checked_mul(340282366920938463463374607431768211455u128)
                == Some(340282366920938463463374607431768211455u128)
        );
    ...
    // __Postcondition:__ `x.checked_mul(y) == None`
    {
        ...
        assert!(
            83986192731364967255371384906620915430u128
                .checked_mul(301005379867646432223940549653217006801u128)
                == None
        );
        assert!(
            132145123220500236102832802004142857118u128
                .checked_mul(290781247035955971507367219360115235397u128)
                == None
        );
        assert!(
            47375551732540594898423331432896111836u128
                .checked_mul(286445005567543643628770389355447743469u128)
                == None
        );
        assert!(
            76171942705243134807864649500317153664u128
                .checked_mul(248541258149928644783175960497109108923u128)
                == None
        );
        assert!(
            201082694704065250270018979038698875697u128
                .checked_mul(224701682906551679448413188341462427813u128)
                == None
        );
        assert!(
            143369544602616970119164156220757045201u128
                .checked_mul(259614584095699209779450772168161701028u128)
                == None
        );
    }
    eprint!("... ");
...
pub fn core_ops_mul_u128_overflowing_mul() {
    ...
    // __Postcondition:__ `x.overflowing_mul(y) == (u128::down(x.up() * y.up()), false)`
    {
        ...
        assert!(
            0u128.overflowing_mul(340282366920938463463374607431768211454u128) == (0u128, false)
        );
        assert!(
        ...
        assert!(
            1u128.overflowing_mul(340282366920938463463374607431768211455u128)
                == (340282366920938463463374607431768211455u128, false)
        );
        assert!(
        ...
        assert!(
            340282366920938463463374607431768211454u128.overflowing_mul(1u128)
                == (340282366920938463463374607431768211454u128, false)
        );
    }
    eprint!("... ");
...
pub fn core_ops_mul_u128_saturating_mul() {
    ...
    // __Postcondition:__ `x.saturating_mul(y) == u128::down((x.up() * y.up()).min(u128::MAX.up()))`
    {
        ...
        assert!(
            1u128.saturating_mul(340282366920938463463374607431768211454u128)
                == 340282366920938463463374607431768211454u128
        );
        assert!(
            1u128.saturating_mul(340282366920938463463374607431768211455u128)
                == 340282366920938463463374607431768211455u128
        );
        assert!(340282366920938463463374607431768211454u128.saturating_mul(0u128) == 0u128);
        assert!(
            340282366920938463463374607431768211454u128.saturating_mul(1u128)
                == 340282366920938463463374607431768211454u128
        );
    }
    eprint!("... ");
    ...
    // __Postcondition:__ `x.saturating_mul(y) == u128::MAX`
    {
        ...
        assert!(
            108865626697870544462235462392014442503u128
                .saturating_mul(160484015167206425022002229947564915195u128)
                == u128::MAX
        );
        assert!(
            212533656292065046214497212819649984684u128
                .saturating_mul(192219731879265760054573880588872201115u128)
                == u128::MAX
        );
        assert!(
            52191727681435494111745893055904531999u128
                .saturating_mul(117907586350458190654469537484173366041u128)
                == u128::MAX
        );
        assert!(
            15652500917196209974053586821863517998u128
                .saturating_mul(172438897800237890023417068549656843125u128)
                == u128::MAX
        );
        assert!(
            313204301664208190853155861414278512503u128
                .saturating_mul(121072400299345306267381664062372119240u128)
                == u128::MAX
        );
        assert!(
            216131861407551197989928883267478851534u128
                .saturating_mul(130784265296077228702064419752487172934u128)
                == u128::MAX
        );
    }
    eprint!("... ");
...
pub fn core_ops_mul_u128_wrapped_mul() {
    eprintln!(r#"Testing "Properties for [`u128::wrapping_mul`]"... (2 contracts)"#);
    eprint!("  ");
    // ## Semantics of the wrapping multiplication
    // __Inputs:__ `x : u128, y : u128`
    // __Precondition:__ `true`
    // __Postcondition:__ `x.wrapping_mul(y) == u128::down((x.up() * y.up()) % (u128::MAX.up() + 1))`
    {
        ...
        assert!(
            1u128.wrapping_mul(340282366920938463463374607431768211454u128)
                == 340282366920938463463374607431768211454u128
        );
        assert!(
            1u128.wrapping_mul(340282366920938463463374607431768211455u128)
                == 340282366920938463463374607431768211455u128
        );
...
pub fn core_ops_add_u128_sub() {
    eprintln!(r#"Testing "Properties for [`core::ops::Sub::<u128>::sub`]"... (2 contracts)"#);
    eprint!("  ");
    // ## Semantics of non-underflowing subtraction
    // __Inputs:__ `x : u128, y : u128`
    // __Precondition:__ `x.up() - y.up() >= 0u8.up()`
...
pub fn core_ops_add_u128_wrapping_sub() {
    eprintln!(r#"Testing "Properties for [`u128::wrapping_sub`]"... (3 contracts)"#);
    eprint!("  ");
    // ## Semantics of non-underflowing wrapping subtraction
    // __Inputs:__ `x : u128, y : u128`
    // __Precondition:__ `x.up() - y.up() >= 0u8.up()`
    // __Postcondition:__ `x.wrapping_sub(y) == u128::down(x.up() - y.up())`
    {
        ...
        assert!(
            340282366920938463463374607431768211455u128.wrapping_sub(0u128)
                == 340282366920938463463374607431768211455u128
        );
        assert!(
...
pub fn core_ops_add_u128_checked_sub() {
    eprintln!(r#"Testing "Properties for [`u128::checked_sub`]"... (2 contracts)"#);
    eprint!("  ");
    // ## Semantics of non-underflowing checked subtraction
    // __Inputs:__ `x : u128, y : u128`
    // __Precondition:__ `x.up() - y.up() >= 0u8.up()`
    // __Postcondition:__ `x.checked_sub(y) == Some(u128::down(x.up() - y.up()))`
    {
        ...
        assert!(
            340282366920938463463374607431768211454u128.checked_sub(0u128)
                == Some(340282366920938463463374607431768211454u128)
        );
        assert!(
    ...
    // __Postcondition:__ `x.checked_sub(y) == None`
    {
        ...
        assert!(
            223084850748120244217618515063575618850u128
                .checked_sub(257524323586146255696481756623772859313u128)
                == None
        );
        assert!(
            259318522211408901781426562252083273483u128
                .checked_sub(262589657307377944831789548959922001341u128)
                == None
        );
        assert!(
            62403035161045869518487771757073272554u128
                .checked_sub(68256595863038872644294905268032407130u128)
                == None
        );
        assert!(
            119167304649820985459714122541467969180u128
                .checked_sub(167979304337648529982724010353284516089u128)
                == None
        );
    }
    eprint!("... ");
...
pub fn core_ops_sub_u128_saturating_sub() {
    ...
    // __Postcondition:__ `x.saturating_sub(y) == u128::down((x.up() - y.up()).max(0u8.up()))`
    {
        ...
        assert!(
            340282366920938463463374607431768211454u128.saturating_sub(0u128)
                == 340282366920938463463374607431768211454u128
        );
        assert!(
            340282366920938463463374607431768211454u128.saturating_sub(1u128)
                == 340282366920938463463374607431768211453u128
        );
    }
    eprint!("... ");
    ...
    // __Postcondition:__ `x.saturating_sub(y) == u128::down(x.up() - y.up())`
    {
        ...
        assert!(
            340282366920938463463374607431768211455u128.saturating_sub(1u128)
                == 340282366920938463463374607431768211454u128
        );
        assert!(
            340282366920938463463374607431768211455u128
        ...
        assert!(
            340282366920938463463374607431768211455u128
                .saturating_sub(340282366920938463463374607431768211455u128)
                == 0u128
        );
    }
    eprint!("... ");
    ...
    // __Postcondition:__ `x.saturating_sub(y) == 0`
    {
        ...
        assert!(
            308159493222008170212433516071637957991u128
                .saturating_sub(336912958774975137111016713931993981058u128)
                == 0
        );
        assert!(
            47047375312546278421773520970915229844u128
                .saturating_sub(269933110999431756607483129968471252418u128)
                == 0
        );
        assert!(
            210782027842437879508213648900258579303u128
                .saturating_sub(282516503624699751817588154051848319960u128)
                == 0
        );
        assert!(
            32501529328219165988604611100005045380u128
                .saturating_sub(325604697242344190678852237326038363009u128)
                == 0
        );
    }
    eprint!("... ");
...
pub fn core_ops_add_u128_add() {
    eprintln!(r#"Testing "Properties for [`core::ops::Add::<u128>::add`]"... (2 contracts)"#);
    eprint!("  ");
    // ## Semantics of non-overflowing addition
    // __Inputs:__ `x : u128, y : u128`
    // __Precondition:__ `x.up() + y.up() <= u128::MAX.up()`
...
pub fn core_ops_add_u128_wrapping_add() {
    eprintln!(r#"Testing "Properties for [`u128::wrapping_add`]"... (3 contracts)"#);
    eprint!("  ");
    // ## Semantics of the wrapping addition
    // __Inputs:__ `x : u128, y : u128`
    // __Precondition:__ `true`
...
pub fn core_ops_add_u128_checked_add() {
    eprintln!(r#"Testing "Properties for [`u128::checked_add`]"... (2 contracts)"#);
    eprint!("  ");
    // ## Semantics of non-overflowing checked addition
    // __Inputs:__ `x : u128, y : u128`
    // __Precondition:__ `x.up() + y.up() <= u128::MAX.up()`
    // __Postcondition:__ `x.checked_add(y) == Some(u128::down(x.up() + y.up()))`
    {
        ...
        assert!(
            1u128.checked_add(340282366920938463463374607431768211454u128)
                == Some(340282366920938463463374607431768211455u128)
        );
        assert!(
    ...
    // __Postcondition:__ `x.checked_add(y) == None`
    {
        ...
        assert!(
            223252351310797899371896571407078852238u128
                .checked_add(198933678429125037099206705034159756030u128)
                == None
        );
        assert!(
            256447879005283468649800694756386103934u128
                .checked_add(141262044775507776552290659380803117353u128)
                == None
        );
        assert!(
            278533717905506021149274765615925115088u128
                .checked_add(128624499775899010657088658577178880972u128)
                == None
        );
        assert!(
            182367566145357583407749308498687777468u128
                .checked_add(336073980784426541441152610881749450375u128)
                == None
        );
    }
    eprint!("... ");
...
pub fn core_ops_add_u128_saturating_add() {
    ...
    // __Postcondition:__ `x.saturating_add(y) == u128::down((x.up() + y.up()).min(u128::MAX.up()))`
    {
        ...
        assert!(
            1u128.saturating_add(340282366920938463463374607431768211455u128)
                == 340282366920938463463374607431768211455u128
        );
        assert!(
        ...
        assert!(
            340282366920938463463374607431768211454u128.saturating_add(1u128)
                == 340282366920938463463374607431768211455u128
        );
    }
    eprint!("... ");
    ...
    // __Postcondition:__ `x.saturating_add(y) == u128::MAX`
    {
        ...
        assert!(
            289264163419910101806803528584714317220u128
                .saturating_add(300948577925741324217620568742071014268u128)
                == u128::MAX
        );
        assert!(
            262866761525365484006238052220884026037u128
                .saturating_add(231671319992634450491778787559928171400u128)
                == u128::MAX
        );
        assert!(
            303104661170160163368840990481556580352u128
                .saturating_add(192325378959867363089690288603338439439u128)
                == u128::MAX
        );
        assert!(
            48909424144176124352012893252146119824u128
                .saturating_add(300768055918235410871680407688544204375u128)
                == u128::MAX
        );
    }
    eprint!("... ");
...
pub fn core_ops_shl_usize_overflowing_shl() {
    ...
    // __Postcondition:__ `x.overflowing_shl(y) == (usize::down((x.up() << y) & usize::MAX.up()), false)`
    {
        ...
        assert!(
            18446744073709551614usize.overflowing_shl(1u32) == (18446744073709551612usize, false)
        );
        assert!(
            18446744073709551615usize.overflowing_shl(0u32) == (18446744073709551615usize, false)
        );
        assert!(
            18446744073709551615usize.overflowing_shl(1u32) == (18446744073709551614usize, false)
        );
        assert!(744606618841236746usize.overflowing_shl(1u32) == (1489213237682473492usize, false));
        assert!(
            17319225806142551341usize.overflowing_shl(19u32) == (63119928850907136usize, false)
        );
    }
    eprint!("... ");
    // ## Semantics of the left shift otherwise
    ...
    //         == (usize::down((x.up() << (y & (usize::BITS - 1)) & usize::MAX.up())), true)`
    {
        ...
        assert!(
            18446744073709551614usize.overflowing_shl(4294967294u32)
        ...
        assert!(
            18446744073709551615usize.overflowing_shl(4294967295u32)
                == (9223372036854775808usize, true)
        );
        assert!(
            16723328203647058273usize.overflowing_shl(115u32) == (794885334230892544usize, true)
        );
        assert!(
            13030765853001403397usize.overflowing_shl(97u32) == (13177699678403166208usize, true)
        );
    }
    eprint!("... ");
    eprintln!("✓\n");
...
pub fn core_ops_shr_usize_overflowing_shr() {
    ...
    // __Postcondition:__ `x.overflowing_shr(y) == (usize::down((x.up() >> y) & usize::MAX.up()), false)`
    {
        ...
        assert!(
            18446744073709551614usize.overflowing_shr(1u32) == (9223372036854775807usize, false)
        );
        assert!(
            18446744073709551615usize.overflowing_shr(0u32) == (18446744073709551615usize, false)
        );
        assert!(
            18446744073709551615usize.overflowing_shr(1u32) == (9223372036854775807usize, false)
        );
    ...
    //         == (usize::down((x.up() >> (y & (usize::BITS - 1)) & usize::MAX.up())), true)`
    {
        ...
        assert!(
            12873940137663621629usize.overflowing_shr(132u32) == (804621258603976351usize, true)
        );
        assert!(
            12790231478335222367usize.overflowing_shr(137u32) == (24980920856123481usize, true)
        );
    }
    eprint!("... ");
    eprintln!("✓\n");
...
pub fn core_ops_div_usize_div() {
    ...
    // __Postcondition:__ `{ #[allow(unconditional_panic)] { panics!(x / 0) } }`
    {
        ...
        assert!({
            #[allow(unconditional_panic)]
            {
                panics!(7177219903555331539usize / 0)
            }
        });
        assert!({
            #[allow(unconditional_panic)]
            {
                panics!(2277125250100354123usize / 0)
            }
        });
        assert!({
            #[allow(unconditional_panic)]
            {
                panics!(18244672869508692365usize / 0)
            }
        });
        assert!({
            #[allow(unconditional_panic)]
            {
                panics!(10173311464430477581usize / 0)
            }
        });
        assert!({
            #[allow(unconditional_panic)]
            {
                panics!(201353183659338415usize / 0)
            }
        });
        assert!({
            #[allow(unconditional_panic)]
            {
                panics!(10793719294718800765usize / 0)
            }
        });
    }
    eprint!("... ");
...
pub fn core_ops_mul_usize_mul() {
    eprintln!(r#"Testing "Properties for [`core::ops::Mul::<usize>::mul`]"... (2 contracts)"#);
    eprint!("  ");
    // ## Semantics of non-overflowing multiplication
    // __Inputs:__ `x : usize, y : usize`
    ...
    // __Postcondition:__ `panics!(x * y)`
    {
        ...
        assert!(panics!(
            17903077435512809579usize * 8835285998654674202usize
        ));
        assert!(panics!(
            15930747705749709487usize * 1438359304808892483usize
        ));
        assert!(panics!(9460921690118579475usize * 273936620495114075usize));
        assert!(panics!(
            8563712348939009824usize * 13696491322304248119usize
        ));
        assert!(panics!(
            3156708032895011001usize * 10210174684726516227usize
        ));
        assert!(panics!(
            6475317113245190952usize * 18032020102732042440usize
        ));
    }
    eprint!("... ");
    eprintln!("✓\n");
...
pub fn core_ops_mul_usize_overflowing_mul() {
    ...
    // __Postcondition:__ `x.overflowing_mul(y) == (usize::down(x.up() * y.up()), false)`
    {
        ...
        assert!(
            1usize.overflowing_mul(18446744073709551614usize) == (18446744073709551614usize, false)
        );
        assert!(
            1usize.overflowing_mul(18446744073709551615usize) == (18446744073709551615usize, false)
        );
        assert!(18446744073709551614usize.overflowing_mul(0usize) == (0usize, false));
        assert!(
            18446744073709551614usize.overflowing_mul(1usize) == (18446744073709551614usize, false)
        );
    }
    eprint!("... ");
    // ## Semantics of the overflowing multiplication when out of bounds
    ...
    // __Postcondition:__ `x.overflowing_mul(y) == (x.wrapping_mul(y), true)`
    {
        ...
        assert!(
            10641328364506949378usize.overflowing_mul(13378019540258322952usize)
                == (5807600512308947984usize, true)
        );
        assert!(
            10052814731475236489usize.overflowing_mul(16765056481422568357usize)
                == (12421612466519959885usize, true)
        );
        assert!(
            15464872804716072760usize.overflowing_mul(4129458824260819679usize)
                == (1016563076987990472usize, true)
        );
        assert!(
            3969558328221247719usize.overflowing_mul(9613602193248531277usize)
                == (9503267555373077115usize, true)
        );
        assert!(
            8686025737837853553usize.overflowing_mul(1124133276319501778usize)
                == (1764071868219047858usize, true)
        );
        assert!(
            17244477822553217784usize.overflowing_mul(3697603314042137741usize)
...
pub fn core_ops_mul_usize_wrapped_mul() {
    eprintln!(r#"Testing "Properties for [`usize::wrapping_mul`]"... (2 contracts)"#);
    eprint!("  ");
    // ## Semantics of the wrapping multiplication
    // __Inputs:__ `x : usize, y : usize`
    // __Precondition:__ `true`
...
pub fn core_ops_add_usize_sub() {
    eprintln!(r#"Testing "Properties for [`core::ops::Sub::<usize>::sub`]"... (2 contracts)"#);
    eprint!("  ");
    // ## Semantics of non-underflowing subtraction
    // __Inputs:__ `x : usize, y : usize`
    // __Precondition:__ `x.up() - y.up() >= 0u8.up()`
    ...
    // __Postcondition:__ `panics!(x - y)`
    {
        ...
        assert!(panics!(
            10909159953310655576usize - 14070458719243159851usize
        ));
...
pub fn core_ops_add_usize_wrapping_sub() {
    eprintln!(r#"Testing "Properties for [`usize::wrapping_sub`]"... (3 contracts)"#);
    eprint!("  ");
    // ## Semantics of non-underflowing wrapping subtraction
    // __Inputs:__ `x : usize, y : usize`
    // __Precondition:__ `x.up() - y.up() >= 0u8.up()`
    ...
    // __Postcondition:__ `x.wrapping_sub(y) == usize::down(x.up() - y.up() + usize::MAX + 1)`
    {
        ...
        assert!(
            4475744829315031623usize.wrapping_sub(9411892713793841930usize)
                == 13510596189230741309usize
        );
        assert!(
            4056473609565881219usize.wrapping_sub(18446001993785668029usize)
                == 4057215689489764806usize
        );
        assert!(
            4704288311423850653usize.wrapping_sub(13809174016516290320usize)
                == 9341858368617111949usize
        );
        assert!(
            6841801605528126176usize.wrapping_sub(11070906018381501746usize)
...
pub fn core_ops_add_usize_checked_sub() {
    eprintln!(r#"Testing "Properties for [`usize::checked_sub`]"... (2 contracts)"#);
    eprint!("  ");
    // ## Semantics of non-underflowing checked subtraction
    // __Inputs:__ `x : usize, y : usize`
    // __Precondition:__ `x.up() - y.up() >= 0u8.up()`
...
pub fn core_ops_add_usize_add() {
    eprintln!(r#"Testing "Properties for [`core::ops::Add::<usize>::add`]"... (2 contracts)"#);
    eprint!("  ");
    // ## Semantics of non-overflowing addition
    // __Inputs:__ `x : usize, y : usize`
    // __Precondition:__ `x.up() + y.up() <= usize::MAX.up()`
    ...
    // __Postcondition:__ `panics!(x + y)`
    {
        ...
        assert!(panics!(
            7985224470225369836usize + 13967774498916397289usize
        ));
        assert!(panics!(
            15203682681027028073usize + 15856495408349350213usize
        ));
        assert!(panics!(
            10743567839063766489usize + 17018294231191272335usize
        ));
        assert!(panics!(
            1120112595967320222usize + 17922677746076571600usize
        ));
    }
    eprint!("... ");
    eprintln!("✓\n");
...
pub fn core_ops_add_usize_wrapping_add() {
    eprintln!(r#"Testing "Properties for [`usize::wrapping_add`]"... (3 contracts)"#);
    eprint!("  ");
    // ## Semantics of the wrapping addition
    // __Inputs:__ `x : usize, y : usize`
    // __Precondition:__ `true`
    ...
    // __Postcondition:__ `x.wrapping_add(y) == usize::down(x.up() + y.up() - usize::MAX - 1)`
    {
        ...
        assert!(
            13235917199200992099usize.wrapping_add(8339715410169055009usize)
                == 3128888535660495492usize
        );
        assert!(
            16838437996241321379usize.wrapping_add(12996350293632658652usize)
                == 11388044216164428415usize
        );
        assert!(
            18090175919516931310usize.wrapping_add(8465335880407505150usize)
                == 8108767726214884844usize
        );
        assert!(
            9698234789024821577usize.wrapping_add(17388315672386635477usize)
...
pub fn core_ops_add_usize_checked_add() {
    eprintln!(r#"Testing "Properties for [`usize::checked_add`]"... (2 contracts)"#);
    eprint!("  ");
    // ## Semantics of non-overflowing checked addition
    // __Inputs:__ `x : usize, y : usize`
    // __Precondition:__ `x.up() + y.up() <= usize::MAX.up()`
...
pub fn core_ops_sub_i64_overflowing_sub() {
    ...
    // __Postcondition:__ `x.overflowing_sub(y) == (i64::down(x.up() - y.up()), false)`
    {
        ...
        assert!(
            (-9223372036854775808i64).overflowing_sub((-9223372036854775807i64))
                == ((-1i64), false)
        );
        assert!(
            (-9223372036854775808i64).overflowing_sub((-1i64))
        ...
        assert!(
            (-9223372036854775807i64).overflowing_sub((-9223372036854775807i64)) == (0i64, false)
        );
        assert!(
            (-9223372036854775807i64).overflowing_sub((-1i64))
                == ((-9223372036854775806i64), false)
        );
        assert!(
            (-9223372036854775807i64).overflowing_sub(0i64) == ((-9223372036854775807i64), false)
        );
        assert!(
            (-9223372036854775807i64).overflowing_sub(1i64) == ((-9223372036854775808i64), false)
        );
        assert!(
            (-1i64).overflowing_sub((-9223372036854775808i64)) == (9223372036854775807i64, false)
        );
    }
    eprint!("... ");
    // ## Semantics of overflowing subtraction when not in bounds
    ...
    //         )`
    {
        ...
        assert!(
            9223372036854775806i64.overflowing_sub((-9223372036854775807i64)) == ((-3i64), true)
        );
    }
    eprint!("... ");
    eprintln!("✓\n");
...
pub fn t_i128_checked_neg() {
    ...
    // __Postcondition:__ `x.checked_neg() == Some(i128::down(-x.up()))`
    {
        ...
        assert!(
            4443526550899695848864685213695735410i128.checked_neg()
                == Some((-4443526550899695848864685213695735410i128))
        );
        assert!(
            89983046691539104091212351332571083884i128.checked_neg()
                == Some((-89983046691539104091212351332571083884i128))
        );
        assert!(
            157033005170615327237629801662667437696i128.checked_neg()
                == Some((-157033005170615327237629801662667437696i128))
        );
        assert!(
            (-68452167488008918508926081952391400531i128).checked_neg()
...
pub fn t_i128_overflowing_neg() {
    ...
    // __Postcondition:__ `x.overflowing_neg() == (i128::down(-x.up()), false)`
    {
        ...
        assert!(
            80702799090855744584094085980453386678i128.overflowing_neg()
                == ((-80702799090855744584094085980453386678i128), false)
        );
        assert!(
            (-29079516468604951734499855108652283431i128).overflowing_neg()
                == (29079516468604951734499855108652283431i128, false)
        );
        assert!(
            41346973316414323899529452013530373549i128.overflowing_neg()
                == ((-41346973316414323899529452013530373549i128), false)
        );
        assert!(
            139411089024669258240116948326023335869i128.overflowing_neg()
...
pub fn core_ops_sub_i128_checked_sub() {
    ...
    // __Postcondition:__ `x.checked_sub(y) == Some(i128::down(x.up() - y.up()))`
    {
        ...
        assert!(
            (-170141183460469231731687303715884105728i128).checked_sub(0i128)
        ...
        assert!(
            (-170141183460469231731687303715884105727i128).checked_sub((-1i128))
                == Some((-170141183460469231731687303715884105726i128))
        );
        assert!(
            (-170141183460469231731687303715884105727i128).checked_sub(0i128)
                == Some((-170141183460469231731687303715884105727i128))
        );
        assert!(
            (-170141183460469231731687303715884105727i128).checked_sub(1i128)
        ...
        assert!(
            (-1i128).checked_sub((-170141183460469231731687303715884105728i128))
                == Some(170141183460469231731687303715884105727i128)
        );
    }
    eprint!("... ");
    ...
    // __Postcondition:__ `x.checked_sub(y) == None`
    {
        ...
        assert!(
            (-170141183460469231731687303715884105728i128)
                .checked_sub(170141183460469231731687303715884105726i128)
                == None
        );
        assert!(
            (-170141183460469231731687303715884105728i128)
...
pub fn core_ops_sub_i128_wrapping_sub() {
    ...
    // __Postcondition:__ `x.wrapping_sub(y) == i128::down(x.up() - y.up())`
    {
        assert!(
            (-170141183460469231731687303715884105728i128)
                .wrapping_sub((-170141183460469231731687303715884105728i128))
                == 0i128
        );
        assert!(
            (-170141183460469231731687303715884105728i128)
        ...
        assert!(
            (-170141183460469231731687303715884105728i128).wrapping_sub((-1i128))
                == (-170141183460469231731687303715884105727i128)
        );
        assert!(
            (-170141183460469231731687303715884105728i128).wrapping_sub(0i128)
                == (-170141183460469231731687303715884105728i128)
        );
        assert!(
            (-170141183460469231731687303715884105727i128)
        ...
        assert!(
            (-170141183460469231731687303715884105727i128).wrapping_sub((-1i128))
                == (-170141183460469231731687303715884105726i128)
        );
        assert!(
            (-170141183460469231731687303715884105727i128).wrapping_sub(0i128)
                == (-170141183460469231731687303715884105727i128)
        );
        assert!(
            (-170141183460469231731687303715884105727i128).wrapping_sub(1i128)
    ...
    //         )`
    {
        ...
        assert!(
            0i128.wrapping_sub((-170141183460469231731687303715884105728i128))
                == (-170141183460469231731687303715884105728i128)
        );
        assert!(
            1i128.wrapping_sub((-170141183460469231731687303715884105728i128))
...
pub fn core_ops_sub_i128_overflowing_sub() {
    ...
    // __Postcondition:__ `x.overflowing_sub(y) == (i128::down(x.up() - y.up()), false)`
    {
        ...
        assert!(
            (-170141183460469231731687303715884105728i128).overflowing_sub(0i128)
        ...
        assert!(
            (-1i128).overflowing_sub((-170141183460469231731687303715884105728i128))
                == (170141183460469231731687303715884105727i128, false)
        );
    }
    eprint!("... ");
    ...
    //         )`
    {
        ...
        assert!(
            0i128.overflowing_sub((-170141183460469231731687303715884105728i128))
                == ((-170141183460469231731687303715884105728i128), true)
        );
        assert!(
            1i128.overflowing_sub((-170141183460469231731687303715884105728i128))
...
pub fn core_ops_sub_isize_sub() {
    ...
    // __Postcondition:__ `panics!(x - y)`
    {
        ...
        assert!(panics!(
            (-9223372036854775808isize) - 9223372036854775806isize
        ));
        assert!(panics!(
        ...
        assert!(panics!(
            9223372036854775806isize - (-9223372036854775808isize)
        ));
        assert!(panics!(
...
pub fn core_ops_sub_isize_checked_sub() {
    ...
    {
        assert!(
            (-9223372036854775808isize).checked_sub((-9223372036854775808isize)) == Some(0isize)
        );
        assert!(
            (-9223372036854775808isize).checked_sub((-9223372036854775807isize)) == Some((-1isize))
        );
        assert!(
            (-9223372036854775808isize).checked_sub((-1isize)) == Some((-9223372036854775807isize))
        );
        assert!(
            (-9223372036854775808isize).checked_sub(0isize) == Some((-9223372036854775808isize))
        );
        assert!(
            (-9223372036854775807isize).checked_sub((-9223372036854775808isize)) == Some(1isize)
        );
        assert!(
            (-9223372036854775807isize).checked_sub((-9223372036854775807isize)) == Some(0isize)
        );
        assert!(
            (-9223372036854775807isize).checked_sub((-1isize)) == Some((-9223372036854775806isize))
        );
        assert!(
            (-9223372036854775807isize).checked_sub(0isize) == Some((-9223372036854775807isize))
        );
        assert!(
            (-9223372036854775807isize).checked_sub(1isize) == Some((-9223372036854775808isize))
        );
        assert!(
            (-1isize).checked_sub((-9223372036854775808isize)) == Some(9223372036854775807isize)
        );
    }
    eprint!("... ");
    // ## Overflowing subtraction panics
...
pub fn core_ops_sub_isize_overflowing_sub() {
    ...
    {
        assert!(
            (-9223372036854775808isize).overflowing_sub((-9223372036854775808isize))
                == (0isize, false)
        );
        assert!(
        ...
        assert!(
            (-9223372036854775808isize).overflowing_sub((-1isize))
                == ((-9223372036854775807isize), false)
        );
        assert!(
            (-9223372036854775808isize).overflowing_sub(0isize)
        ...
        assert!(
            (-9223372036854775807isize).overflowing_sub((-1isize))
                == ((-9223372036854775806isize), false)
        );
        assert!(
            (-9223372036854775807isize).overflowing_sub(0isize)
                == ((-9223372036854775807isize), false)
        );
        assert!(
            (-9223372036854775807isize).overflowing_sub(1isize)
        ...
        assert!(
            (-1isize).overflowing_sub((-9223372036854775808isize))
                == (9223372036854775807isize, false)
        );
    }
    eprint!("... ");
    ...
    //         )`
    {
        ...
        assert!(
            (-9223372036854775808isize).overflowing_sub(9223372036854775806isize) == (2isize, true)
        );
        assert!(
            (-9223372036854775808isize).overflowing_sub(9223372036854775807isize) == (1isize, true)
        );
        assert!(
            (-9223372036854775807isize).overflowing_sub(9223372036854775806isize) == (3isize, true)
        );
        assert!(
        ...
        assert!(
            9223372036854775806isize.overflowing_sub((-9223372036854775807isize))
                == ((-3isize), true)
        );
    }
    eprint!("... ");
...
pub fn core_ops_add_isize_add() {
    ...
    {
        assert!(panics!(
            (-9223372036854775808isize) + (-9223372036854775808isize)
        ));
        assert!(panics!(
            (-9223372036854775808isize) + (-9223372036854775807isize)
        ));
...
pub fn core_cmp_partial_ord_u128_cmp() {
    ...
    // __Postcondition:__ `x.cmp(&(y)) == x.up().cmp(&(y).up())`
    {
        ...
        assert!(
            0u128.cmp(&(340282366920938463463374607431768211454u128)) == core::cmp::Ordering::Less
        );
        assert!(
            0u128.cmp(&(340282366920938463463374607431768211455u128)) == core::cmp::Ordering::Less
        );
        ...
        assert!(
            1u128.cmp(&(340282366920938463463374607431768211455u128)) == core::cmp::Ordering::Less
        );
        assert!(
        ...
        assert!(
            340282366920938463463374607431768211454u128.cmp(&(1u128))
                == core::cmp::Ordering::Greater
        );
    }
    eprint!("... ");
...
pub fn core_cmp_partial_ord_i64_cmp() {
    ...
    {
        assert!(
            (-9223372036854775808i64).cmp(&(-9223372036854775808i64)) == core::cmp::Ordering::Equal
        );
        assert!(
            (-9223372036854775808i64).cmp(&(-9223372036854775807i64)) == core::cmp::Ordering::Less
        );
        ...
        assert!((-9223372036854775808i64).cmp(&(1i64)) == core::cmp::Ordering::Less);
        assert!(
            (-9223372036854775808i64).cmp(&(9223372036854775806i64)) == core::cmp::Ordering::Less
        );
        assert!(
            (-9223372036854775808i64).cmp(&(9223372036854775807i64)) == core::cmp::Ordering::Less
        );
        assert!(
            (-9223372036854775807i64).cmp(&(-9223372036854775808i64))
                == core::cmp::Ordering::Greater
        );
        assert!(
...
pub fn core_cmp_partial_ord_i128_cmp() {
    ...
    // __Postcondition:__ `x.cmp(&(y)) == x.up().cmp(&(y).up())`
    {
        ...
        assert!(
            (-170141183460469231731687303715884105728i128).cmp(&(-1i128))
                == core::cmp::Ordering::Less
        );
        assert!(
            (-170141183460469231731687303715884105728i128).cmp(&(0i128))
                == core::cmp::Ordering::Less
        );
        assert!(
            (-170141183460469231731687303715884105728i128).cmp(&(1i128))
        ...
        assert!(
            (-170141183460469231731687303715884105728i128)
                .cmp(&(170141183460469231731687303715884105726i128))
                == core::cmp::Ordering::Less
        );
        assert!(
            (-170141183460469231731687303715884105728i128)
        ...
        assert!(
            (-170141183460469231731687303715884105727i128).cmp(&(-1i128))
                == core::cmp::Ordering::Less
        );
    }
    eprint!("... ");
...
pub fn core_cmp_partial_ord_i128_lt() {
    ...
    // __Postcondition:__ `x.lt(&(y)) == x.up().lt(&(y).up())`
    {
        assert!(
            (-170141183460469231731687303715884105728i128)
                .lt(&(-170141183460469231731687303715884105728i128))
                == false
        );
        assert!(
            (-170141183460469231731687303715884105728i128)
...
pub fn core_cmp_partial_ord_i128_gt() {
    ...
    // __Postcondition:__ `x.gt(&(y)) == x.up().gt(&(y).up())`
    {
        assert!(
            (-170141183460469231731687303715884105728i128)
                .gt(&(-170141183460469231731687303715884105728i128))
                == false
        );
        assert!(
            (-170141183460469231731687303715884105728i128)
        ...
        assert!(
            (-170141183460469231731687303715884105728i128)
                .gt(&(170141183460469231731687303715884105726i128))
                == false
        );
        assert!(
            (-170141183460469231731687303715884105728i128)
...
pub fn core_cmp_partial_ord_i128_ge() {
    ...
    // __Postcondition:__ `x.ge(&(y)) == x.up().ge(&(y).up())`
    {
        assert!(
            (-170141183460469231731687303715884105728i128)
                .ge(&(-170141183460469231731687303715884105728i128))
                == true
        );
        assert!(
            (-170141183460469231731687303715884105728i128)
        ...
        assert!(
            (-170141183460469231731687303715884105728i128)
                .ge(&(170141183460469231731687303715884105726i128))
                == false
        );
        assert!(
            (-170141183460469231731687303715884105728i128)
...
pub fn core_cmp_partial_ord_i128_le() {
    ...
    // __Postcondition:__ `x.le(&(y)) == x.up().le(&(y).up())`
    {
        assert!(
            (-170141183460469231731687303715884105728i128)
                .le(&(-170141183460469231731687303715884105728i128))
                == true
        );
        assert!(
            (-170141183460469231731687303715884105728i128)
        ...
        assert!(
            (-170141183460469231731687303715884105728i128)
                .le(&(170141183460469231731687303715884105726i128))
                == true
        );
        assert!(
            (-170141183460469231731687303715884105728i128)
...
pub fn core_cmp_partial_ord_isize_cmp() {
    ...
    {
        assert!(
            (-9223372036854775808isize).cmp(&(-9223372036854775808isize))
                == core::cmp::Ordering::Equal
        );
        assert!(
            (-9223372036854775808isize).cmp(&(-9223372036854775807isize))
                == core::cmp::Ordering::Less
        );
        ...
        assert!(
            (-9223372036854775807isize).cmp(&(-9223372036854775808isize))
                == core::cmp::Ordering::Greater
        );
        assert!(
            (-9223372036854775807isize).cmp(&(-9223372036854775807isize))
                == core::cmp::Ordering::Equal
        );
