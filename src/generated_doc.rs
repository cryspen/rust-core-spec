...
///             None => false,
///         }));
/// assert!(Some(61u8).is_some()
///         == (match Some(61u8) {
///             Some(_) => true,
///             None => false,
///         }));
/// assert!(Some(16u8).is_some()
///         == (match Some(16u8) {
///             Some(_) => true,
///             None => false,
///         }));
/// assert!(Some(150u8).is_some()
///         == (match Some(150u8) {
///             Some(_) => true,
///             None => false,
///         }));
/// assert!(Some(36u8).is_some()
///         == (match Some(36u8) {
///             Some(_) => true,
///             None => false,
///         }));
...
///             None => true,
///         }));
/// assert!(Some(70u8).is_none()
///         == (match Some(70u8) {
///             Some(_) => false,
///             None => true,
///         }));
/// assert!(Some(216u8).is_none()
///         == (match Some(216u8) {
///             Some(_) => false,
///             None => true,
///         }));
/// assert!(Some(253u8).is_none()
///         == (match Some(253u8) {
///             Some(_) => false,
///             None => true,
///         }));
/// assert!(Some(25u8).is_none()
///         == (match Some(25u8) {
///             Some(_) => false,
///             None => true,
///         }));
...
/// assert!(Some(13u8).filter((|x: &u8| *x > 128)).is_some() == (|x: &u8| *x > 128)(&13u8));
/// assert!(Some(147u8).filter((|x: &u8| *x > 128)).is_some() == (|x: &u8| *x > 128)(&147u8));
/// assert!(Some(54u8).filter((|x: &u8| *x > 128)).is_some() == (|x: &u8| *x > 128)(&54u8));
/// # }
/// ```
...
///     });
/// assert!({
///         let mut y = Some(168u8).clone();
///         y.take() == Some(168u8) && y.is_none()
///     });
/// assert!({
///         let mut y = Some(174u8).clone();
///         y.take() == Some(174u8) && y.is_none()
///     });
/// assert!({
///         let mut y = Some(164u8).clone();
///         y.take() == Some(164u8) && y.is_none()
///     });
/// assert!({
///         let mut y = Some(64u8).clone();
///         y.take() == Some(64u8) && y.is_none()
///     });
/// # }
/// ```
pub fn option_take(){}
...
/// assert!((1159101526u32 + 1970943638u32) + 745456067u32
///         == 1159101526u32 + (1970943638u32 + 745456067u32));
/// assert!((441662636u32 + 1485688977u32) + 137806018u32
///         == 441662636u32 + (1485688977u32 + 137806018u32));
/// assert!((123644037u32 + 268912338u32) + 3619402573u32
///         == 123644037u32 + (268912338u32 + 3619402573u32));
/// # }
/// ```
...
/// assert!(2978925542u32.checked_add(2542189118u32) == 2542189118u32.checked_add(2978925542u32));
/// assert!(648804476u32.checked_add(2190182634u32) == 2190182634u32.checked_add(648804476u32));
/// assert!(4092167640u32.checked_add(2041777482u32) == 2041777482u32.checked_add(4092167640u32));
/// # }
/// ```
/// ## Left identity
/// __Inputs:__ `x : u32`  
...
/// assert!(11871368544704088055u64 + 888011700992038935u64 == 12759380245696126990u64);
/// assert!(11350891116549680892u64 + 4242852414073054584u64 == 15593743530622735476u64);
/// assert!(497512941569413017u64 + 7372574157137864387u64 == 7870087098707277404u64);
/// assert!(9520668372638770033u64 + 1961869264817343129u64 == 11482537637456113162u64);
/// # }
/// ```
/// ## Panics when overflowing
/// __Inputs:__ `x : u64, y : u64`  
...
/// assert!(10758124627942853055u64 + 4307736027674636938u64
///         == 4307736027674636938u64 + 10758124627942853055u64);
/// assert!(10465776571036549980u64 + 7667941233865951239u64
///         == 7667941233865951239u64 + 10465776571036549980u64);
/// assert!(248808288612872646u64 + 12266172561417304657u64
///         == 12266172561417304657u64 + 248808288612872646u64);
/// assert!(1801422218836205355u64 + 380912020150770053u64
///         == 380912020150770053u64 + 1801422218836205355u64);
/// # }
/// ```
/// ## Left identity
/// __Inputs:__ `x : u64`  
...
/// assert!((4831166760179866709u64 + 4381723276812744171u64) + 9063414266465401720u64
///         == 4831166760179866709u64 + (4381723276812744171u64 + 9063414266465401720u64));
/// assert!((3283240233562121164u64 + 10923207668211229844u64) + 1376106991170207504u64
///         == 3283240233562121164u64 + (10923207668211229844u64 + 1376106991170207504u64));
/// assert!((3457201212874433870u64 + 7272927831482578559u64) + 1464277534800466864u64
...
/// assert!(6421644081636274296u64.checked_add(1975814712575291192u64)
///         == Some(8397458794211565488u64));
/// assert!(5587963983248741622u64.checked_add(6260766345293237330u64)
///         == Some(11848730328541978952u64));
/// assert!(9994728396847391065u64.checked_add(418551447663990640u64)
///         == Some(10413279844511381705u64));
/// assert!(4170087122906035120u64.checked_add(8233713955671513950u64)
...
/// assert!(2414861540101794906u64.checked_add(4773178533036005721u64)
///         == 4773178533036005721u64.checked_add(2414861540101794906u64));
/// assert!(13310688041786787170u64.checked_add(12004327392646337751u64)
///         == 12004327392646337751u64.checked_add(13310688041786787170u64));
/// assert!(17221613034456464262u64.checked_add(7479145416433949492u64)
...
/// assert!(0u64.checked_add(0u64) == Some(0u64));
/// assert!(18446744073709551615u64.checked_add(0u64) == Some(18446744073709551615u64));
/// assert!(2797366007693812659u64.checked_add(0u64) == Some(2797366007693812659u64));
/// assert!(5554164456954812873u64.checked_add(0u64) == Some(5554164456954812873u64));
/// assert!(6065242237336584507u64.checked_add(0u64) == Some(6065242237336584507u64));
/// assert!(6284473443622061021u64.checked_add(0u64) == Some(6284473443622061021u64));
/// assert!(16204980333079000017u64.checked_add(0u64) == Some(16204980333079000017u64));
/// # }
/// ```
/// ## Right identity
/// __Inputs:__ `x : u64`  
...
/// assert!(0u64.checked_add(5225006725455295128u64) == Some(5225006725455295128u64));
/// assert!(0u64.checked_add(245831050827445708u64) == Some(245831050827445708u64));
/// assert!(0u64.checked_add(2502366769960902339u64) == Some(2502366769960902339u64));
/// assert!(0u64.checked_add(3305599750053080643u64) == Some(3305599750053080643u64));
/// # }
/// ```
/// ## Associativity
/// __Inputs:__ `x : u64, y : u64, z : u64`  
...
///     ));
/// assert!(panics!(
///         304729255982784698050401176630358565864u128 +
///         246092185862351841961398637806498643314u128
///     ));
/// assert!(panics!(
///         231583563439984710731710747125776287866u128 +
///         201167471374747631758258845457373798598u128
///     ));
/// assert!(panics!(
///         289520500223168794718019099630616242398u128 +
///         250219856797968508128097317497906499561u128
///     ));
/// assert!(panics!(
///         158480307502663174219261828881678548762u128 +
...
///         == 340282366920938463463374607431768211455u128);
/// assert!(208679760187711222092234600280620218905u128 + 0
///         == 208679760187711222092234600280620218905u128);
/// assert!(254515581157111815171908781040291506688u128 + 0
///         == 254515581157111815171908781040291506688u128);
/// assert!(68249478854860180228768214461596920639u128 + 0
///         == 68249478854860180228768214461596920639u128);
/// assert!(303114730350188113105657230788108688814u128 + 0
///         == 303114730350188113105657230788108688814u128);
/// assert!(24889589056419785914457194540251549286u128 + 0
...
///         == 340282366920938463463374607431768211455u128);
/// assert!(0 + 118161551329733355621697751123271393725u128
///         == 118161551329733355621697751123271393725u128);
/// assert!(0 + 236517319423271216909496246633447694678u128
///         == 236517319423271216909496246633447694678u128);
/// assert!(0 + 262775740016103845022162152598166628851u128
///         == 262775740016103845022162152598166628851u128);
/// assert!(0 + 127752164075952016463164275435037271429u128
///         == 127752164075952016463164275435037271429u128);
/// assert!(0 + 174891994191968848750246435175535156536u128
...
/// assert!((26722379428880807347411130526663864129u128
...
///             + (247082526874420784304601804380473055041u128
///                 + 12857151542568655906927240522699745055u128));
/// assert!((50206869902125921366118396906901670084u128
...
///             + (82888956811223442925349255869331597429u128
///                 + 155875025336365988923758100077473903601u128));
/// assert!((17346417100613710069605018832947627826u128
...
/// assert!(270467049828537614618764599626770980812u128
///         .checked_add(288126481526285981805704370192334052987u128) == None);
/// assert!(36045971748951525716554327082115614094u128
///         .checked_add(334381050094727626233590565272250941002u128) == None);
/// assert!(111986577799617418025916371268163844122u128
///         .checked_add(243584389146707846720913375133312066999u128) == None);
/// assert!(56403673948442921958739413523681560011u128
...
///         == 340282366920938463463374607431768211455u128
///             .checked_add(340282366920938463463374607431768211455u128));
/// assert!(145751601124010921353479323471917357878u128
...
/// assert!(282705233823680694728756139015676226473u128
...
/// assert!(135837792909016589480713516885864963892u128
...
/// assert!(340282366920938463463374607431768211455u128.checked_add(0u128)
///         == Some(340282366920938463463374607431768211455u128));
/// assert!(131549467034166332901059641356837276926u128.checked_add(0u128)
///         == Some(131549467034166332901059641356837276926u128));
/// assert!(53550988151919353031835073824315121708u128.checked_add(0u128)
///         == Some(53550988151919353031835073824315121708u128));
/// assert!(5762964146128519402181475002220796759u128.checked_add(0u128)
///         == Some(5762964146128519402181475002220796759u128));
/// assert!(175344093148714898200802848363235616513u128.checked_add(0u128)
///         == Some(175344093148714898200802848363235616513u128));
/// assert!(24494802265958941267650736120226515915u128.checked_add(0u128)
...
/// assert!(0u128.checked_add(340282366920938463463374607431768211455u128)
///         == Some(340282366920938463463374607431768211455u128));
/// assert!(0u128.checked_add(223393970518338524840982936410025334088u128)
///         == Some(223393970518338524840982936410025334088u128));
/// assert!(0u128.checked_add(205406436429678396900677614243975148419u128)
///         == Some(205406436429678396900677614243975148419u128));
/// assert!(0u128.checked_add(232819812947974530198024205277468994823u128)
///         == Some(232819812947974530198024205277468994823u128));
/// assert!(0u128.checked_add(2555104023491319561175488322427128910u128)
///         == Some(2555104023491319561175488322427128910u128));
/// assert!(0u128.checked_add(127463225468834824516058818947122317193u128)
